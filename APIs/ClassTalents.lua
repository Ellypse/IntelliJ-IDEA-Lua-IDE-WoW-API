...
---@field Error number @ Value is set to: 0
---@field NoChangesNecessary number @ Value is set to: 1
---@field LoadInProgress number @ Value is set to: 2
---@field Ready number @ Value is set to: 3
