...
---@field Neutral number @ Value is set to: 0
---@field Horde number @ Value is set to: 1
---@field Alliance number @ Value is set to: 2
...
---@field Current number @ Value is set to: 0
---@field Reachable number @ Value is set to: 1
---@field Unreachable number @ Value is set to: 2
