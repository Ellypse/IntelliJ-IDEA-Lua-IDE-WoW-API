...
---@field Offensive number @ Value is set to: 0
---@field Defensive number @ Value is set to: 1
---@field Debuff number @ Value is set to: 2
---@field RacialAbility number @ Value is set to: 3
---@field Count number @ Value is set to: 4
