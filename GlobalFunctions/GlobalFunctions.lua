...
--- [https://wow.gamepedia.com/wiki/API_AbandonSkill]
...
--- [https://wow.gamepedia.com/wiki/API_AcceptAreaSpiritHeal]
--- @return void
function AcceptAreaSpiritHeal()
end

--- Confirms entry into a Battleground you are queued for that is ready.
--- [https://wow.gamepedia.com/wiki/API_AcceptBattlefieldPort]
...
--- [https://wow.gamepedia.com/wiki/API_AcceptTrade]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_AcceptXPLoss]
--- @return void
function AcceptXPLoss()
end

--- Acknowledges that the currently-offered auto-accept quest has been accepted by the player.
--- [https://wow.gamepedia.com/wiki/API_AcknowledgeAutoAcceptQuest]
--- @return void
function AcknowledgeAutoAcceptQuest()
end

--- [https://wow.gamepedia.com/wiki/API_AcknowledgeSurvey?action=edit&amp;redlink=1]
--- @return void
function AcknowledgeSurvey()
end

--- [https://wow.gamepedia.com/wiki/API_ActionBindsItem?action=edit&amp;redlink=1]
--- @return void
function ActionBindsItem()
end

--- Returns true if the action has a numeric range requirement.
--- [https://wow.gamepedia.com/wiki/API_ActionHasRange]
...
--- [https://wow.gamepedia.com/wiki/API_AddAutoQuestPopUp]
...
--- [https://wow.gamepedia.com/wiki/API_AddChatWindowChannel]
...
--- [https://wow.gamepedia.com/wiki/API_AddChatWindowMessages]
...
--- [https://wow.gamepedia.com/wiki/API_AddTrackedAchievement]
...
--- [https://wow.gamepedia.com/wiki/API_AntiAliasingSupported?action=edit&amp;redlink=1]
--- @return void
function AntiAliasingSupported()
end

--- Purchases currently selected customizations from the barber shop.
--- [https://wow.gamepedia.com/wiki/API_ApplyBarberShopStyle]
--- @return void
function ApplyBarberShopStyle()
end

--- [https://wow.gamepedia.com/wiki/API_ArchaeologyGetIconInfo?action=edit&amp;redlink=1]
--- @return void
function ArchaeologyGetIconInfo()
end

--- Returns how many digsites are in a zone like Azsuna or Elwynn Forest.
--- [https://wow.gamepedia.com/wiki/API_ArchaeologyMapUpdateAll]
--- @param uiMapID number @ UiMapID
--- @return number @ numSites
function ArchaeologyMapUpdateAll(uiMapID)
end

--- [https://wow.gamepedia.com/wiki/API_ArcheologyGetVisibleBlobID?action=edit&amp;redlink=1]
--- @return void
function ArcheologyGetVisibleBlobID()
end

--- Returns whether account-wide achievements are hidden from other players.
--- [https://wow.gamepedia.com/wiki/API_AreAccountAchievementsHidden]
--- @return boolean @ hidden
function AreAccountAchievementsHidden()
end

--- [https://wow.gamepedia.com/wiki/API_AreDangerousScriptsAllowed?action=edit&amp;redlink=1]
--- @return void
function AreDangerousScriptsAllowed()
end

--- [https://wow.gamepedia.com/wiki/API_AreTalentsLocked?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_AscendStop]
--- @return void
function AscendStop()
end

--- Assists the specified unit, setting the player's target to theirs.
--- [https://wow.gamepedia.com/wiki/API_AssistUnit]
--- @param unit string @ unit to assist.
--- @return void
function AssistUnit(unit)
end

--- [https://wow.gamepedia.com/wiki/API_AttachGlyphToSpell?action=edit&amp;redlink=1]
--- @return void
function AttachGlyphToSpell()
end

--- Toggles auto-attacking of the player's current target.
--- [https://wow.gamepedia.com/wiki/API_AttackTarget]
--- @return void
function AttackTarget()
end

--- [https://wow.gamepedia.com/wiki/API_AutoChooseCurrentGraphicsSetting?action=edit&amp;redlink=1]
--- @return void
function AutoChooseCurrentGraphicsSetting()
end

--- Automatically equips the item currently held on the cursor.
--- [https://wow.gamepedia.com/wiki/API_AutoEquipCursorItem]
--- @return void
function AutoEquipCursorItem()
end

--- [https://wow.gamepedia.com/wiki/API_AutoLootMailItem?action=edit&amp;redlink=1]
--- @return void
function AutoLootMailItem()
end

--- Allows you to withdraw an item and automatically store it in your inventory.
--- [https://wow.gamepedia.com/wiki/API_AutoStoreGuildBankItem]
...
--- [https://wow.gamepedia.com/wiki/API_BNAcceptFriendInvite?action=edit&amp;redlink=1]
--- @return void
function BNAcceptFriendInvite()
end

--- [https://wow.gamepedia.com/wiki/API_BNCheckBattleTagInviteToGuildMember?action=edit&amp;redlink=1]
--- @return void
function BNCheckBattleTagInviteToGuildMember()
end

--- [https://wow.gamepedia.com/wiki/API_BNCheckBattleTagInviteToUnit?action=edit&amp;redlink=1]
--- @return void
function BNCheckBattleTagInviteToUnit()
end

--- Returns info whether the WoW Client is connected to the Battle.net.
--- [https://wow.gamepedia.com/wiki/API_BNConnected]
--- @return boolean @ connected
function BNConnected()
end

--- [https://wow.gamepedia.com/wiki/API_BNDeclineFriendInvite?action=edit&amp;redlink=1]
--- @return void
function BNDeclineFriendInvite()
end

--- [https://wow.gamepedia.com/wiki/API_BNFeaturesEnabled?action=edit&amp;redlink=1]
--- @return void
function BNFeaturesEnabled()
end

--- [https://wow.gamepedia.com/wiki/API_BNFeaturesEnabledAndConnected?action=edit&amp;redlink=1]
--- @return void
function BNFeaturesEnabledAndConnected()
end

--- [https://wow.gamepedia.com/wiki/API_BNGetBlockedInfo?action=edit&amp;redlink=1]
--- @return void
function BNGetBlockedInfo()
end

--- [https://wow.gamepedia.com/wiki/API_BNGetDisplayName?action=edit&amp;redlink=1]
--- @return void
function BNGetDisplayName()
end

--- Returns information about the specified friend of a RealID friend
--- [https://wow.gamepedia.com/wiki/API_BNGetFOFInfo]
...
--- [https://wow.gamepedia.com/wiki/API_BNGetFriendIndex]
...
--- [https://wow.gamepedia.com/wiki/API_BNGetFriendInviteInfo]
...
--- [https://wow.gamepedia.com/wiki/API_BNGetInfo]
...
--- [https://wow.gamepedia.com/wiki/API_BNGetNumBlocked?action=edit&amp;redlink=1]
--- @return void
function BNGetNumBlocked()
end

--- [https://wow.gamepedia.com/wiki/API_BNGetNumFOF?action=edit&amp;redlink=1]
--- @return void
function BNGetNumFOF()
end

--- [https://wow.gamepedia.com/wiki/API_BNGetNumFriendInvites?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_BNGetNumFriends]
...
--- [https://wow.gamepedia.com/wiki/API_BNGetSelectedBlock?action=edit&amp;redlink=1]
--- @return void
function BNGetSelectedBlock()
end

--- [https://wow.gamepedia.com/wiki/API_BNGetSelectedFriend?action=edit&amp;redlink=1]
--- @return void
function BNGetSelectedFriend()
end

--- [https://wow.gamepedia.com/wiki/API_BNInviteFriend?action=edit&amp;redlink=1]
--- @return void
function BNInviteFriend()
end

--- [https://wow.gamepedia.com/wiki/API_BNIsBlocked?action=edit&amp;redlink=1]
--- @return void
function BNIsBlocked()
end

--- [https://wow.gamepedia.com/wiki/API_BNIsFriend?action=edit&amp;redlink=1]
--- @return void
function BNIsFriend()
end

--- [https://wow.gamepedia.com/wiki/API_BNIsSelf?action=edit&amp;redlink=1]
--- @return void
function BNIsSelf()
end

--- [https://wow.gamepedia.com/wiki/API_BNRemoveFriend?action=edit&amp;redlink=1]
--- @return void
function BNRemoveFriend()
end

--- [https://wow.gamepedia.com/wiki/API_BNRequestFOFInfo?action=edit&amp;redlink=1]
--- @return void
function BNRequestFOFInfo()
end

--- [https://wow.gamepedia.com/wiki/API_BNRequestInviteFriend?action=edit&amp;redlink=1]
--- @return void
function BNRequestInviteFriend()
end

--- [https://wow.gamepedia.com/wiki/API_BNSendFriendInvite?action=edit&amp;redlink=1]
--- @return void
function BNSendFriendInvite()
end

--- [https://wow.gamepedia.com/wiki/API_BNSendFriendInviteByID?action=edit&amp;redlink=1]
--- @return void
function BNSendFriendInviteByID()
end

--- BNSendGameData is the battle.net chat-equivalent of SendAddonMessage().
--- [https://wow.gamepedia.com/wiki/API_BNSendGameData]
...
--- [https://wow.gamepedia.com/wiki/API_BNSendSoR?action=edit&amp;redlink=1]
--- @return void
function BNSendSoR()
end

--- [https://wow.gamepedia.com/wiki/API_BNSendVerifiedBattleTagInvite?action=edit&amp;redlink=1]
--- @return void
function BNSendVerifiedBattleTagInvite()
end

--- Sends a whisper to Battle.net friends.
--- [https://wow.gamepedia.com/wiki/API_BNSendWhisper]
...
--- [https://wow.gamepedia.com/wiki/API_BNSetDND]
...
--- [https://wow.gamepedia.com/wiki/API_BNSetFriendFavoriteFlag]
...
--- [https://wow.gamepedia.com/wiki/API_BNSetFriendNote]
...
--- [https://wow.gamepedia.com/wiki/API_BNSetSelectedBlock?action=edit&amp;redlink=1]
--- @return void
function BNSetSelectedBlock()
end

--- [https://wow.gamepedia.com/wiki/API_BNSetSelectedFriend?action=edit&amp;redlink=1]
--- @return void
function BNSetSelectedFriend()
end

--- [https://wow.gamepedia.com/wiki/API_BNSummonFriendByIndex?action=edit&amp;redlink=1]
--- @return void
function BNSummonFriendByIndex()
end

--- [https://wow.gamepedia.com/wiki/API_BNTokenFindName?action=edit&amp;redlink=1]
--- @return void
function BNTokenFindName()
end

--- Map a bank item button or bag to an inventory slot button for use in inventory functions.
--- [https://wow.gamepedia.com/wiki/API_BankButtonIDToInvSlotID]
...
--- [https://wow.gamepedia.com/wiki/API_BarberShopReset]
--- @return void
function BarberShopReset()
end

--- [https://wow.gamepedia.com/wiki/API_BattlefieldMgrEntryInviteResponse?action=edit&amp;redlink=1]
--- @return void
function BattlefieldMgrEntryInviteResponse()
end

--- [https://wow.gamepedia.com/wiki/API_BattlefieldMgrExitRequest?action=edit&amp;redlink=1]
--- @return void
function BattlefieldMgrExitRequest()
end

--- [https://wow.gamepedia.com/wiki/API_BattlefieldMgrQueueInviteResponse?action=edit&amp;redlink=1]
--- @return void
function BattlefieldMgrQueueInviteResponse()
end

--- [https://wow.gamepedia.com/wiki/API_BattlefieldMgrQueueRequest?action=edit&amp;redlink=1]
--- @return void
function BattlefieldMgrQueueRequest()
end

--- [https://wow.gamepedia.com/wiki/API_BattlefieldSetPendingReportTarget?action=edit&amp;redlink=1]
--- @return void
function BattlefieldSetPendingReportTarget()
end

--- Accepts an offer to start trading with another player.
--- [https://wow.gamepedia.com/wiki/API_BeginTrade]
--- @return void
function BeginTrade()
end

--- Accepts the confirmation to bind an item by enchanting it, and proceeds with applying the enchantment.
--- [https://wow.gamepedia.com/wiki/API_BindEnchant]
--- @return void
function BindEnchant()
end

--- Breaks up large numbers (>=1000), or shortens lengthy decimal values (<1000), into a localized string.
--- [https://wow.gamepedia.com/wiki/API_BreakUpLargeNumbers]
--- @param value number @ The number to convert into a localized string
--- @return string @ valueString
function BreakUpLargeNumbers(value)
end

--- [https://wow.gamepedia.com/wiki/API_BuyGuildBankTab?action=edit&amp;redlink=1]
--- @return void
function BuyGuildBankTab()
end

--- Purchase a Guild Charter.
--- [https://wow.gamepedia.com/wiki/API_BuyGuildCharter]
...
--- [https://wow.gamepedia.com/wiki/API_BuyMerchantItem]
...
--- [https://wow.gamepedia.com/wiki/API_BuyReagentBank?action=edit&amp;redlink=1]
--- @return void
function BuyReagentBank()
end

--- Buys a service available at the current trainer.
--- [https://wow.gamepedia.com/wiki/API_BuyTrainerService]
...
--- [https://wow.gamepedia.com/wiki/API_CameraOrSelectOrMoveStart]
--- @return void
function CameraOrSelectOrMoveStart()
end

--- End Left click in the 3D game world.
--- [https://wow.gamepedia.com/wiki/API_CameraOrSelectOrMoveStop]
...
--- [https://wow.gamepedia.com/wiki/API_CameraZoomIn]
...
--- [https://wow.gamepedia.com/wiki/API_CameraZoomOut]
--- @param increment unknown
--- @return void
function CameraZoomOut(increment)
end

--- [https://wow.gamepedia.com/wiki/API_CanAffordMerchantItem?action=edit&amp;redlink=1]
--- @return void
function CanAffordMerchantItem()
end

--- [https://wow.gamepedia.com/wiki/API_CanAutoSetGamePadCursorControl?action=edit&amp;redlink=1]
--- @return void
function CanAutoSetGamePadCursorControl()
end

--- Returns whether the specified unit can be assigned a raid target marker.
--- [https://wow.gamepedia.com/wiki/API_CanBeRaidTarget]
--- @param unit string @ unitId to query.
--- @return boolean @ canBeRaidTarget
function CanBeRaidTarget(unit)
end

--- [https://wow.gamepedia.com/wiki/API_CanCancelScene?action=edit&amp;redlink=1]
--- @return void
function CanCancelScene()
end

--- [https://wow.gamepedia.com/wiki/API_CanChangePlayerDifficulty?action=edit&amp;redlink=1]
--- @return void
function CanChangePlayerDifficulty()
end

--- [https://wow.gamepedia.com/wiki/API_CanComplainInboxItem?action=edit&amp;redlink=1]
--- @return void
function CanComplainInboxItem()
end

--- [https://wow.gamepedia.com/wiki/API_CanDualWield?action=edit&amp;redlink=1]
--- @return void
function CanDualWield()
end

--- [https://wow.gamepedia.com/wiki/API_CanEditGuildBankTabInfo?action=edit&amp;redlink=1]
--- @return void
function CanEditGuildBankTabInfo()
end

--- [https://wow.gamepedia.com/wiki/API_CanEditGuildEvent?action=edit&amp;redlink=1]
--- @return void
function CanEditGuildEvent()
end

--- [https://wow.gamepedia.com/wiki/API_CanEditGuildInfo?action=edit&amp;redlink=1]
--- @return void
function CanEditGuildInfo()
end

--- [https://wow.gamepedia.com/wiki/API_CanEditGuildTabInfo?action=edit&amp;redlink=1]
--- @return void
function CanEditGuildTabInfo()
end

--- Checks if the player can edit the guild MOTD.
--- [https://wow.gamepedia.com/wiki/API_CanEditMOTD]
--- @return boolean @ canEdit
function CanEditMOTD()
end

--- [https://wow.gamepedia.com/wiki/API_CanEditPublicNote?action=edit&amp;redlink=1]
--- @return void
function CanEditPublicNote()
end

--- [https://wow.gamepedia.com/wiki/API_CanEjectPassengerFromSeat?action=edit&amp;redlink=1]
--- @return void
function CanEjectPassengerFromSeat()
end

--- [https://wow.gamepedia.com/wiki/API_CanExitVehicle?action=edit&amp;redlink=1]
--- @return void
function CanExitVehicle()
end

--- [https://wow.gamepedia.com/wiki/API_CanGamePadControlCursor?action=edit&amp;redlink=1]
--- @return void
function CanGamePadControlCursor()
end

--- [https://wow.gamepedia.com/wiki/API_CanGuildBankRepair?action=edit&amp;redlink=1]
--- @return void
function CanGuildBankRepair()
end

--- Checks if the player can demote guild members.
--- [https://wow.gamepedia.com/wiki/API_CanGuildDemote]
--- @return boolean @ canDemote
function CanGuildDemote()
end

--- [https://wow.gamepedia.com/wiki/API_CanGuildInvite]
--- @return boolean @ canInvite
function CanGuildInvite()
end

--- Checks if the player can promote guild members.
--- [https://wow.gamepedia.com/wiki/API_CanGuildPromote]
--- @return boolean @ canPromote
function CanGuildPromote()
end

--- [https://wow.gamepedia.com/wiki/API_CanGuildRemove?action=edit&amp;redlink=1]
--- @return void
function CanGuildRemove()
end

--- [https://wow.gamepedia.com/wiki/API_CanHearthAndResurrectFromArea?action=edit&amp;redlink=1]
--- @return void
function CanHearthAndResurrectFromArea()
end

--- [https://wow.gamepedia.com/wiki/API_CanInitiateWarGame?action=edit&amp;redlink=1]
--- @return void
function CanInitiateWarGame()
end

--- Returns whether you can inspect a particular unit.
--- [https://wow.gamepedia.com/wiki/API_CanInspect]
...
--- [https://wow.gamepedia.com/wiki/API_CanWithdrawGuildBankMoney?action=edit&amp;redlink=1]
--- @return void
function CanWithdrawGuildBankMoney()
end

--- Cancels the area Spirit Healer's resurrection in battlegrounds.
--- [https://wow.gamepedia.com/wiki/API_CancelAreaSpiritHeal]
--- @return void
function CancelAreaSpiritHeal()
end

--- Exits the barber shop without applying selected customizations.
--- [https://wow.gamepedia.com/wiki/API_CancelBarberShop]
--- @return void
function CancelBarberShop()
end

--- Forfeits the current duel, or declines an invitation to duel.
--- [https://wow.gamepedia.com/wiki/API_CancelDuel]
--- @return void
function CancelDuel()
end

--- [https://wow.gamepedia.com/wiki/API_CancelEmote?action=edit&amp;redlink=1]
--- @return void
function CancelEmote()
end

--- [https://wow.gamepedia.com/wiki/API_CancelGuildMembershipRequest?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_CancelItemTempEnchantment]
...
--- [https://wow.gamepedia.com/wiki/API_CancelLogout]
--- @return void
function CancelLogout()
end

--- [https://wow.gamepedia.com/wiki/API_CancelMasterLootRoll?action=edit&amp;redlink=1]
--- @return void
function CancelMasterLootRoll()
end

--- Cancels a pending equip operation.
--- [https://wow.gamepedia.com/wiki/API_CancelPendingEquip]
--- @param slot number @ equipment slot to cancel equipping an item to.
--- @return void
function CancelPendingEquip(slot)
end

--- [https://wow.gamepedia.com/wiki/API_CancelPetPossess?action=edit&amp;redlink=1]
--- @return void
function CancelPetPossess()
end

--- [https://wow.gamepedia.com/wiki/API_CancelPreloadingMovie?action=edit&amp;redlink=1]
--- @return void
function CancelPreloadingMovie()
end

--- [https://wow.gamepedia.com/wiki/API_CancelScene?action=edit&amp;redlink=1]
--- @return void
function CancelScene()
end

--- Cancels a druid's shapeshift buff.
--- [https://wow.gamepedia.com/wiki/API_CancelShapeshiftForm]
--- @return void
function CancelShapeshiftForm()
end

--- [https://wow.gamepedia.com/wiki/API_CancelSpellByName?action=edit&amp;redlink=1]
--- @return void
function CancelSpellByName()
end

--- Cancels the currently open trade.
--- [https://wow.gamepedia.com/wiki/API_CancelTrade]
--- @return void
function CancelTrade()
end

--- [https://wow.gamepedia.com/wiki/API_CancelTradeAccept?action=edit&amp;redlink=1]
--- @return void
function CancelTradeAccept()
end

--- Removes a specific buff from the unit.
--- [https://wow.gamepedia.com/wiki/API_CancelUnitBuff]
...
--- [https://wow.gamepedia.com/wiki/API_CannotBeResurrected?action=edit&amp;redlink=1]
--- @return void
function CannotBeResurrected()
end

--- [https://wow.gamepedia.com/wiki/API_CaseAccentInsensitiveParse?action=edit&amp;redlink=1]
--- @return void
function CaseAccentInsensitiveParse()
end

--- Cast the corresponding pet skill.
--- [https://wow.gamepedia.com/wiki/API_CastPetAction]
...
--- [https://wow.gamepedia.com/wiki/API_CastShapeshiftForm]
...
--- [https://wow.gamepedia.com/wiki/API_CastSpell]
...
--- [https://wow.gamepedia.com/wiki/API_CastSpellByID?action=edit&amp;redlink=1]
--- @return void
function CastSpellByID()
end

--- Casts the specified spell.
--- [https://wow.gamepedia.com/wiki/API_CastSpellByName]
...
--- [https://wow.gamepedia.com/wiki/API_CenterCamera?action=edit&amp;redlink=1]
--- @return void
function CenterCamera()
end

--- Changes the current action button to the one specified in the arguments.
--- [https://wow.gamepedia.com/wiki/API_ChangeActionBarPage]
...
--- [https://wow.gamepedia.com/wiki/API_ChangeChatColor]
...
--- [https://wow.gamepedia.com/wiki/API_ChannelBan]
...
--- [https://wow.gamepedia.com/wiki/API_ChannelInvite]
...
--- [https://wow.gamepedia.com/wiki/API_ChannelKick]
...
--- [https://wow.gamepedia.com/wiki/API_ChannelModerator]
...
--- [https://wow.gamepedia.com/wiki/API_ChannelSetAllSilent?action=edit&amp;redlink=1]
--- @return void
function ChannelSetAllSilent()
end

--- [https://wow.gamepedia.com/wiki/API_ChannelSetPartyMemberSilent?action=edit&amp;redlink=1]
--- @return void
function ChannelSetPartyMemberSilent()
end

--- Toggles the channel to display announcements either on or off.
--- [https://wow.gamepedia.com/wiki/API_ChannelToggleAnnouncements]
...
--- [https://wow.gamepedia.com/wiki/API_ChannelUnban]
...
--- [https://wow.gamepedia.com/wiki/API_ChannelUnmoderator]
...
--- [https://wow.gamepedia.com/wiki/API_CheckBinderDist?action=edit&amp;redlink=1]
--- @return void
function CheckBinderDist()
end

--- Populates client's inbox with messages.
--- [https://wow.gamepedia.com/wiki/API_CheckInbox]
--- @return void
function CheckInbox()
end

--- Checks whether you are in range to perform a specific interaction with a specified unit.
--- [https://wow.gamepedia.com/wiki/API_CheckInteractDistance]
...
--- [https://wow.gamepedia.com/wiki/API_CheckSpiritHealerDist?action=edit&amp;redlink=1]
--- @return void
function CheckSpiritHealerDist()
end

--- [https://wow.gamepedia.com/wiki/API_CheckTalentMasterDist?action=edit&amp;redlink=1]
--- @return void
function CheckTalentMasterDist()
end

--- [https://wow.gamepedia.com/wiki/API_ClearAchievementComparisonUnit?action=edit&amp;redlink=1]
--- @return void
function ClearAchievementComparisonUnit()
end

--- [https://wow.gamepedia.com/wiki/API_ClearAchievementSearchString?action=edit&amp;redlink=1]
--- @return void
function ClearAchievementSearchString()
end

--- [https://wow.gamepedia.com/wiki/API_ClearAllLFGDungeons?action=edit&amp;redlink=1]
--- @return void
function ClearAllLFGDungeons()
end

--- [https://wow.gamepedia.com/wiki/API_ClearAllTracking?action=edit&amp;redlink=1]
--- @return void
function ClearAllTracking()
end

--- [https://wow.gamepedia.com/wiki/API_ClearAutoAcceptQuestSound?action=edit&amp;redlink=1]
--- @return void
function ClearAutoAcceptQuestSound()
end

--- [https://wow.gamepedia.com/wiki/API_ClearBattlemaster?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_ClearCursor]
--- @return void
function ClearCursor()
end

--- [https://wow.gamepedia.com/wiki/API_ClearFailedPVPTalentIDs?action=edit&amp;redlink=1]
--- @return void
function ClearFailedPVPTalentIDs()
end

--- [https://wow.gamepedia.com/wiki/API_ClearFailedTalentIDs?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_ClearFocus]
--- @return void
function ClearFocus()
end

--- [https://wow.gamepedia.com/wiki/API_ClearInspectPlayer?action=edit&amp;redlink=1]
--- @return void
function ClearInspectPlayer()
end

--- [https://wow.gamepedia.com/wiki/API_ClearItemUpgrade?action=edit&amp;redlink=1]
--- @return void
function ClearItemUpgrade()
end

--- Removes all override bindings owned by a particular frame.
--- [https://wow.gamepedia.com/wiki/API_ClearOverrideBindings]
--- @param owner Frame @ The frame to clear override bindings for.
--- @return void
function ClearOverrideBindings(owner)
end

--- [https://wow.gamepedia.com/wiki/API_ClearPartyAssignment?action=edit&amp;redlink=1]
--- @return void
function ClearPartyAssignment()
end

--- [https://wow.gamepedia.com/wiki/API_ClearRaidMarker?action=edit&amp;redlink=1]
--- @return void
function ClearRaidMarker()
end

--- [https://wow.gamepedia.com/wiki/API_ClearSendMail]
--- @return void
function ClearSendMail()
end

--- Clears the player's target.
--- [https://wow.gamepedia.com/wiki/API_ClearTarget]
--- @return void
function ClearTarget()
end

--- [https://wow.gamepedia.com/wiki/API_ClearTutorials?action=edit&amp;redlink=1]
--- @return void
function ClearTutorials()
end

--- Clears the specified Void Transfer deposit slot [1]
--- [https://wow.gamepedia.com/wiki/API_ClearVoidTransferDepositSlot]
...
--- [https://wow.gamepedia.com/wiki/API_ClickSendMailItemButton]
...
--- [https://wow.gamepedia.com/wiki/API_ClickSocketButton?action=edit&amp;redlink=1]
--- @return void
function ClickSocketButton()
end

--- [https://wow.gamepedia.com/wiki/API_ClickTargetTradeButton?action=edit&amp;redlink=1]
--- @return void
function ClickTargetTradeButton()
end

--- [https://wow.gamepedia.com/wiki/API_ClickTradeButton?action=edit&amp;redlink=1]
--- @return void
function ClickTradeButton()
end

--- Clicks the specified Void Storage slot [1]
--- [https://wow.gamepedia.com/wiki/API_ClickVoidStorageSlot]
...
--- [https://wow.gamepedia.com/wiki/API_ClickVoidTransferDepositSlot]
...
--- [https://wow.gamepedia.com/wiki/API_ClickVoidTransferWithdrawalSlot]
...
--- [https://wow.gamepedia.com/wiki/API_ClickWorldMapActionButton?action=edit&amp;redlink=1]
--- @return void
function ClickWorldMapActionButton()
end

--- Will Close the Bank Frame if opened.
--- [https://wow.gamepedia.com/wiki/API_CloseBankFrame]
--- @return void
function CloseBankFrame()
end

--- [https://wow.gamepedia.com/wiki/API_CloseGuildBankFrame?action=edit&amp;redlink=1]
--- @return void
function CloseGuildBankFrame()
end

--- [https://wow.gamepedia.com/wiki/API_CloseGuildRegistrar?action=edit&amp;redlink=1]
--- @return void
function CloseGuildRegistrar()
end

--- [https://wow.gamepedia.com/wiki/API_CloseGuildRoster?action=edit&amp;redlink=1]
--- @return void
function CloseGuildRoster()
end

--- Close an open item text (book, plaque, etc).
--- [https://wow.gamepedia.com/wiki/API_CloseItemText]
--- @return void
function CloseItemText()
end

--- [https://wow.gamepedia.com/wiki/API_CloseItemUpgrade?action=edit&amp;redlink=1]
--- @return void
function CloseItemUpgrade()
end

--- Close the loot window.
--- [https://wow.gamepedia.com/wiki/API_CloseLoot]
...
--- [https://wow.gamepedia.com/wiki/API_CloseMail]
--- @return void
function CloseMail()
end

--- [https://wow.gamepedia.com/wiki/API_CloseMerchant]
--- @return void
function CloseMerchant()
end

--- [https://wow.gamepedia.com/wiki/API_ClosePetStables]
--- @return void
function ClosePetStables()
end

--- Closes a petition that has been presented to the player.
--- [https://wow.gamepedia.com/wiki/API_ClosePetition]
--- @return void
function ClosePetition()
end

--- [https://wow.gamepedia.com/wiki/API_ClosePlayerChoice?action=edit&amp;redlink=1]
--- @return void
function ClosePlayerChoice()
end

--- [https://wow.gamepedia.com/wiki/API_CloseQuest?action=edit&amp;redlink=1]
--- @return void
function CloseQuest()
end

--- [https://wow.gamepedia.com/wiki/API_CloseResearch?action=edit&amp;redlink=1]
--- @return void
function CloseResearch()
end

--- Stops considering the item for socketing, ignoring any tentative changes made.
--- [https://wow.gamepedia.com/wiki/API_CloseSocketInfo]
--- @return void
function CloseSocketInfo()
end

--- [https://wow.gamepedia.com/wiki/API_CloseTabardCreation?action=edit&amp;redlink=1]
--- @return void
function CloseTabardCreation()
end

--- Closes your Flightpath Map.
--- [https://wow.gamepedia.com/wiki/API_CloseTaxiMap]
--- @return void
function CloseTaxiMap()
end

--- Closes the trade window.
--- [https://wow.gamepedia.com/wiki/API_CloseTrade]
--- @return void
function CloseTrade()
end

--- [https://wow.gamepedia.com/wiki/API_CloseTrainer]
--- @return void
function CloseTrainer()
end

--- [https://wow.gamepedia.com/wiki/API_CloseVoidStorageFrame?action=edit&amp;redlink=1]
--- @return void
function CloseVoidStorageFrame()
end

--- [https://wow.gamepedia.com/wiki/API_ClosestGameObjectPosition?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_ClosestUnitPosition]
...
--- [https://wow.gamepedia.com/wiki/API_CollapseAllFactionHeaders?action=edit&amp;redlink=1]
--- @return void
function CollapseAllFactionHeaders()
end

--- Collapse a faction header row.
--- [https://wow.gamepedia.com/wiki/API_CollapseFactionHeader]
...
--- [https://wow.gamepedia.com/wiki/API_CollapseGuildTradeSkillHeader?action=edit&amp;redlink=1]
--- @return void
function CollapseGuildTradeSkillHeader()
end

--- Collapses the quest header.
--- [https://wow.gamepedia.com/wiki/API_CollapseQuestHeader]
...
--- [https://wow.gamepedia.com/wiki/API_CollapseWarGameHeader?action=edit&amp;redlink=1]
--- @return void
function CollapseWarGameHeader()
end

--- [https://wow.gamepedia.com/wiki/API_CombatLogAddFilter?action=edit&amp;redlink=1]
--- @return void
function CombatLogAddFilter()
end

--- [https://wow.gamepedia.com/wiki/API_CombatLogAdvanceEntry?action=edit&amp;redlink=1]
--- @return void
function CombatLogAdvanceEntry()
end

--- [https://wow.gamepedia.com/wiki/API_CombatLogClearEntries?action=edit&amp;redlink=1]
--- @return void
function CombatLogClearEntries()
end

--- [https://wow.gamepedia.com/wiki/API_CombatLogGetCurrentEntry?action=edit&amp;redlink=1]
--- @return void
function CombatLogGetCurrentEntry()
end

--- Returns the current COMBAT_LOG_EVENT payload.
--- [https://wow.gamepedia.com/wiki/API_CombatLogGetCurrentEventInfo]
--- @return unknown @ eventInfo
function CombatLogGetCurrentEventInfo()
end

--- [https://wow.gamepedia.com/wiki/API_CombatLogGetNumEntries?action=edit&amp;redlink=1]
--- @return void
function CombatLogGetNumEntries()
end

--- [https://wow.gamepedia.com/wiki/API_CombatLogGetRetentionTime?action=edit&amp;redlink=1]
--- @return void
function CombatLogGetRetentionTime()
end

--- [https://wow.gamepedia.com/wiki/API_CombatLogResetFilter?action=edit&amp;redlink=1]
--- @return void
function CombatLogResetFilter()
end

--- [https://wow.gamepedia.com/wiki/API_CombatLogSetCurrentEntry?action=edit&amp;redlink=1]
--- @return void
function CombatLogSetCurrentEntry()
end

--- [https://wow.gamepedia.com/wiki/API_CombatLogSetRetentionTime?action=edit&amp;redlink=1]
--- @return void
function CombatLogSetRetentionTime()
end

--- Compares two UnitFlag bitfields.
--- [https://wow.gamepedia.com/wiki/API_CombatLog_Object_IsA]
...
--- [https://wow.gamepedia.com/wiki/API_CombatTextSetActiveUnit]
--- @param unit string @ UnitId of the entity you want receive notifications for.
--- @return void
function CombatTextSetActiveUnit(unit)
end

--- [https://wow.gamepedia.com/wiki/API_ComplainInboxItem?action=edit&amp;redlink=1]
--- @return void
function ComplainInboxItem()
end

--- [https://wow.gamepedia.com/wiki/API_CompleteLFGReadyCheck?action=edit&amp;redlink=1]
--- @return void
function CompleteLFGReadyCheck()
end

--- [https://wow.gamepedia.com/wiki/API_CompleteLFGRoleCheck?action=edit&amp;redlink=1]
--- @return void
function CompleteLFGRoleCheck()
end

--- Advances the quest completion dialog to the reward selection step.
--- [https://wow.gamepedia.com/wiki/API_CompleteQuest]
--- @return void
function CompleteQuest()
end

--- Accept an escort quest being started by a player nearby.
--- [https://wow.gamepedia.com/wiki/API_ConfirmAcceptQuest]
--- @return void
function ConfirmAcceptQuest()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_ConfirmBNRequestInviteFriend]
...
--- [https://wow.gamepedia.com/wiki/API_ConfirmBindOnUse]
--- @return void
function ConfirmBindOnUse()
end

--- [https://wow.gamepedia.com/wiki/API_ConfirmBinder?action=edit&amp;redlink=1]
--- @return void
function ConfirmBinder()
end

--- Confirm your loot roll after either CONFIRM_LOOT_ROLL or CONFIRM_DISENCHANT_ROLL fires.
--- [https://wow.gamepedia.com/wiki/API_ConfirmLootRoll]
...
--- [https://wow.gamepedia.com/wiki/API_ConfirmLootSlot]
--- @param slot number @ the loot slot of a BoP loot item that is waiting for confirmation
--- @return void
function ConfirmLootSlot(slot)
end

--- [https://wow.gamepedia.com/wiki/API_ConfirmNoRefundOnUse?action=edit&amp;redlink=1]
--- @return void
function ConfirmNoRefundOnUse()
end

--- [https://wow.gamepedia.com/wiki/API_ConfirmOnUse?action=edit&amp;redlink=1]
--- @return void
function ConfirmOnUse()
end

--- Sends a response to a raid ready check
--- [https://wow.gamepedia.com/wiki/API_ConfirmReadyCheck]
...
--- [https://wow.gamepedia.com/wiki/API_ConfirmTalentWipe?action=edit&amp;redlink=1]
--- @return void
function ConfirmTalentWipe()
end

--- [https://wow.gamepedia.com/wiki/API_ConsoleAddMessage?action=edit&amp;redlink=1]
--- @return void
function ConsoleAddMessage()
end

--- Execute a console command.
--- [https://wow.gamepedia.com/wiki/API_ConsoleExec]
...
--- [https://wow.gamepedia.com/wiki/API_ContainerIDToInventoryID]
--- @param containerID unknown
--- @return number @ bagID
function ContainerIDToInventoryID(containerID)
end

--- [https://wow.gamepedia.com/wiki/API_ContainerRefundItemPurchase?action=edit&amp;redlink=1]
--- @return void
function ContainerRefundItemPurchase()
end

--- [https://wow.gamepedia.com/wiki/API_CopyToClipboard?action=edit&amp;redlink=1]
--- @return void
function CopyToClipboard()
end

--- Creates a font object.
--- [https://wow.gamepedia.com/wiki/API_CreateFont]
...
--- [https://wow.gamepedia.com/wiki/API_CreateFrame]
...
--- [https://wow.gamepedia.com/wiki/API_CreateMacro]
...
--- [https://wow.gamepedia.com/wiki/API_CreateNewRaidProfile?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_CursorCanGoInSlot]
...
--- [https://wow.gamepedia.com/wiki/API_CursorHasItem]
--- @return boolean @ hasItem
function CursorHasItem()
end

--- [https://wow.gamepedia.com/wiki/API_CursorHasMacro?action=edit&amp;redlink=1]
--- @return void
function CursorHasMacro()
end

--- [https://wow.gamepedia.com/wiki/API_CursorHasMoney?action=edit&amp;redlink=1]
--- @return void
function CursorHasMoney()
end

--- [https://wow.gamepedia.com/wiki/API_CursorHasSpell?action=edit&amp;redlink=1]
--- @return void
function CursorHasSpell()
end

--- Returns a table representing the last five damaging combat events against the player.
--- [https://wow.gamepedia.com/wiki/API_DeathRecap_GetEvents]
...
--- [https://wow.gamepedia.com/wiki/API_DeclineGroup?action=edit&amp;redlink=1]
--- @return void
function DeclineGroup()
end

--- Declines a guild invitation.
--- [https://wow.gamepedia.com/wiki/API_DeclineGuild]
--- @return void
function DeclineGuild()
end

--- [https://wow.gamepedia.com/wiki/API_DeclineGuildApplicant?action=edit&amp;redlink=1]
--- @return void
function DeclineGuildApplicant()
end

--- [https://wow.gamepedia.com/wiki/API_DeclineName?action=edit&amp;redlink=1]
--- @return void
function DeclineName()
end

--- Declines the currently offered quest.
--- [https://wow.gamepedia.com/wiki/API_DeclineQuest]
--- @return void
function DeclineQuest()
end

--- Declines a resurrection offer.
--- [https://wow.gamepedia.com/wiki/API_DeclineResurrect]
--- @return void
function DeclineResurrect()
end

--- Declines a spell confirmation prompt (e.g. bonus loot roll).
--- [https://wow.gamepedia.com/wiki/API_DeclineSpellConfirmationPrompt]
...
--- [https://wow.gamepedia.com/wiki/API_DeleteCursorItem]
--- @return void
function DeleteCursorItem()
end

--- [https://wow.gamepedia.com/wiki/API_DeleteGMTicket?action=edit&amp;redlink=1]
--- @return void
function DeleteGMTicket()
end

--- Asynchronously request the server to remove a message from the mailbox.
--- [https://wow.gamepedia.com/wiki/API_DeleteInboxItem]
...
--- Deletes a macro.
--- [https://wow.gamepedia.com/wiki/API_DeleteMacro]
--- @param index_or_macroname unknown
--- @return void
function DeleteMacro(index_or_macroname)
end

--- [https://wow.gamepedia.com/wiki/API_DeleteRaidProfile?action=edit&amp;redlink=1]
--- @return void
function DeleteRaidProfile()
end

--- [https://wow.gamepedia.com/wiki/API_DemoteAssistant?action=edit&amp;redlink=1]
--- @return void
function DemoteAssistant()
end

--- [https://wow.gamepedia.com/wiki/API_DepositGuildBankMoney?action=edit&amp;redlink=1]
--- @return void
function DepositGuildBankMoney()
end

--- [https://wow.gamepedia.com/wiki/API_DepositReagentBank?action=edit&amp;redlink=1]
--- @return void
function DepositReagentBank()
end

--- The player stops descending (while flying or swimming).
--- [https://wow.gamepedia.com/wiki/API_DescendStop]
--- @return void
function DescendStop()
end

--- Destroys a totem/minion.
--- [https://wow.gamepedia.com/wiki/API_DestroyTotem]
...
--- [https://wow.gamepedia.com/wiki/API_DetectWowMouse?action=edit&amp;redlink=1]
--- @return void
function DetectWowMouse()
end

--- Disable an AddOn for subsequent sessions.
--- [https://wow.gamepedia.com/wiki/API_DisableAddOn]
...
--- [https://wow.gamepedia.com/wiki/API_DisableAllAddOns]
--- @return void
function DisableAllAddOns()
end

--- [https://wow.gamepedia.com/wiki/API_DisableSpellAutocast?action=edit&amp;redlink=1]
--- @return void
function DisableSpellAutocast()
end

--- Dismisses a currently-summoned mount or non-combat pet.
--- [https://wow.gamepedia.com/wiki/API_DismissCompanion]
...
--- [https://wow.gamepedia.com/wiki/API_DoMasterLootRoll?action=edit&amp;redlink=1]
--- @return void
function DoMasterLootRoll()
end

--- [https://wow.gamepedia.com/wiki/API_DoReadyCheck]
--- @return void
function DoReadyCheck()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_DoesCurrentLocaleSellExpansionLevels]
--- @return boolean @ regionSellsExpansions
function DoesCurrentLocaleSellExpansionLevels()
end

--- [https://wow.gamepedia.com/wiki/API_DoesItemContainSpec?action=edit&amp;redlink=1]
--- @return void
function DoesItemContainSpec()
end

--- This function returns true if the player character knows the spell.
--- [https://wow.gamepedia.com/wiki/API_DoesSpellExist]
--- @param spellName string
--- @return boolean @ spellExists
function DoesSpellExist(spellName)
end

--- [https://wow.gamepedia.com/wiki/API_DoesTemplateExist?action=edit&amp;redlink=1]
--- @return void
function DoesTemplateExist()
end

--- [https://wow.gamepedia.com/wiki/API_DropCursorMoney]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_EJ_GetCurrentTier]
--- @return number @ index
function EJ_GetCurrentTier()
end

--- Returns the currently viewed difficulty in the journal.
--- [https://wow.gamepedia.com/wiki/API_EJ_GetDifficulty]
--- @return number @ difficultyId
function EJ_GetDifficulty()
end

--- Returns encounter info from the journal.
--- [https://wow.gamepedia.com/wiki/API_EJ_GetEncounterInfo]
...
--- Returns encounter info from the journal.
--- [https://wow.gamepedia.com/wiki/API_EJ_GetEncounterInfoByIndex]
--- @return void
function EJ_GetEncounterInfoByIndex()
end

--- Returns instance info for the Encounter Journal.
--- [https://wow.gamepedia.com/wiki/API_EJ_GetInstanceByIndex]
--- @param index number
...
--- [https://wow.gamepedia.com/wiki/API_EJ_GetInstanceForMap]
--- @param mapID number
...
--- Returns instance info for the Encounter Journal.
--- [https://wow.gamepedia.com/wiki/API_EJ_GetInstanceInfo]
...
--- [https://wow.gamepedia.com/wiki/API_EJ_GetInvTypeSortOrder]
...
--- [https://wow.gamepedia.com/wiki/API_EJ_GetLootFilter]
...
--- [https://wow.gamepedia.com/wiki/API_EJ_GetMapEncounter]
--- @param mapID unknown
...
--- [https://wow.gamepedia.com/wiki/API_EJ_GetNumEncountersForLootByIndex]
...
--- [https://wow.gamepedia.com/wiki/API_EJ_GetSearchSize]
--- @return number @ searchSize
function EJ_GetSearchSize()
end

--- Returns the parent Section ID if available.
--- [https://wow.gamepedia.com/wiki/API_EJ_GetSectionPath]
...
--- [https://wow.gamepedia.com/wiki/API_EJ_GetTierInfo]
...
--- [https://wow.gamepedia.com/wiki/API_EJ_HandleLinkPath]
...
--- [https://wow.gamepedia.com/wiki/API_EJ_InstanceIsRaid]
...
--- [https://wow.gamepedia.com/wiki/API_EJ_ResetLootFilter]
--- @return void
function EJ_ResetLootFilter()
end

--- Selects an encounter for the Encounter Journal API state.
--- [https://wow.gamepedia.com/wiki/API_EJ_SelectEncounter]
--- @param encounterID number
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_EJ_SelectInstance]
...
--- [https://wow.gamepedia.com/wiki/API_EJ_SelectTier]
...
--- [https://wow.gamepedia.com/wiki/API_EJ_SetDifficulty]
...
--- [https://wow.gamepedia.com/wiki/API_EJ_SetLootFilter]
...
--- [https://wow.gamepedia.com/wiki/API_EJ_SetSearch]
--- @param text string
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_EditMacro]
--- @param index_or_macroName unknown
...
--- [https://wow.gamepedia.com/wiki/API_EjectPassengerFromSeat?action=edit&amp;redlink=1]
--- @return void
function EjectPassengerFromSeat()
end

--- Enables an AddOn for subsequent sessions.
--- [https://wow.gamepedia.com/wiki/API_EnableAddOn]
--- @param index_or_name unknown
--- @param character string @ The name of the character (without realm) for whom to disable the addon, Defaults to the current character.
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_EnableAllAddOns]
--- @return void
function EnableAllAddOns()
end

--- [https://wow.gamepedia.com/wiki/API_EnableSpellAutocast?action=edit&amp;redlink=1]
--- @return void
function EnableSpellAutocast()
end

--- [https://wow.gamepedia.com/wiki/API_EndBoundTradeable?action=edit&amp;redlink=1]
--- @return void
function EndBoundTradeable()
end

--- [https://wow.gamepedia.com/wiki/API_EndRefund?action=edit&amp;redlink=1]
--- @return void
function EndRefund()
end
...
--- [https://wow.gamepedia.com/wiki/API_EnumerateFrames]
...
--- [https://wow.gamepedia.com/wiki/API_EnumerateServerChannels]
...
--- [https://wow.gamepedia.com/wiki/API_EquipCursorItem]
...
--- [https://wow.gamepedia.com/wiki/API_EquipItemByName]
...
--- [https://wow.gamepedia.com/wiki/API_EquipPendingItem]
...
--- [https://wow.gamepedia.com/wiki/API_ExecuteVoidTransfer]
--- @return void
function ExecuteVoidTransfer()
end

--- [https://wow.gamepedia.com/wiki/API_ExpandAllFactionHeaders?action=edit&amp;redlink=1]
--- @return void
function ExpandAllFactionHeaders()
end

--- Expand a faction header row.
--- [https://wow.gamepedia.com/wiki/API_ExpandFactionHeader]
...
--- [https://wow.gamepedia.com/wiki/API_ExpandGuildTradeSkillHeader?action=edit&amp;redlink=1]
--- @return void
function ExpandGuildTradeSkillHeader()
end

--- Expands the quest header.
--- [https://wow.gamepedia.com/wiki/API_ExpandQuestHeader]
...
--- [https://wow.gamepedia.com/wiki/API_ExpandWarGameHeader?action=edit&amp;redlink=1]
--- @return void
function ExpandWarGameHeader()
end

--- Toggle the At War status of a faction row.
--- [https://wow.gamepedia.com/wiki/API_FactionToggleAtWar]
...
--- [https://wow.gamepedia.com/wiki/API_FillLocalizedClassList]
...
--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_FindBaseSpellByID]
--- @param spellID number
--- @return number @ baseSpellID
function FindBaseSpellByID(spellID)
end

--- [https://wow.gamepedia.com/wiki/API_FindFlyoutSlotBySpellID?action=edit&amp;redlink=1]
--- @return void
function FindFlyoutSlotBySpellID()
end

--- [https://wow.gamepedia.com/wiki/API_FindSpellBookSlotBySpellID?action=edit&amp;redlink=1]
--- @return void
function FindSpellBookSlotBySpellID()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_FindSpellOverrideByID]
--- @param spellID number
--- @return number @ overrideSpellID
function FindSpellOverrideByID(spellID)
end

--- [https://wow.gamepedia.com/wiki/API_FlagTutorial?action=edit&amp;redlink=1]
--- @return void
function FlagTutorial()
end

--- Flashes the game client icon in the Operating System (does not require a hardware event).
--- [https://wow.gamepedia.com/wiki/API_FlashClientIcon]
--- @return void
function FlashClientIcon()
end

--- Rotates the camera about the Z-axis.
--- [https://wow.gamepedia.com/wiki/API_FlipCameraYaw]
--- @param angle number
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_FlyoutHasSpell]
...
--- [https://wow.gamepedia.com/wiki/API_FocusUnit]
...
--- [https://wow.gamepedia.com/wiki/API_FollowUnit]
...
--- [https://wow.gamepedia.com/wiki/API_ForceLogout]
--- @return void
function ForceLogout()
end

--- Instantly quits the game, bypassing the usual 20 seconds countdown.
--- [https://wow.gamepedia.com/wiki/API_ForceQuit]
--- @return void
function ForceQuit()
end

--- [https://wow.gamepedia.com/wiki/API_ForfeitDuel?action=edit&amp;redlink=1]
--- @return void
function ForfeitDuel()
end

--- [https://wow.gamepedia.com/wiki/API_FrameXML_Debug?action=edit&amp;redlink=1]
--- @return void
function FrameXML_Debug()
end

--- [https://wow.gamepedia.com/wiki/API_GMEuropaBugsEnabled?action=edit&amp;redlink=1]
--- @return void
function GMEuropaBugsEnabled()
end

--- [https://wow.gamepedia.com/wiki/API_GMEuropaComplaintsEnabled?action=edit&amp;redlink=1]
--- @return void
function GMEuropaComplaintsEnabled()
end

--- [https://wow.gamepedia.com/wiki/API_GMEuropaSuggestionsEnabled?action=edit&amp;redlink=1]
--- @return void
function GMEuropaSuggestionsEnabled()
end

--- [https://wow.gamepedia.com/wiki/API_GMEuropaTicketsEnabled?action=edit&amp;redlink=1]
--- @return void
function GMEuropaTicketsEnabled()
end

--- [https://wow.gamepedia.com/wiki/API_GMItemRestorationButtonEnabled?action=edit&amp;redlink=1]
--- @return void
function GMItemRestorationButtonEnabled()
end

--- [https://wow.gamepedia.com/wiki/API_GMQuickTicketSystemEnabled?action=edit&amp;redlink=1]
--- @return void
function GMQuickTicketSystemEnabled()
end

--- [https://wow.gamepedia.com/wiki/API_GMQuickTicketSystemThrottled?action=edit&amp;redlink=1]
--- @return void
function GMQuickTicketSystemThrottled()
end

--- [https://wow.gamepedia.com/wiki/API_GMReportLag?action=edit&amp;redlink=1]
--- @return void
function GMReportLag()
end

--- [https://wow.gamepedia.com/wiki/API_GMRequestPlayerInfo]
--- @return void
function GMRequestPlayerInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GMResponseResolve?action=edit&amp;redlink=1]
--- @return void
function GMResponseResolve()
end

--- [https://wow.gamepedia.com/wiki/API_GMSurveyAnswer?action=edit&amp;redlink=1]
--- @return void
function GMSurveyAnswer()
end

--- [https://wow.gamepedia.com/wiki/API_GMSurveyAnswerSubmit?action=edit&amp;redlink=1]
--- @return void
function GMSurveyAnswerSubmit()
end

--- [https://wow.gamepedia.com/wiki/API_GMSurveyCommentSubmit?action=edit&amp;redlink=1]
--- @return void
function GMSurveyCommentSubmit()
end

--- [https://wow.gamepedia.com/wiki/API_GMSurveyNumAnswers?action=edit&amp;redlink=1]
--- @return void
function GMSurveyNumAnswers()
end

--- Usage: GMSurveyGetQuestion(index)
--- [https://wow.gamepedia.com/wiki/API_GMSurveyQuestion]
--- @return void
function GMSurveyQuestion()
end

--- [https://wow.gamepedia.com/wiki/API_GMSurveySubmit?action=edit&amp;redlink=1]
--- @return void
function GMSurveySubmit()
end

--- [https://wow.gamepedia.com/wiki/API_GameMovieFinished?action=edit&amp;redlink=1]
--- @return void
function GameMovieFinished()
end

--- Returns the expansion level the account has been flagged for.
--- [https://wow.gamepedia.com/wiki/API_GetAccountExpansionLevel]
--- @return number @ expansionLevel
function GetAccountExpansionLevel()
end

--- Returns the category number the requested achievement belongs to.
--- [https://wow.gamepedia.com/wiki/API_GetAchievementCategory]
...
--- [https://wow.gamepedia.com/wiki/API_GetAchievementComparisonInfo]
--- @param achievementID number @ ID of the achievement to retrieve information for.
...
--- [https://wow.gamepedia.com/wiki/API_GetAchievementCriteriaInfo]
...
--- Returns information about the given Achievement's specified criteria.
--- [https://wow.gamepedia.com/wiki/API_GetAchievementCriteriaInfoByID]
--- @param achievementID number
...
--- [https://wow.gamepedia.com/wiki/API_GetAchievementGuildRep?action=edit&amp;redlink=1]
--- @return void
function GetAchievementGuildRep()
end

--- Returns information about an Achievement.
--- [https://wow.gamepedia.com/wiki/API_GetAchievementInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetAchievementLink]
...
--- [https://wow.gamepedia.com/wiki/API_GetAchievementNumCriteria]
...
--- [https://wow.gamepedia.com/wiki/API_GetAchievementNumRewards?action=edit&amp;redlink=1]
--- @return void
function GetAchievementNumRewards()
end

--- [https://wow.gamepedia.com/wiki/API_GetAchievementReward?action=edit&amp;redlink=1]
--- @return void
function GetAchievementReward()
end

--- [https://wow.gamepedia.com/wiki/API_GetAchievementSearchProgress?action=edit&amp;redlink=1]
--- @return void
function GetAchievementSearchProgress()
end

--- [https://wow.gamepedia.com/wiki/API_GetAchievementSearchSize?action=edit&amp;redlink=1]
--- @return void
function GetAchievementSearchSize()
end

--- [https://wow.gamepedia.com/wiki/API_GetActionAutocast?action=edit&amp;redlink=1]
--- @return void
function GetActionAutocast()
end

--- Returns the index of the currently-selected action bar page.
--- [https://wow.gamepedia.com/wiki/API_GetActionBarPage]
--- @return number @ index
function GetActionBarPage()
end

--- Gets the toggle states of the extra action bars.
--- [https://wow.gamepedia.com/wiki/API_GetActionBarToggles]
...
--- [https://wow.gamepedia.com/wiki/API_GetActionCharges]
...
--- [https://wow.gamepedia.com/wiki/API_GetActionCooldown]
--- @param slot number @ The action slot to retrieve data from.
...
--- [https://wow.gamepedia.com/wiki/API_GetActionCount]
...
--- [https://wow.gamepedia.com/wiki/API_GetActionInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetActionLossOfControlCooldown]
...
--- [https://wow.gamepedia.com/wiki/API_GetActionText]
...
--- [https://wow.gamepedia.com/wiki/API_GetActionTexture]
--- @param actionSlot unknown
...
--- [https://wow.gamepedia.com/wiki/API_GetActiveArtifactByRace]
...
--- [https://wow.gamepedia.com/wiki/API_GetActiveLevel?action=edit&amp;redlink=1]
--- @return void
function GetActiveLevel()
end

--- [https://wow.gamepedia.com/wiki/API_GetActiveLootRollIDs?action=edit&amp;redlink=1]
--- @return void
function GetActiveLootRollIDs()
end

--- [https://wow.gamepedia.com/wiki/API_GetActiveQuestID?action=edit&amp;redlink=1]
--- @return void
function GetActiveQuestID()
end

--- Returns the index of the current active specialization/talent/glyph group.
--- [https://wow.gamepedia.com/wiki/API_GetActiveSpecGroup]
...
--- [https://wow.gamepedia.com/wiki/API_GetActiveTitle?action=edit&amp;redlink=1]
--- @return void
function GetActiveTitle()
end

--- Returns the total time used by the specified AddOn.
--- [https://wow.gamepedia.com/wiki/API_GetAddOnCPUUsage]
--- @param index_or_name unknown
--- @return number @ time
...
--- [https://wow.gamepedia.com/wiki/API_GetAddOnDependencies]
--- @param index_or_name unknown
...
--- [https://wow.gamepedia.com/wiki/API_GetAddOnEnableState]
...
--- [https://wow.gamepedia.com/wiki/API_GetAddOnInfo]
--- @param index_or_name unknown
...
--- [https://wow.gamepedia.com/wiki/API_GetAddOnMemoryUsage?action=edit&amp;redlink=1]
--- @return void
function GetAddOnMemoryUsage()
end

--- Returns addon metadata.
--- [https://wow.gamepedia.com/wiki/API_GetAddOnMetadata]
...
--- [https://wow.gamepedia.com/wiki/API_GetAddOnOptionalDependencies?action=edit&amp;redlink=1]
--- @return void
function GetAddOnOptionalDependencies()
end

--- [https://wow.gamepedia.com/wiki/API_GetAllowLowLevelRaid?action=edit&amp;redlink=1]
--- @return void
function GetAllowLowLevelRaid()
end

--- [https://wow.gamepedia.com/wiki/API_GetAlternativeDefaultLanguage?action=edit&amp;redlink=1]
--- @return void
function GetAlternativeDefaultLanguage()
end

--- Returns the localized name for Archaeology.
--- [https://wow.gamepedia.com/wiki/API_GetArchaeologyInfo]
--- @return unknown @ izedName
function GetArchaeologyInfo()
end

--- Returns the information for a specific race used in Archaeology.
--- [https://wow.gamepedia.com/wiki/API_GetArchaeologyRaceInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetArchaeologyRaceInfoByID]
...
--- [https://wow.gamepedia.com/wiki/API_GetAreaSpiritHealerTime]
--- @return number @ timeleft
function GetAreaSpiritHealerTime()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_GetAreaText]
--- @return string @ areaText
function GetAreaText()
end

--- [https://wow.gamepedia.com/wiki/API_GetArenaOpponentSpec?action=edit&amp;redlink=1]
--- @return void
function GetArenaOpponentSpec()
end

--- Returns the information for a specific race's artifact.
--- [https://wow.gamepedia.com/wiki/API_GetArtifactInfoByRace]
...
--- [https://wow.gamepedia.com/wiki/API_GetArtifactProgress]
...
--- [https://wow.gamepedia.com/wiki/API_GetAttackPowerForStat]
...
--- [https://wow.gamepedia.com/wiki/API_GetAutoCompletePresenceID?action=edit&amp;redlink=1]
--- @return void
function GetAutoCompletePresenceID()
end

--- Returns a table of realm names for auto-completion.
--- [https://wow.gamepedia.com/wiki/API_GetAutoCompleteRealms]
...
--- [https://wow.gamepedia.com/wiki/API_GetAutoCompleteResults]
...
--- [https://wow.gamepedia.com/wiki/API_GetAutoDeclineGuildInvites]
--- @return number @ enabled
function GetAutoDeclineGuildInvites()
end

--- Returns information about a popup quest notification.
--- [https://wow.gamepedia.com/wiki/API_GetAutoQuestPopUp]
...
--- [https://wow.gamepedia.com/wiki/API_GetAvailableBandwidth?action=edit&amp;redlink=1]
--- @return void
function GetAvailableBandwidth()
end

--- [https://wow.gamepedia.com/wiki/API_GetAvailableLevel?action=edit&amp;redlink=1]
--- @return void
function GetAvailableLevel()
end

--- Two functions return lists of the available locales:
--- [https://wow.gamepedia.com/wiki/API_GetAvailableLocaleInfo]
...
--- Two functions return lists of the available locales:
--- [https://wow.gamepedia.com/wiki/API_GetAvailableLocales]
--- @param ignoreLocalRestrictions boolean @ Returns the complete list, not only those locales which the game client might use in the current region (NA, Europe, etc.)
...
--- [https://wow.gamepedia.com/wiki/API_GetAvailableQuestInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetAvailableTitle?action=edit&amp;redlink=1]
--- @return void
function GetAvailableTitle()
end

--- Returns the average item level of the player's character and average item level equipped.
--- [https://wow.gamepedia.com/wiki/API_GetAverageItemLevel]
--- @return number, number, number @ avgItemLevel, avgItemLevelEquipped, avgItemLevelPvp
function GetAverageItemLevel()
end

--- [https://wow.gamepedia.com/wiki/API_GetAvoidance?action=edit&amp;redlink=1]
--- @return void
function GetAvoidance()
end

--- [https://wow.gamepedia.com/wiki/API_GetBackgroundLoadingStatus?action=edit&amp;redlink=1]
--- @return void
function GetBackgroundLoadingStatus()
end

--- [https://wow.gamepedia.com/wiki/API_GetBackpackAutosortDisabled?action=edit&amp;redlink=1]
--- @return void
function GetBackpackAutosortDisabled()
end

--- Returns the name of the bag for the selected index
--- [https://wow.gamepedia.com/wiki/API_GetBagName]
...
--- [https://wow.gamepedia.com/wiki/API_GetBagSlotFlag?action=edit&amp;redlink=1]
--- @return void
function GetBagSlotFlag()
end

--- [https://wow.gamepedia.com/wiki/API_GetBankAutosortDisabled?action=edit&amp;redlink=1]
--- @return void
function GetBankAutosortDisabled()
end

--- [https://wow.gamepedia.com/wiki/API_GetBankBagSlotFlag?action=edit&amp;redlink=1]
--- @return void
function GetBankBagSlotFlag()
end

--- Returns the price of a particular bank slot.
--- [https://wow.gamepedia.com/wiki/API_GetBankSlotCost]
...
--- [https://wow.gamepedia.com/wiki/API_GetBarberShopStyleInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetBattlefieldFlagPosition]
...
--- [https://wow.gamepedia.com/wiki/API_GetBattlefieldInstanceExpiration]
--- @return number @ expiration
function GetBattlefieldInstanceExpiration()
end

--- Returns the time passed since the battleground started.
--- [https://wow.gamepedia.com/wiki/API_GetBattlefieldInstanceRunTime]
--- @return number @ time
function GetBattlefieldInstanceRunTime()
end

--- [https://wow.gamepedia.com/wiki/API_GetBattlefieldMapIconScale?action=edit&amp;redlink=1]
--- @return void
function GetBattlefieldMapIconScale()
end

--- [https://wow.gamepedia.com/wiki/API_GetBattlefieldPortExpiration]
...
--- [https://wow.gamepedia.com/wiki/API_GetBattlefieldScore]
...
--- [https://wow.gamepedia.com/wiki/API_GetBattlefieldStatData]
...
--- [https://wow.gamepedia.com/wiki/API_GetBattlefieldStatus]
...
--- [https://wow.gamepedia.com/wiki/API_GetBattlefieldTeamInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetBattlefieldTimeWaited]
...
--- [https://wow.gamepedia.com/wiki/API_GetBattlefieldWinner]
--- @return number @ winner
function GetBattlefieldWinner()
end

--- Returns information about a battleground type.
--- [https://wow.gamepedia.com/wiki/API_GetBattlegroundInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetBattlegroundPoints]
...
--- [https://wow.gamepedia.com/wiki/API_GetBinding]
...
--- [https://wow.gamepedia.com/wiki/API_GetBindingAction]
...
--- [https://wow.gamepedia.com/wiki/API_GetBindingByKey]
...
--- [https://wow.gamepedia.com/wiki/API_GetBindingKey]
...
--- [https://wow.gamepedia.com/wiki/API_GetBindingText]
...
--- [https://wow.gamepedia.com/wiki/API_GetBlockChance]
--- @return number @ blockChance
function GetBlockChance()
end

--- [https://wow.gamepedia.com/wiki/API_GetBonusBarIndex?action=edit&amp;redlink=1]
--- @return void
function GetBonusBarIndex()
end

--- Returns the current bonus action bar index.
--- [https://wow.gamepedia.com/wiki/API_GetBonusBarOffset]
--- @return unknown @ offset
function GetBonusBarOffset()
end

--- Returns information about the current client build.
--- [https://wow.gamepedia.com/wiki/API_GetBuildInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetBuybackItemInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetBuybackItemLink?action=edit&amp;redlink=1]
--- @return void
function GetBuybackItemLink()
end

--- Returns information on a console variable.
--- [https://wow.gamepedia.com/wiki/API_GetCVarInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetCVarSettingValidity?action=edit&amp;redlink=1]
--- @return void
function GetCVarSettingValidity()
end

--- [https://wow.gamepedia.com/wiki/API_GetCallPetSpellInfo?action=edit&amp;redlink=1]
--- @return void
function GetCallPetSpellInfo()
end

--- Gets the current zoom level of the camera.
--- [https://wow.gamepedia.com/wiki/API_GetCameraZoom]
--- @return number @ zoom
function GetCameraZoom()
end

--- [https://wow.gamepedia.com/wiki/API_GetCategoryAchievementPoints?action=edit&amp;redlink=1]
--- @return void
function GetCategoryAchievementPoints()
end

--- Returns information about the given category.
--- [https://wow.gamepedia.com/wiki/API_GetCategoryInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetCemeteryPreference?action=edit&amp;redlink=1]
--- @return void
function GetCemeteryPreference()
end

--- Retrieves channels (and category headers) that would be displayed in Blizzards ChannelFrame.
--- [https://wow.gamepedia.com/wiki/API_GetChannelDisplayInfo]
--- @param i unknown
...
--- [https://wow.gamepedia.com/wiki/API_GetChatTypeIndex]
...
--- [https://wow.gamepedia.com/wiki/API_GetChatWindowChannels]
...
--- [https://wow.gamepedia.com/wiki/API_GetChatWindowInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetChatWindowMessages]
--- @param index number @ Chat window index, ascending from 1.
--- @return unknown, unknown @ type1, ...
function GetChatWindowMessages(index)
end

--- [https://wow.gamepedia.com/wiki/API_GetChatWindowSavedDimensions?action=edit&amp;redlink=1]
--- @return void
function GetChatWindowSavedDimensions()
end

--- [https://wow.gamepedia.com/wiki/API_GetChatWindowSavedPosition?action=edit&amp;redlink=1]
--- @return void
function GetChatWindowSavedPosition()
end

--- Returns information about a class.
--- [https://wow.gamepedia.com/wiki/API_GetClassInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetClickFrame?action=edit&amp;redlink=1]
--- @return void
function GetClickFrame()
end

--- Returns the expansion level of the game client.
--- [https://wow.gamepedia.com/wiki/API_GetClientDisplayExpansionLevel]
--- @return number @ expansionLevel
function GetClientDisplayExpansionLevel()
end

--- [https://wow.gamepedia.com/wiki/API_GetCoinIcon]
...
--- [https://wow.gamepedia.com/wiki/API_GetCoinText]
...
--- [https://wow.gamepedia.com/wiki/API_GetCoinTextureString]
--- @param amount number @ the amount of money in copper (for example, the return value from GetMoney)
...
--- [https://wow.gamepedia.com/wiki/API_GetCombatRating]
...
--- [https://wow.gamepedia.com/wiki/API_GetCombatRatingBonus]
--- @param combatRatingIdentifier number @ One of the following values from FrameXML/PaperDollFrame.lua:
--- @return number @ bonus
function GetCombatRatingBonus(combatRatingIdentifier)
end

--- [https://wow.gamepedia.com/wiki/API_GetCombatRatingBonusForCombatRatingValue?action=edit&amp;redlink=1]
--- @return void
function GetCombatRatingBonusForCombatRatingValue()
end

--- Retrieves the number of combo points gained by a player.
--- [https://wow.gamepedia.com/wiki/API_GetComboPoints]
...
--- [https://wow.gamepedia.com/wiki/API_GetCompanionInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetComparisonAchievementPoints?action=edit&amp;redlink=1]
--- @return void
function GetComparisonAchievementPoints()
end

--- [https://wow.gamepedia.com/wiki/API_GetComparisonCategoryNumAchievements?action=edit&amp;redlink=1]
--- @return void
function GetComparisonCategoryNumAchievements()
end

--- Return the value of the requested Statistic from the comparison unit.
--- [https://wow.gamepedia.com/wiki/API_GetComparisonStatistic]
--- @param achievementID number @ The ID of the Achievement.
--- @return string @ value
...
--- [https://wow.gamepedia.com/wiki/API_GetContainerFreeSlots]
...
--- [https://wow.gamepedia.com/wiki/API_GetContainerItemCooldown]
...
--- [https://wow.gamepedia.com/wiki/API_GetContainerItemDurability]
...
--- [https://wow.gamepedia.com/wiki/API_GetContainerItemEquipmentSetInfo?action=edit&amp;redlink=1]
--- @return void
function GetContainerItemEquipmentSetInfo()
end

--- Returns the item id of the item in a particular container slot.
--- [https://wow.gamepedia.com/wiki/API_GetContainerItemID]
...
--- [https://wow.gamepedia.com/wiki/API_GetContainerItemInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetContainerItemLink]
...
--- [https://wow.gamepedia.com/wiki/API_GetContainerItemPurchaseCurrency?action=edit&amp;redlink=1]
--- @return void
function GetContainerItemPurchaseCurrency()
end

--- [https://wow.gamepedia.com/wiki/API_GetContainerItemPurchaseInfo?action=edit&amp;redlink=1]
--- @return void
function GetContainerItemPurchaseInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetContainerItemPurchaseItem?action=edit&amp;redlink=1]
--- @return void
function GetContainerItemPurchaseItem()
end

--- Returns whether the item in the slot is a quest item.
--- [https://wow.gamepedia.com/wiki/API_GetContainerItemQuestInfo]
--- @param bag number @ BagID) - Index of the bag to query.
...
--- [https://wow.gamepedia.com/wiki/API_GetContainerNumFreeSlots]
...
--- [https://wow.gamepedia.com/wiki/API_GetContainerNumSlots]
--- @param bagID number @ the slot containing the bag, e.g. 0 for backpack, etc.
--- @return number @ numberOfSlots
function GetContainerNumSlots(bagID)
end

--- [https://wow.gamepedia.com/wiki/API_GetCorpseRecoveryDelay?action=edit&amp;redlink=1]
--- @return void
function GetCorpseRecoveryDelay()
end

--- Tracks the extent to which a player is wearing items touched by N'Zoth's influence.
--- [https://wow.gamepedia.com/wiki/API_GetCorruption]
...
--- [https://wow.gamepedia.com/wiki/API_GetCorruptionResistance]
--- @return number @ corruptionResistance
function GetCorruptionResistance()
end

--- Returns the player's critical hit chance.
--- [https://wow.gamepedia.com/wiki/API_GetCritChance]
--- @return number @ critChance
function GetCritChance()
end

--- [https://wow.gamepedia.com/wiki/API_GetCritChanceProvidesParryEffect?action=edit&amp;redlink=1]
--- @return void
function GetCritChanceProvidesParryEffect()
end

--- [https://wow.gamepedia.com/wiki/API_GetCriteriaSpell?action=edit&amp;redlink=1]
--- @return void
function GetCriteriaSpell()
end

--- Returns the current arena season
--- [https://wow.gamepedia.com/wiki/API_GetCurrentArenaSeason]
--- @return number @ season
function GetCurrentArenaSeason()
end

--- Returns whether account- or character-specific bindings are active.
--- [https://wow.gamepedia.com/wiki/API_GetCurrentBindingSet]
--- @return number @ which
function GetCurrentBindingSet()
end

--- [https://wow.gamepedia.com/wiki/API_GetCurrentCombatTextEventInfo?action=edit&amp;redlink=1]
--- @return void
function GetCurrentCombatTextEventInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetCurrentEventID?action=edit&amp;redlink=1]
--- @return void
function GetCurrentEventID()
end

--- [https://wow.gamepedia.com/wiki/API_GetCurrentGlyphNameForSpell?action=edit&amp;redlink=1]
--- @return void
function GetCurrentGlyphNameForSpell()
end

--- [https://wow.gamepedia.com/wiki/API_GetCurrentGraphicsSetting?action=edit&amp;redlink=1]
--- @return void
function GetCurrentGraphicsSetting()
end

--- [https://wow.gamepedia.com/wiki/API_GetCurrentGuildBankTab?action=edit&amp;redlink=1]
--- @return void
function GetCurrentGuildBankTab()
end

--- [https://wow.gamepedia.com/wiki/API_GetCurrentKeyBoardFocus?action=edit&amp;redlink=1]
--- @return void
function GetCurrentKeyBoardFocus()
end

--- [https://wow.gamepedia.com/wiki/API_GetCurrentLevelFeatures?action=edit&amp;redlink=1]
--- @return void
function GetCurrentLevelFeatures()
end

--- For the level you put in, it returns the ID of the spell that will become available.
--- [https://wow.gamepedia.com/wiki/API_GetCurrentLevelSpells]
--- @return void
function GetCurrentLevelSpells()
end

--- Returns a numeric ID representing the region the player is currently logged into.
--- [https://wow.gamepedia.com/wiki/API_GetCurrentRegion]
...
--- [https://wow.gamepedia.com/wiki/API_GetCurrentRegionName]
--- @return string @ regionName
function GetCurrentRegionName()
end

--- Returns the index of the current resolution in effect
--- [https://wow.gamepedia.com/wiki/API_GetCurrentResolution]
--- @return unknown @ index
function GetCurrentResolution()
end

--- [https://wow.gamepedia.com/wiki/API_GetCurrentScaledResolution?action=edit&amp;redlink=1]
--- @return void
function GetCurrentScaledResolution()
end

--- Returns the title currently used by the player.
--- [https://wow.gamepedia.com/wiki/API_GetCurrentTitle]
--- @return number @ currentTitle
function GetCurrentTitle()
end

--- [https://wow.gamepedia.com/wiki/API_GetCursorDelta?action=edit&amp;redlink=1]
--- @return void
function GetCursorDelta()
end

--- Returns information about what the mouse cursor is holding.
--- [https://wow.gamepedia.com/wiki/API_GetCursorInfo]
--- @return unknown, unknown @ infoType, ...
function GetCursorInfo()
end

--- Returns the amount of copper held on the cursor.
--- [https://wow.gamepedia.com/wiki/API_GetCursorMoney]
--- @return number @ copper
function GetCursorMoney()
end

--- Returns the cursor's position on the screen.
--- [https://wow.gamepedia.com/wiki/API_GetCursorPosition]
--- @return number, number @ x, y
function GetCursorPosition()
end

--- [https://wow.gamepedia.com/wiki/API_GetCustomizationDetails?action=edit&amp;redlink=1]
--- @return void
function GetCustomizationDetails()
end

--- [https://wow.gamepedia.com/wiki/API_GetDailyQuestsCompleted?action=edit&amp;redlink=1]
--- @return void
function GetDailyQuestsCompleted()
end

--- Returns a chat link for a specific death.
--- [https://wow.gamepedia.com/wiki/API_GetDeathRecapLink]
...
--- [https://wow.gamepedia.com/wiki/API_GetDefaultGraphicsQuality?action=edit&amp;redlink=1]
--- @return void
function GetDefaultGraphicsQuality()
end

--- Returns the player's default language.
--- [https://wow.gamepedia.com/wiki/API_GetDefaultLanguage]
--- @return string, number @ language, languageID
function GetDefaultLanguage()
end

--- [https://wow.gamepedia.com/wiki/API_GetDefaultScale?action=edit&amp;redlink=1]
--- @return void
function GetDefaultScale()
end

--- [https://wow.gamepedia.com/wiki/API_GetDefaultVideoOption?action=edit&amp;redlink=1]
--- @return void
function GetDefaultVideoOption()
end

--- [https://wow.gamepedia.com/wiki/API_GetDefaultVideoOptions?action=edit&amp;redlink=1]
--- @return void
function GetDefaultVideoOptions()
end

--- [https://wow.gamepedia.com/wiki/API_GetDefaultVideoQualityOption?action=edit&amp;redlink=1]
--- @return void
function GetDefaultVideoQualityOption()
end

--- [https://wow.gamepedia.com/wiki/API_GetDemotionRank?action=edit&amp;redlink=1]
--- @return void
function GetDemotionRank()
end

--- Returns detailed item level information about a given item.
--- [https://wow.gamepedia.com/wiki/API_GetDetailedItemLevelInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetDifficultyInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetDodgeChance]
--- @return number @ dodgeChance
function GetDodgeChance()
end

--- [https://wow.gamepedia.com/wiki/API_GetDodgeChanceFromAttribute?action=edit&amp;redlink=1]
--- @return void
function GetDodgeChanceFromAttribute()
end

--- [https://wow.gamepedia.com/wiki/API_GetDownloadedPercentage?action=edit&amp;redlink=1]
--- @return void
function GetDownloadedPercentage()
end

--- Returns the player's currently selected dungeon difficulty.
--- [https://wow.gamepedia.com/wiki/API_GetDungeonDifficultyID]
--- @return number @ difficultyID
function GetDungeonDifficultyID()
end

--- [https://wow.gamepedia.com/wiki/API_GetDungeonForRandomSlot?action=edit&amp;redlink=1]
--- @return void
function GetDungeonForRandomSlot()
end

--- [https://wow.gamepedia.com/wiki/API_GetDungeonInfo?action=edit&amp;redlink=1]
--- @return void
function GetDungeonInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetEquipmentNameFromSpell?action=edit&amp;redlink=1]
--- @return void
function GetEquipmentNameFromSpell()
end

--- [https://wow.gamepedia.com/wiki/API_GetEventCPUUsage?action=edit&amp;redlink=1]
--- @return void
function GetEventCPUUsage()
end

--- [https://wow.gamepedia.com/wiki/API_GetEventTime?action=edit&amp;redlink=1]
--- @return void
function GetEventTime()
end

--- [https://wow.gamepedia.com/wiki/API_GetExistingSocketInfo?action=edit&amp;redlink=1]
--- @return void
function GetExistingSocketInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetExistingSocketLink?action=edit&amp;redlink=1]
--- @return void
function GetExistingSocketLink()
end

--- Returns the logo and banner textures for an expansion id.
--- [https://wow.gamepedia.com/wiki/API_GetExpansionDisplayInfo]
...
--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_GetExpansionForLevel]
...
--- [https://wow.gamepedia.com/wiki/API_GetExpansionLevel]
--- @return number @ expansionLevel
function GetExpansionLevel()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_GetExpansionTrialInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetExpertise]
...
--- [https://wow.gamepedia.com/wiki/API_GetExtraBarIndex]
...
--- [https://wow.gamepedia.com/wiki/API_GetFactionInfo]
...
--- Returns information about the specified faction or faction header in the player's reputation pane.
--- [https://wow.gamepedia.com/wiki/API_GetFactionInfoByID]
--- @return void
function GetFactionInfoByID()
end

--- [https://wow.gamepedia.com/wiki/API_GetFailedPVPTalentIDs?action=edit&amp;redlink=1]
--- @return void
function GetFailedPVPTalentIDs()
end

--- [https://wow.gamepedia.com/wiki/API_GetFailedTalentIDs?action=edit&amp;redlink=1]
--- @return void
function GetFailedTalentIDs()
end

--- Returns the FileDataID corresponding to the given game file path (texture, sound, model, etc.).
--- [https://wow.gamepedia.com/wiki/API_GetFileIDFromPath]
...
--- [https://wow.gamepedia.com/wiki/API_GetFileStreamingStatus?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetFilteredAchievementID]
...
--- [https://wow.gamepedia.com/wiki/API_GetFlexRaidDungeonInfo?action=edit&amp;redlink=1]
--- @return void
function GetFlexRaidDungeonInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetFlyoutID?action=edit&amp;redlink=1]
--- @return void
function GetFlyoutID()
end

--- [https://wow.gamepedia.com/wiki/API_GetFlyoutInfo?action=edit&amp;redlink=1]
--- @return void
function GetFlyoutInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetFlyoutSlotInfo?action=edit&amp;redlink=1]
--- @return void
function GetFlyoutSlotInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetFollowerTypeIDFromSpell?action=edit&amp;redlink=1]
--- @return void
function GetFollowerTypeIDFromSpell()
end

--- Returns a structured table of information about the given font object.
--- [https://wow.gamepedia.com/wiki/API_GetFontInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetFonts]
--- @return string @ fonts
function GetFonts()
end

--- Returns the total time used by and number of calls of a frame's event handlers.
--- [https://wow.gamepedia.com/wiki/API_GetFrameCPUUsage]
...
--- [https://wow.gamepedia.com/wiki/API_GetFramerate]
--- @return number @ framerate
function GetFramerate()
end

--- Returns all frames registered for the specified event, in dispatch order.
--- [https://wow.gamepedia.com/wiki/API_GetFramesRegisteredForEvent]
...
--- [https://wow.gamepedia.com/wiki/API_GetFriendshipReputation]
...
--- [https://wow.gamepedia.com/wiki/API_GetFriendshipReputationRanks]
...
--- [https://wow.gamepedia.com/wiki/API_GetFunctionCPUUsage?action=edit&amp;redlink=1]
--- @return void
function GetFunctionCPUUsage()
end

--- [https://wow.gamepedia.com/wiki/API_GetGMStatus?action=edit&amp;redlink=1]
--- @return void
function GetGMStatus()
end

--- [https://wow.gamepedia.com/wiki/API_GetGMTicket?action=edit&amp;redlink=1]
--- @return void
function GetGMTicket()
end

--- Returns the error message for an id.
--- [https://wow.gamepedia.com/wiki/API_GetGameMessageInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetGameTime]
--- @return number, number @ hours, minutes
function GetGameTime()
end

--- Returns the supported graphics APIs for the system, D3D11_LEGACY, D3D11, D3D12, etc.
--- [https://wow.gamepedia.com/wiki/API_GetGraphicsAPIs]
--- @return string, unknown @ cvarValues, ...
function GetGraphicsAPIs()
end

--- [https://wow.gamepedia.com/wiki/API_GetGraphicsDropdownIndexByMasterIndex?action=edit&amp;redlink=1]
--- @return void
function GetGraphicsDropdownIndexByMasterIndex()
end

--- [https://wow.gamepedia.com/wiki/API_GetGreetingText?action=edit&amp;redlink=1]
--- @return void
function GetGreetingText()
end

--- [https://wow.gamepedia.com/wiki/API_GetGroupMemberCounts?action=edit&amp;redlink=1]
--- @return void
function GetGroupMemberCounts()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildAchievementMemberInfo?action=edit&amp;redlink=1]
--- @return void
function GetGuildAchievementMemberInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildAchievementMembers?action=edit&amp;redlink=1]
--- @return void
function GetGuildAchievementMembers()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildAchievementNumMembers?action=edit&amp;redlink=1]
--- @return void
function GetGuildAchievementNumMembers()
end

--- Returns information about the given selected guild applicant.
--- [https://wow.gamepedia.com/wiki/API_GetGuildApplicantInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetGuildApplicantSelection?action=edit&amp;redlink=1]
--- @return void
function GetGuildApplicantSelection()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildBankBonusDepositMoney?action=edit&amp;redlink=1]
--- @return void
function GetGuildBankBonusDepositMoney()
end

--- Gets information about an item slot from the guild bank.
--- [https://wow.gamepedia.com/wiki/API_GetGuildBankItemInfo]
--- @param tab number @ The index of the tab in the guild bank
--- @param slot number @ The index of the slot in the chosen tab.
...
--- [https://wow.gamepedia.com/wiki/API_GetGuildBankTabCost?action=edit&amp;redlink=1]
--- @return void
function GetGuildBankTabCost()
end

--- Gets display / player's access information regarding a guild bank tab.
--- [https://wow.gamepedia.com/wiki/API_GetGuildBankTabInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetGuildBankTabPermissions]
...
--- [https://wow.gamepedia.com/wiki/API_GetGuildBankText?action=edit&amp;redlink=1]
--- @return void
function GetGuildBankText()
end

--- Get information for specific item transaction from Guild Bank.
--- [https://wow.gamepedia.com/wiki/API_GetGuildBankTransaction]
...
--- Arguments none
--- [https://wow.gamepedia.com/wiki/API_GetGuildBankWithdrawGoldLimit]
...
--- [https://wow.gamepedia.com/wiki/API_GetGuildBankWithdrawMoney]
--- @return unknown @ withdrawLimit
function GetGuildBankWithdrawMoney()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildCategoryList?action=edit&amp;redlink=1]
--- @return void
function GetGuildCategoryList()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildChallengeInfo?action=edit&amp;redlink=1]
--- @return void
function GetGuildChallengeInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildCharterCost?action=edit&amp;redlink=1]
--- @return void
function GetGuildCharterCost()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildEventInfo?action=edit&amp;redlink=1]
--- @return void
function GetGuildEventInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildExpirationTime?action=edit&amp;redlink=1]
--- @return void
function GetGuildExpirationTime()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildFactionGroup?action=edit&amp;redlink=1]
--- @return void
function GetGuildFactionGroup()
end

--- Returns the guild name and faction standing of the player.
--- [https://wow.gamepedia.com/wiki/API_GetGuildFactionInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetGuildInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetGuildInfoText?action=edit&amp;redlink=1]
--- @return void
function GetGuildInfoText()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildLogoInfo?action=edit&amp;redlink=1]
--- @return void
function GetGuildLogoInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildMemberRecipes?action=edit&amp;redlink=1]
--- @return void
function GetGuildMemberRecipes()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildMembershipRequestInfo?action=edit&amp;redlink=1]
--- @return void
function GetGuildMembershipRequestInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildMembershipRequestSettings?action=edit&amp;redlink=1]
--- @return void
function GetGuildMembershipRequestSettings()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildNewsFilters?action=edit&amp;redlink=1]
--- @return void
function GetGuildNewsFilters()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildNewsMemberName?action=edit&amp;redlink=1]
--- @return void
function GetGuildNewsMemberName()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildNewsSort?action=edit&amp;redlink=1]
--- @return void
function GetGuildNewsSort()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildPerkInfo?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetGuildRecipeInfoPostQuery]
...
--- [https://wow.gamepedia.com/wiki/API_GetGuildRecipeMember]
...
--- [https://wow.gamepedia.com/wiki/API_GetGuildRecruitmentComment?action=edit&amp;redlink=1]
--- @return void
function GetGuildRecruitmentComment()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildRecruitmentSettings?action=edit&amp;redlink=1]
--- @return void
function GetGuildRecruitmentSettings()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildRenameRequired?action=edit&amp;redlink=1]
--- @return void
function GetGuildRenameRequired()
end

--- [https://wow.gamepedia.com/wiki/API_GetGuildRewardInfo?action=edit&amp;redlink=1]
--- @return void
function GetGuildRewardInfo()
end

--- Returns information about a character in your current guild.
--- [https://wow.gamepedia.com/wiki/API_GetGuildRosterInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetGuildRosterLargestAchievementPoints?action=edit&amp;redlink=1]
--- @return void
function GetGuildRosterLargestAchievementPoints()
end

--- Returns a specific guild member's last seen time.
--- [https://wow.gamepedia.com/wiki/API_GetGuildRosterLastOnline]
...
--- [https://wow.gamepedia.com/wiki/API_GetGuildRosterMOTD]
--- @return string @ motd
...
--- [https://wow.gamepedia.com/wiki/API_GetGuildRosterSelection]
...
--- [https://wow.gamepedia.com/wiki/API_GetGuildTradeSkillInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetInboxHeaderInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetInboxInvoiceInfo]
--- @param index number @ the index of the message (1 is the first message)
...
--- [https://wow.gamepedia.com/wiki/API_GetInboxItem]
...
--- [https://wow.gamepedia.com/wiki/API_GetInboxItemLink]
...
--- [https://wow.gamepedia.com/wiki/API_GetInboxNumItems]
--- @return unknown, unknown @ numItems, totalItems
function GetInboxNumItems()
end

--- [https://wow.gamepedia.com/wiki/API_GetInboxText]
--- @param index number @ the index of the message (1 is the first message)
...
--- [https://wow.gamepedia.com/wiki/API_GetInsertItemsLeftToRight?action=edit&amp;redlink=1]
--- @return void
function GetInsertItemsLeftToRight()
end

--- Returns the inspected unit's rated PvP stats.
--- [https://wow.gamepedia.com/wiki/API_GetInspectArenaData]
...
--- [https://wow.gamepedia.com/wiki/API_GetInspectGuildInfo?action=edit&amp;redlink=1]
--- @return void
function GetInspectGuildInfo()
end

--- Get the honor information about the inspected unit.
--- [https://wow.gamepedia.com/wiki/API_GetInspectHonorData]
...
--- [https://wow.gamepedia.com/wiki/API_GetInstanceLockTimeRemaining]
...
--- [https://wow.gamepedia.com/wiki/API_GetInstanceLockTimeRemainingEncounter]
...
--- [https://wow.gamepedia.com/wiki/API_GetInventoryAlertStatus]
...
--- [https://wow.gamepedia.com/wiki/API_GetInventoryItemBroken]
...
--- [https://wow.gamepedia.com/wiki/API_GetInventoryItemCooldown]
--- @param unit string @ The UnitId of the unit whose inventory is to be queried.
--- @param slotId number @ The inventory slot to be queried, obtained via GetInventorySlotInfo.
...
--- [https://wow.gamepedia.com/wiki/API_GetInventoryItemCount]
--- @param unit string @ The UnitId of the unit whose inventory is to be queried.
--- @param slotId number @ The inventory slot to be queried, obtained via GetInventorySlotInfo.
--- @return number @ count
...
--- [https://wow.gamepedia.com/wiki/API_GetInventoryItemLink]
--- @param unit unknown
...
--- [https://wow.gamepedia.com/wiki/API_GetInventoryItemQuality]
...
--- [https://wow.gamepedia.com/wiki/API_GetInventoryItemTexture]
--- @param unit string @ The UnitId of the unit whose inventory is to be queried.
--- @param slotId number @ The inventory slot to be queried, obtained via GetInventorySlotInfo.
...
--- [https://wow.gamepedia.com/wiki/API_GetInventoryItemsForSlot?action=edit&amp;redlink=1]
--- @return void
function GetInventoryItemsForSlot()
end

--- Return information about a specific inventory slot
--- [https://wow.gamepedia.com/wiki/API_GetInventorySlotInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetInviteConfirmationInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetItemChildInfo?action=edit&amp;redlink=1]
--- @return void
function GetItemChildInfo()
end

--- Returns the name of the item type.
--- [https://wow.gamepedia.com/wiki/API_GetItemClassInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetItemCooldown]
...
--- Counts an item.
--- [https://wow.gamepedia.com/wiki/API_GetItemCount]
...
--- [https://wow.gamepedia.com/wiki/API_GetItemCreationContext?action=edit&amp;redlink=1]
--- @return void
function GetItemCreationContext()
end

--- Gets the bitfield of what types of bags an item can go into or contain.
--- [https://wow.gamepedia.com/wiki/API_GetItemFamily]
--- @param itemId_or_itemName_or_itemLink unknown
...
--- [https://wow.gamepedia.com/wiki/API_GetItemGem]
...
--- [https://wow.gamepedia.com/wiki/API_GetItemIcon]
...
--- [https://wow.gamepedia.com/wiki/API_GetItemInfo]
--- @param itemInfo string @ ItemLink, Name or ID
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetItemInfoInstant]
--- @param itemID_or_itemString_or_itemName_or_itemLink unknown
...
--- [https://wow.gamepedia.com/wiki/API_GetItemSubClassInfo]
--- @param classID number @ ID of the ItemType
...
--- [https://wow.gamepedia.com/wiki/API_GetItemUpgradeItemInfo]
--- @return void
function GetItemUpgradeItemInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetItemUpgradeStats?action=edit&amp;redlink=1]
--- @return void
function GetItemUpgradeStats()
end

--- [https://wow.gamepedia.com/wiki/API_GetJailersTowerLevel?action=edit&amp;redlink=1]
--- @return void
function GetJailersTowerLevel()
end

--- [https://wow.gamepedia.com/wiki/API_GetJournalInfoForSpellConfirmation?action=edit&amp;redlink=1]
--- @return void
function GetJournalInfoForSpellConfirmation()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFDChoiceCollapseState?action=edit&amp;redlink=1]
--- @return void
function GetLFDChoiceCollapseState()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFDChoiceEnabledState?action=edit&amp;redlink=1]
--- @return void
function GetLFDChoiceEnabledState()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFDChoiceOrder?action=edit&amp;redlink=1]
--- @return void
function GetLFDChoiceOrder()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFDLockInfo?action=edit&amp;redlink=1]
--- @return void
function GetLFDLockInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFDLockPlayerCount?action=edit&amp;redlink=1]
--- @return void
function GetLFDLockPlayerCount()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFDRoleLockInfo?action=edit&amp;redlink=1]
--- @return void
function GetLFDRoleLockInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFDRoleRestrictions?action=edit&amp;redlink=1]
--- @return void
function GetLFDRoleRestrictions()
end

--- Returns information about an LFG Kick vote currently in progress.
--- [https://wow.gamepedia.com/wiki/API_GetLFGBootProposal]
--- @return number, number, number, string @ totalVotes, bootVotes, timeLeft, reason
function GetLFGBootProposal()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFGCategoryForID?action=edit&amp;redlink=1]
--- @return void
function GetLFGCategoryForID()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFGCompletionReward?action=edit&amp;redlink=1]
--- @return void
function GetLFGCompletionReward()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFGCompletionRewardItem?action=edit&amp;redlink=1]
--- @return void
function GetLFGCompletionRewardItem()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFGCompletionRewardItemLink?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetLFGDungeonInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetLFGDungeonNumEncounters]
--- @param dungeonID number @ Ranging from 1 to around 2000 in patch 8.1.5
...
--- [https://wow.gamepedia.com/wiki/API_GetLFGDungeonRewardCapBarInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetLFGDungeonRewardCapInfo?action=edit&amp;redlink=1]
--- @return void
function GetLFGDungeonRewardCapInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFGDungeonRewardInfo?action=edit&amp;redlink=1]
--- @return void
function GetLFGDungeonRewardInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFGDungeonRewardLink?action=edit&amp;redlink=1]
--- @return void
function GetLFGDungeonRewardLink()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFGDungeonRewards?action=edit&amp;redlink=1]
--- @return void
function GetLFGDungeonRewards()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFGDungeonShortageRewardInfo?action=edit&amp;redlink=1]
--- @return void
function GetLFGDungeonShortageRewardInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFGDungeonShortageRewardLink?action=edit&amp;redlink=1]
--- @return void
function GetLFGDungeonShortageRewardLink()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFGInfoServer?action=edit&amp;redlink=1]
--- @return void
function GetLFGInfoServer()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFGInviteRoleAvailability?action=edit&amp;redlink=1]
--- @return void
function GetLFGInviteRoleAvailability()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFGInviteRoleRestrictions?action=edit&amp;redlink=1]
--- @return void
function GetLFGInviteRoleRestrictions()
end

--- Returns information about the current LFD group invite.
--- [https://wow.gamepedia.com/wiki/API_GetLFGProposal]
...
--- [https://wow.gamepedia.com/wiki/API_GetLFGProposalEncounter?action=edit&amp;redlink=1]
--- @return void
function GetLFGProposalEncounter()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFGProposalMember?action=edit&amp;redlink=1]
--- @return void
function GetLFGProposalMember()
end

--- Returns the current state and wait times for being in queue.
--- [https://wow.gamepedia.com/wiki/API_GetLFGQueueStats]
...
--- [https://wow.gamepedia.com/wiki/API_GetLFGQueuedList?action=edit&amp;redlink=1]
--- @return void
function GetLFGQueuedList()
end

--- Returns the time at which you may once again queue for a random dungeon.
--- [https://wow.gamepedia.com/wiki/API_GetLFGRandomCooldownExpiration]
--- @return number @ expiryTime
function GetLFGRandomCooldownExpiration()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFGRandomDungeonInfo?action=edit&amp;redlink=1]
--- @return void
function GetLFGRandomDungeonInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFGReadyCheckUpdate?action=edit&amp;redlink=1]
--- @return void
function GetLFGReadyCheckUpdate()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFGReadyCheckUpdateBattlegroundInfo?action=edit&amp;redlink=1]
--- @return void
function GetLFGReadyCheckUpdateBattlegroundInfo()
end

--- Return information concerning the LFG Call to Arms rewards.
--- [https://wow.gamepedia.com/wiki/API_GetLFGRoleShortageRewards]
...
--- [https://wow.gamepedia.com/wiki/API_GetLFGRoleUpdate?action=edit&amp;redlink=1]
--- @return void
function GetLFGRoleUpdate()
end

--- Returns the name of the battleground queue triggering a role check.
--- [https://wow.gamepedia.com/wiki/API_GetLFGRoleUpdateBattlegroundInfo]
--- @return string @ queueName
function GetLFGRoleUpdateBattlegroundInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetLFGRoleUpdateMember?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetLanguageByIndex]
--- @param index number @ Ranging from 1 up to GetNumLanguages()
--- @return string, number @ language, languageID
function GetLanguageByIndex(index)
end

--- [https://wow.gamepedia.com/wiki/API_GetLatestCompletedAchievements?action=edit&amp;redlink=1]
--- @return void
function GetLatestCompletedAchievements()
end

--- [https://wow.gamepedia.com/wiki/API_GetLatestCompletedComparisonAchievements?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetLatestThreeSenders]
--- @return unknown, unknown, unknown @ sender1, sender2, sender3
function GetLatestThreeSenders()
end

--- [https://wow.gamepedia.com/wiki/API_GetLatestUpdatedComparisonStats?action=edit&amp;redlink=1]
--- @return void
function GetLatestUpdatedComparisonStats()
end

--- [https://wow.gamepedia.com/wiki/API_GetLatestUpdatedStats?action=edit&amp;redlink=1]
--- @return void
function GetLatestUpdatedStats()
end

--- [https://wow.gamepedia.com/wiki/API_GetLegacyRaidDifficultyID?action=edit&amp;redlink=1]
--- @return void
function GetLegacyRaidDifficultyID()
end

--- Returns a list of dungeon/raid IDs that are advertised as available at a given level.
--- [https://wow.gamepedia.com/wiki/API_GetLevelUpInstances]
...
--- [https://wow.gamepedia.com/wiki/API_GetLifesteal]
--- @return unknown @ Leech
function GetLifesteal()
end

--- [https://wow.gamepedia.com/wiki/API_GetLocalGameTime?action=edit&amp;redlink=1]
--- @return void
function GetLocalGameTime()
end

--- Returns information about the client locale.
--- [https://wow.gamepedia.com/wiki/API_GetLocale]
--- @return unknown @ e
function GetLocale()
end

--- [https://wow.gamepedia.com/wiki/API_GetLookingForGuildComment?action=edit&amp;redlink=1]
--- @return void
function GetLookingForGuildComment()
end

--- [https://wow.gamepedia.com/wiki/API_GetLookingForGuildSettings?action=edit&amp;redlink=1]
--- @return void
function GetLookingForGuildSettings()
end

--- [https://wow.gamepedia.com/wiki/API_GetLooseMacroIcons?action=edit&amp;redlink=1]
--- @return void
function GetLooseMacroIcons()
end

--- [https://wow.gamepedia.com/wiki/API_GetLooseMacroItemIcons?action=edit&amp;redlink=1]
--- @return void
function GetLooseMacroItemIcons()
end

--- Returns a table with all of the loot info for the current loot window.
--- [https://wow.gamepedia.com/wiki/API_GetLootInfo]
--- @return table @ info
function GetLootInfo()
end

--- Retrieves the Loot Method and (if applicable) Master Looter idenity.
--- [https://wow.gamepedia.com/wiki/API_GetLootMethod]
...
--- [https://wow.gamepedia.com/wiki/API_GetLootRollItemInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetLootRollItemLink]
...
--- [https://wow.gamepedia.com/wiki/API_GetLootRollTimeLeft?action=edit&amp;redlink=1]
--- @return void
function GetLootRollTimeLeft()
end

--- Returns information about the contents of a loot slot.
--- [https://wow.gamepedia.com/wiki/API_GetLootSlotInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetLootSlotLink]
...
--- [https://wow.gamepedia.com/wiki/API_GetLootSlotType]
...
--- [https://wow.gamepedia.com/wiki/API_GetLootSourceInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetMacroInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetMacroItem?action=edit&amp;redlink=1]
--- @return void
function GetMacroItem()
end

--- [https://wow.gamepedia.com/wiki/API_GetMacroItemIcons?action=edit&amp;redlink=1]
--- @return void
function GetMacroItemIcons()
end

--- Returns information about the spell a given macro is set to cast.
--- [https://wow.gamepedia.com/wiki/API_GetMacroSpell]
...
--- [https://wow.gamepedia.com/wiki/API_GetManaRegen]
...
--- [https://wow.gamepedia.com/wiki/API_GetMasterLootCandidate]
...
--- [https://wow.gamepedia.com/wiki/API_GetMastery]
--- @return number @ mastery
function GetMastery()
end

--- Returns the effect of player's current Mastery.
--- [https://wow.gamepedia.com/wiki/API_GetMasteryEffect]
--- @return number, number @ mastery, coefficient
function GetMasteryEffect()
end

--- [https://wow.gamepedia.com/wiki/API_GetMawPowerLinkBySpellID?action=edit&amp;redlink=1]
--- @return void
function GetMawPowerLinkBySpellID()
end

--- [https://wow.gamepedia.com/wiki/API_GetMaxArenaCurrency?action=edit&amp;redlink=1]
--- @return void
function GetMaxArenaCurrency()
end

--- Returns the max number of battlefields you can queue for [1]
--- [https://wow.gamepedia.com/wiki/API_GetMaxBattlefieldID]
--- @return number @ maxBattlefieldID
function GetMaxBattlefieldID()
end

--- [https://wow.gamepedia.com/wiki/API_GetMaxCombatRatingBonus?action=edit&amp;redlink=1]
--- @return void
function GetMaxCombatRatingBonus()
end

--- Maps an expansion level to a maximum character level for that expansion.
--- [https://wow.gamepedia.com/wiki/API_GetMaxLevelForExpansionLevel]
--- @param expansionLevel number
...
--- [https://wow.gamepedia.com/wiki/API_GetMaxLevelForLatestExpansion]
--- @return number @ maxLevel
...
--- [https://wow.gamepedia.com/wiki/API_GetMaxLevelForPlayerExpansion]
--- @return number @ maxLevel
function GetMaxLevelForPlayerExpansion()
end

--- [https://wow.gamepedia.com/wiki/API_GetMaxNumCUFProfiles?action=edit&amp;redlink=1]
--- @return void
function GetMaxNumCUFProfiles()
end

--- [https://wow.gamepedia.com/wiki/API_GetMaxPlayerLevel?action=edit&amp;redlink=1]
--- @return void
function GetMaxPlayerLevel()
end

--- [https://wow.gamepedia.com/wiki/API_GetMaxRenderScale?action=edit&amp;redlink=1]
--- @return void
function GetMaxRenderScale()
end

--- [https://wow.gamepedia.com/wiki/API_GetMaxRewardCurrencies?action=edit&amp;redlink=1]
--- @return void
function GetMaxRewardCurrencies()
end

--- [https://wow.gamepedia.com/wiki/API_GetMaxSpellStartRecoveryOffset?action=edit&amp;redlink=1]
--- @return void
function GetMaxSpellStartRecoveryOffset()
end

--- Returns the number of available talent tiers.
--- [https://wow.gamepedia.com/wiki/API_GetMaxTalentTier]
--- @return number @ tiers
function GetMaxTalentTier()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_GetMaximumExpansionLevel]
--- @return number @ expansionLevel
function GetMaximumExpansionLevel()
end

--- [https://wow.gamepedia.com/wiki/API_GetMeleeHaste?action=edit&amp;redlink=1]
--- @return void
function GetMeleeHaste()
end

--- [https://wow.gamepedia.com/wiki/API_GetMerchantCurrencies?action=edit&amp;redlink=1]
--- @return void
function GetMerchantCurrencies()
end

--- [https://wow.gamepedia.com/wiki/API_GetMerchantFilter?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetMerchantItemCostInfo]
--- @param index number @ The index of the item in the merchant's inventory
...
--- [https://wow.gamepedia.com/wiki/API_GetMerchantItemCostItem]
...
--- [https://wow.gamepedia.com/wiki/API_GetMerchantItemID?action=edit&amp;redlink=1]
--- @return void
function GetMerchantItemID()
end

--- Returns information about a merchant's item.
--- [https://wow.gamepedia.com/wiki/API_GetMerchantItemInfo]
--- @param index number @ The index of the item in the merchant's inventory
...
--- [https://wow.gamepedia.com/wiki/API_GetMerchantItemLink]
--- @param index number @ The index of the item in the merchant's inventory
--- @return unknown @ link
function GetMerchantItemLink(index)
end

--- [https://wow.gamepedia.com/wiki/API_GetMerchantItemMaxStack]
--- @param index number @ The index of the item in the merchant's inventory.
...
--- [https://wow.gamepedia.com/wiki/API_GetMerchantNumItems]
--- @return number @ numItems
function GetMerchantNumItems()
end

--- [https://wow.gamepedia.com/wiki/API_GetMinRenderScale?action=edit&amp;redlink=1]
--- @return void
function GetMinRenderScale()
end

--- Returns the zone text, that is displayed over the minimap
--- [https://wow.gamepedia.com/wiki/API_GetMinimapZoneText]
--- @return string @ zone
function GetMinimapZoneText()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_GetMinimumExpansionLevel]
--- @return number @ expansionLevel
function GetMinimumExpansionLevel()
end

--- Gives information about the mirror bar. (Spirit release, exhaustion/fatigue, etc)
--- [https://wow.gamepedia.com/wiki/API_GetMirrorTimerInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetMirrorTimerProgress]
...
--- [https://wow.gamepedia.com/wiki/API_GetModResilienceDamageReduction?action=edit&amp;redlink=1]
--- @return void
function GetModResilienceDamageReduction()
end

--- Returns the modifier key assigned to the given action.
--- [https://wow.gamepedia.com/wiki/API_GetModifiedClick]
--- @param action string @ The action to query. Actions defined by Blizzard:
--- @return string @ key
function GetModifiedClick(action)
end

--- [https://wow.gamepedia.com/wiki/API_GetModifiedClickAction?action=edit&amp;redlink=1]
--- @return void
function GetModifiedClickAction()
end

--- Returns an integer value of your held money.
--- [https://wow.gamepedia.com/wiki/API_GetMoney]
--- @return number @ money
function GetMoney()
end

--- [https://wow.gamepedia.com/wiki/API_GetMonitorAspectRatio?action=edit&amp;redlink=1]
--- @return void
function GetMonitorAspectRatio()
end

--- [https://wow.gamepedia.com/wiki/API_GetMonitorCount?action=edit&amp;redlink=1]
--- @return void
function GetMonitorCount()
end

--- [https://wow.gamepedia.com/wiki/API_GetMonitorName?action=edit&amp;redlink=1]
--- @return void
function GetMonitorName()
end

--- Returns the name of the button responsible causing the OnClick handler to fire.
--- [https://wow.gamepedia.com/wiki/API_GetMouseButtonClicked]
--- @return string @ buttonName
function GetMouseButtonClicked()
end

--- [https://wow.gamepedia.com/wiki/API_GetMouseButtonName?action=edit&amp;redlink=1]
--- @return void
function GetMouseButtonName()
end

--- [https://wow.gamepedia.com/wiki/API_GetMouseClickFocus?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetMouseFocus]
--- @return table @ frameID
function GetMouseFocus()
end

--- [https://wow.gamepedia.com/wiki/API_GetMouseMotionFocus?action=edit&amp;redlink=1]
--- @return void
function GetMouseMotionFocus()
end

--- [https://wow.gamepedia.com/wiki/API_GetMovieDownloadProgress?action=edit&amp;redlink=1]
--- @return void
function GetMovieDownloadProgress()
end

--- [https://wow.gamepedia.com/wiki/API_GetMultiCastBarIndex?action=edit&amp;redlink=1]
--- @return void
function GetMultiCastBarIndex()
end

--- Returns a list of valid totem spells for the specified totem bar slot.
--- [https://wow.gamepedia.com/wiki/API_GetMultiCastTotemSpells]
...
--- [https://wow.gamepedia.com/wiki/API_GetNegativeCorruptionEffectInfo]
--- @return unknown @ corruptionEffects
function GetNegativeCorruptionEffectInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetNetIpTypes?action=edit&amp;redlink=1]
--- @return void
function GetNetIpTypes()
end

--- Returns various network statistics.
--- [https://wow.gamepedia.com/wiki/API_GetNetStats]
--- @return number, number, number, number @ bandwidthIn, bandwidthOut, latencyHome, latencyWorld
function GetNetStats()
end

--- [https://wow.gamepedia.com/wiki/API_GetNewSocketInfo?action=edit&amp;redlink=1]
--- @return void
function GetNewSocketInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetNewSocketLink?action=edit&amp;redlink=1]
--- @return void
function GetNewSocketLink()
end

--- Return the next achievement in a chain.
--- [https://wow.gamepedia.com/wiki/API_GetNextAchievement]
--- @param achievementID number @ The ID of the Achievement
--- @return number @ nextAchievementID
function GetNextAchievement(achievementID)
end

--- [https://wow.gamepedia.com/wiki/API_GetNextCompleatedTutorial?action=edit&amp;redlink=1]
--- @return void
function GetNextCompleatedTutorial()
end

--- [https://wow.gamepedia.com/wiki/API_GetNextPendingInviteConfirmation?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetNormalizedRealmName]
--- @return string @ normalizedRealmName
function GetNormalizedRealmName()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumActiveQuests?action=edit&amp;redlink=1]
--- @return void
function GetNumActiveQuests()
end

--- Get the number of user supplied AddOns.
--- [https://wow.gamepedia.com/wiki/API_GetNumAddOns]
--- @return number @ count
function GetNumAddOns()
end

--- Returns the number of Archaeology races in the game.
--- [https://wow.gamepedia.com/wiki/API_GetNumArchaeologyRaces]
--- @return number @ numRaces
function GetNumArchaeologyRaces()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumArenaOpponentSpecs?action=edit&amp;redlink=1]
--- @return void
function GetNumArenaOpponentSpecs()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumArenaOpponents?action=edit&amp;redlink=1]
--- @return void
function GetNumArenaOpponents()
end

--- Returns the amount of artifacts the player has acquired from the provided race.
--- [https://wow.gamepedia.com/wiki/API_GetNumArtifactsByRace]
...
--- [https://wow.gamepedia.com/wiki/API_GetNumBindings]
--- @return unknown @ numKeyBindings
function GetNumBindings()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumBuybackItems?action=edit&amp;redlink=1]
--- @return void
function GetNumBuybackItems()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumChannelMembers?action=edit&amp;redlink=1]
--- @return void
function GetNumChannelMembers()
end

--- Returns the number of existing player classes.
--- [https://wow.gamepedia.com/wiki/API_GetNumClasses]
--- @return number @ numClasses
function GetNumClasses()
end

--- Returns the number of companions you have.
--- [https://wow.gamepedia.com/wiki/API_GetNumCompanions]
...
--- [https://wow.gamepedia.com/wiki/API_GetNumComparisonCompletedAchievements]
--- @return void
function GetNumComparisonCompletedAchievements()
end

--- Return the total number of Achievements, and number completed.
--- [https://wow.gamepedia.com/wiki/API_GetNumCompletedAchievements]
--- @return number, number @ total, completed
function GetNumCompletedAchievements()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumDeclensionSets?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetNumDisplayChannels]
--- @return unknown @ channelCount
function GetNumDisplayChannels()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumDungeonForRandomSlot?action=edit&amp;redlink=1]
--- @return void
function GetNumDungeonForRandomSlot()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_GetNumExpansions]
--- @return number @ numExpansions
function GetNumExpansions()
end

--- Returns the number of lines in the faction display.
--- [https://wow.gamepedia.com/wiki/API_GetNumFactions]
...
--- [https://wow.gamepedia.com/wiki/API_GetNumFilteredAchievements]
--- @return number @ numFiltered
function GetNumFilteredAchievements()
end

--- Returns the number of available Flexible Raid instances.
--- [https://wow.gamepedia.com/wiki/API_GetNumFlexRaidDungeons]
--- @return number @ numInstances
function GetNumFlexRaidDungeons()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumFlyouts?action=edit&amp;redlink=1]
--- @return void
function GetNumFlyouts()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumFrames?action=edit&amp;redlink=1]
--- @return void
function GetNumFrames()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumGroupChannels?action=edit&amp;redlink=1]
--- @return void
function GetNumGroupChannels()
end

--- Returns the total number of players in a group.
--- [https://wow.gamepedia.com/wiki/API_GetNumGroupMembers]
...
--- [https://wow.gamepedia.com/wiki/API_GetNumGuildApplicants]
--- @return number @ numApplicants
function GetNumGuildApplicants()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumGuildBankMoneyTransactions?action=edit&amp;redlink=1]
--- @return void
function GetNumGuildBankMoneyTransactions()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumGuildBankTabs?action=edit&amp;redlink=1]
--- @return void
function GetNumGuildBankTabs()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumGuildBankTransactions?action=edit&amp;redlink=1]
--- @return void
function GetNumGuildBankTransactions()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumGuildChallenges?action=edit&amp;redlink=1]
--- @return void
function GetNumGuildChallenges()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumGuildEvents?action=edit&amp;redlink=1]
--- @return void
function GetNumGuildEvents()
end

--- Returns the number of guild members.
--- [https://wow.gamepedia.com/wiki/API_GetNumGuildMembers]
--- @return number, number, number @ numTotalGuildMembers, numOnlineGuildMembers, numOnlineAndMobileMembers
function GetNumGuildMembers()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumGuildMembershipRequests?action=edit&amp;redlink=1]
--- @return void
function GetNumGuildMembershipRequests()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumGuildNews?action=edit&amp;redlink=1]
--- @return void
function GetNumGuildNews()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumGuildPerks?action=edit&amp;redlink=1]
--- @return void
function GetNumGuildPerks()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumGuildRewards?action=edit&amp;redlink=1]
--- @return void
function GetNumGuildRewards()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumGuildTradeSkill?action=edit&amp;redlink=1]
--- @return void
function GetNumGuildTradeSkill()
end

--- Returns the number of item effects affected by upgrading the current item.
--- [https://wow.gamepedia.com/wiki/API_GetNumItemUpgradeEffects]
--- @return number @ numUpgradeEffects
function GetNumItemUpgradeEffects()
end

--- Returns the number of languages your character can speak.
--- [https://wow.gamepedia.com/wiki/API_GetNumLanguages]
...
--- [https://wow.gamepedia.com/wiki/API_GetNumLootItems]
--- @return number @ numLootItems
function GetNumLootItems()
end

--- Return the number of macros the player has.
--- [https://wow.gamepedia.com/wiki/API_GetNumMacros]
--- @return number, number @ global, perChar
function GetNumMacros()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumMembersInRank?action=edit&amp;redlink=1]
--- @return void
function GetNumMembersInRank()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumModifiedClickActions?action=edit&amp;redlink=1]
--- @return void
function GetNumModifiedClickActions()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumPetitionNames]
...
--- [https://wow.gamepedia.com/wiki/API_GetNumQuestChoices]
--- @return number @ numChoices
function GetNumQuestChoices()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumQuestCurrencies?action=edit&amp;redlink=1]
--- @return void
function GetNumQuestCurrencies()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumQuestItemDrops?action=edit&amp;redlink=1]
--- @return void
function GetNumQuestItemDrops()
end

--- Returns the number of items nessecary to complete a particular quest.
--- [https://wow.gamepedia.com/wiki/API_GetNumQuestItems]
--- @return number @ numRequiredItems
function GetNumQuestItems()
end

--- Returns the number of objectives for a given quest.
--- [https://wow.gamepedia.com/wiki/API_GetNumQuestLeaderBoards]
...
--- [https://wow.gamepedia.com/wiki/API_GetNumQuestLogChoices]
...
--- [https://wow.gamepedia.com/wiki/API_GetNumQuestLogRewardCurrencies?action=edit&amp;redlink=1]
--- @return void
function GetNumQuestLogRewardCurrencies()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumQuestLogRewardFactions?action=edit&amp;redlink=1]
--- @return void
function GetNumQuestLogRewardFactions()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumQuestLogRewardSpells?action=edit&amp;redlink=1]
--- @return void
function GetNumQuestLogRewardSpells()
end

--- Returns the count of the rewards for a particular quest.
--- [https://wow.gamepedia.com/wiki/API_GetNumQuestLogRewards]
--- @return number @ numQuestRewards
function GetNumQuestLogRewards()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumQuestLogTasks?action=edit&amp;redlink=1]
--- @return void
function GetNumQuestLogTasks()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumQuestPOIWorldEffects?action=edit&amp;redlink=1]
--- @return void
function GetNumQuestPOIWorldEffects()
end

--- Returns the number of items unconditionally rewarded by the quest being completed.
--- [https://wow.gamepedia.com/wiki/API_GetNumQuestRewards]
--- @return number @ numRewards
function GetNumQuestRewards()
end

--- Returns the number of available Raid Finder dungeons [1]
--- [https://wow.gamepedia.com/wiki/API_GetNumRFDungeons]
--- @return number @ numRFDungeons
function GetNumRFDungeons()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumRaidProfiles?action=edit&amp;redlink=1]
--- @return void
function GetNumRaidProfiles()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumRandomDungeons?action=edit&amp;redlink=1]
--- @return void
function GetNumRandomDungeons()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumRandomScenarios?action=edit&amp;redlink=1]
--- @return void
function GetNumRandomScenarios()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumRecruitingGuilds?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetNumRewardCurrencies]
--- @return number @ numCurrencies
function GetNumRewardCurrencies()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumRewardSpells?action=edit&amp;redlink=1]
--- @return void
function GetNumRewardSpells()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumRoutes?action=edit&amp;redlink=1]
--- @return void
function GetNumRoutes()
end

--- Returns the number of instances for which the player currently has lockout data saved.
--- [https://wow.gamepedia.com/wiki/API_GetNumSavedInstances]
--- @return number @ numInstances
function GetNumSavedInstances()
end

--- Returns the number of world bosses the player currently cannot receive loot from.
--- [https://wow.gamepedia.com/wiki/API_GetNumSavedWorldBosses]
--- @return number @ numSavedWorldBosses
function GetNumSavedWorldBosses()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumScenarios?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetNumSpecializations]
...
--- [https://wow.gamepedia.com/wiki/API_GetNumSpecializationsForClassID]
...
--- [https://wow.gamepedia.com/wiki/API_GetNumVoidTransferDeposit]
...
--- [https://wow.gamepedia.com/wiki/API_GetNumVoidTransferWithdrawal]
--- @return number @ numWithdrawals
function GetNumVoidTransferWithdrawal()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumWarGameTypes?action=edit&amp;redlink=1]
--- @return void
function GetNumWarGameTypes()
end

--- [https://wow.gamepedia.com/wiki/API_GetNumWorldPVPAreas?action=edit&amp;redlink=1]
--- @return void
function GetNumWorldPVPAreas()
end

--- [https://wow.gamepedia.com/wiki/API_GetOSLocale?action=edit&amp;redlink=1]
--- @return void
function GetOSLocale()
end

--- Returns texture coordinates of an object icon.
--- [https://wow.gamepedia.com/wiki/API_GetObjectIconTextureCoords]
...
--- [https://wow.gamepedia.com/wiki/API_GetObjectiveText?action=edit&amp;redlink=1]
--- @return void
function GetObjectiveText()
end

--- Returns whether you're currently passing on all loot.
--- [https://wow.gamepedia.com/wiki/API_GetOptOutOfLoot]
--- @return number @ optedOut
function GetOptOutOfLoot()
end

--- [https://wow.gamepedia.com/wiki/API_GetOverrideAPBySpellPower?action=edit&amp;redlink=1]
--- @return void
function GetOverrideAPBySpellPower()
end

--- [https://wow.gamepedia.com/wiki/API_GetOverrideBarIndex?action=edit&amp;redlink=1]
--- @return void
function GetOverrideBarIndex()
end

--- [https://wow.gamepedia.com/wiki/API_GetOverrideBarSkin?action=edit&amp;redlink=1]
--- @return void
function GetOverrideBarSkin()
end

--- [https://wow.gamepedia.com/wiki/API_GetOverrideSpellPowerByAP?action=edit&amp;redlink=1]
--- @return void
function GetOverrideSpellPowerByAP()
end

--- [https://wow.gamepedia.com/wiki/API_GetPOITextureCoords?action=edit&amp;redlink=1]
--- @return void
function GetPOITextureCoords()
end

--- Controls PvP combat flagging.
--- [https://wow.gamepedia.com/wiki/API_GetPVPDesired]
--- @return boolean @ flag
function GetPVPDesired()
end

--- [https://wow.gamepedia.com/wiki/API_GetPVPGearStatRules?action=edit&amp;redlink=1]
--- @return void
function GetPVPGearStatRules()
end

--- Gets the statistics about your lifetime PVP contributions.
--- [https://wow.gamepedia.com/wiki/API_GetPVPLifetimeStats]
...
--- [https://wow.gamepedia.com/wiki/API_GetPVPRoles]
--- @return boolean, boolean, boolean @ tank, healer, dps
function GetPVPRoles()
end

--- [https://wow.gamepedia.com/wiki/API_GetPVPSessionStats]
--- @return number, number @ hk, hp
function GetPVPSessionStats()
end

--- Returns the amount of time left on your PVP flag.
--- [https://wow.gamepedia.com/wiki/API_GetPVPTimer]
--- @return number @ ms
function GetPVPTimer()
end

--- [https://wow.gamepedia.com/wiki/API_GetPVPYesterdayStats]
...
--- [https://wow.gamepedia.com/wiki/API_GetParryChance]
--- @return number @ parryChance
function GetParryChance()
end

--- [https://wow.gamepedia.com/wiki/API_GetParryChanceFromAttribute?action=edit&amp;redlink=1]
--- @return void
function GetParryChanceFromAttribute()
end

--- Returns a list of raidmembers with a main tank or main assist role.
--- [https://wow.gamepedia.com/wiki/API_GetPartyAssignment]
...
--- [https://wow.gamepedia.com/wiki/API_GetPartyLFGBackfillInfo?action=edit&amp;redlink=1]
--- @return void
function GetPartyLFGBackfillInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetPartyLFGID?action=edit&amp;redlink=1]
--- @return void
function GetPartyLFGID()
end

--- [https://wow.gamepedia.com/wiki/API_GetPendingGlyphName?action=edit&amp;redlink=1]
--- @return void
function GetPendingGlyphName()
end

--- [https://wow.gamepedia.com/wiki/API_GetPendingInviteConfirmations?action=edit&amp;redlink=1]
--- @return void
function GetPendingInviteConfirmations()
end

--- Returns information about the player's personal PvP rating in a specific bracket.
--- [https://wow.gamepedia.com/wiki/API_GetPersonalRatedInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetPetActionCooldown]
...
--- [https://wow.gamepedia.com/wiki/API_GetPetActionInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetPetActionSlotUsable?action=edit&amp;redlink=1]
--- @return void
function GetPetActionSlotUsable()
end

--- [https://wow.gamepedia.com/wiki/API_GetPetActionsUsable?action=edit&amp;redlink=1]
--- @return void
function GetPetActionsUsable()
end

--- Returns the pet's current XP total, and the XP total required for the next level.
--- [https://wow.gamepedia.com/wiki/API_GetPetExperience]
--- @return number, number @ currXP, nextXP
function GetPetExperience()
end

--- Returns the food types the current pet can eat.
--- [https://wow.gamepedia.com/wiki/API_GetPetFoodTypes]
--- @return unknown @ petFoodList
function GetPetFoodTypes()
end

--- [https://wow.gamepedia.com/wiki/API_GetPetIcon?action=edit&amp;redlink=1]
--- @return void
function GetPetIcon()
end

--- [https://wow.gamepedia.com/wiki/API_GetPetMeleeHaste?action=edit&amp;redlink=1]
--- @return void
function GetPetMeleeHaste()
end

--- [https://wow.gamepedia.com/wiki/API_GetPetSpellBonusDamage?action=edit&amp;redlink=1]
--- @return void
function GetPetSpellBonusDamage()
end

--- [https://wow.gamepedia.com/wiki/API_GetPetTalentTree?action=edit&amp;redlink=1]
--- @return void
function GetPetTalentTree()
end

--- [https://wow.gamepedia.com/wiki/API_GetPetTimeRemaining?action=edit&amp;redlink=1]
--- @return void
function GetPetTimeRemaining()
end

--- Gets the information for a petition being viewed.
--- [https://wow.gamepedia.com/wiki/API_GetPetitionInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetPetitionNameInfo?action=edit&amp;redlink=1]
--- @return void
function GetPetitionNameInfo()
end

--- Returns physical screen size of game.
--- [https://wow.gamepedia.com/wiki/API_GetPhysicalScreenSize]
--- @return number, number @ width, height
function GetPhysicalScreenSize()
end

--- Returns an active buff/debuff by spell ID on the player character.
--- [https://wow.gamepedia.com/wiki/API_GetPlayerAuraBySpellID]
--- @param spellID number
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetPlayerFacing]
--- @return number @ facing
function GetPlayerFacing()
end

--- Returns basic information about another player from their GUID.
--- [https://wow.gamepedia.com/wiki/API_GetPlayerInfoByGUID]
...
--- [https://wow.gamepedia.com/wiki/API_GetPowerRegen?action=edit&amp;redlink=1]
--- @return void
function GetPowerRegen()
end

--- [https://wow.gamepedia.com/wiki/API_GetPowerRegenForPowerType?action=edit&amp;redlink=1]
--- @return void
function GetPowerRegenForPowerType()
end

--- [https://wow.gamepedia.com/wiki/API_GetPrevCompleatedTutorial?action=edit&amp;redlink=1]
--- @return void
function GetPrevCompleatedTutorial()
end

--- Return the previous achievement in a chain.
--- [https://wow.gamepedia.com/wiki/API_GetPreviousAchievement]
--- @param achievementID number @ The ID of the Achievement
--- @return number @ previousAchievementID
function GetPreviousAchievement(achievementID)
end

--- [https://wow.gamepedia.com/wiki/API_GetPreviousArenaSeason?action=edit&amp;redlink=1]
--- @return void
function GetPreviousArenaSeason()
end

--- [https://wow.gamepedia.com/wiki/API_GetPrimarySpecialization?action=edit&amp;redlink=1]
--- @return void
function GetPrimarySpecialization()
end

--- Gets details on a profession from its index including name, icon, and skill level.
--- [https://wow.gamepedia.com/wiki/API_GetProfessionInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetProfessions]
...
--- [https://wow.gamepedia.com/wiki/API_GetPvpTalentInfoBySpecialization?action=edit&amp;redlink=1]
--- @return void
function GetPvpTalentInfoBySpecialization()
end

--- [https://wow.gamepedia.com/wiki/API_GetPvpTalentLink?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetQuestBackgroundMaterial]
--- @return string @ material
function GetQuestBackgroundMaterial()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestCurrencyID?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetQuestCurrencyInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetQuestExpansion?action=edit&amp;redlink=1]
--- @return void
function GetQuestExpansion()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestFactionGroup?action=edit&amp;redlink=1]
--- @return void
function GetQuestFactionGroup()
end

--- Returns the quest ID of the quest being offered/discussed with an NPC.
--- [https://wow.gamepedia.com/wiki/API_GetQuestID]
--- @return number @ questID
function GetQuestID()
end

--- Returns information about a quest's item rewards or requirements.
--- [https://wow.gamepedia.com/wiki/API_GetQuestItemInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetQuestItemInfoLootType?action=edit&amp;redlink=1]
--- @return void
function GetQuestItemInfoLootType()
end

--- Returns link to the quest item.
--- [https://wow.gamepedia.com/wiki/API_GetQuestItemLink]
...
--- [https://wow.gamepedia.com/wiki/API_GetQuestLink]
...
--- [https://wow.gamepedia.com/wiki/API_GetQuestLogChoiceInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetQuestLogChoiceInfoLootType?action=edit&amp;redlink=1]
--- @return void
function GetQuestLogChoiceInfoLootType()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestLogCompletionText?action=edit&amp;redlink=1]
--- @return void
function GetQuestLogCompletionText()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestLogCriteriaSpell?action=edit&amp;redlink=1]
--- @return void
function GetQuestLogCriteriaSpell()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestLogItemDrop?action=edit&amp;redlink=1]
--- @return void
function GetQuestLogItemDrop()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestLogItemLink]
--- @param type string @ required, reward or choice
...
--- [https://wow.gamepedia.com/wiki/API_GetQuestLogLeaderBoard]
...
--- [https://wow.gamepedia.com/wiki/API_GetQuestLogPortraitGiver?action=edit&amp;redlink=1]
--- @return void
function GetQuestLogPortraitGiver()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestLogPortraitTurnIn?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetQuestLogQuestText]
...
--- [https://wow.gamepedia.com/wiki/API_GetQuestLogQuestType?action=edit&amp;redlink=1]
--- @return void
function GetQuestLogQuestType()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestLogRewardArtifactXP?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetQuestLogRewardCurrencyInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetQuestLogRewardFactionInfo?action=edit&amp;redlink=1]
--- @return void
function GetQuestLogRewardFactionInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestLogRewardHonor?action=edit&amp;redlink=1]
--- @return void
function GetQuestLogRewardHonor()
end

--- GetQuestLogRewardInfo returns information about mandatory quest reward items.
--- [https://wow.gamepedia.com/wiki/API_GetQuestLogRewardInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetQuestLogRewardMoney]
--- @param questID number @ ?Optional.  Could be nil. - Unique identifier for a quest.
--- @return unknown @ money
function GetQuestLogRewardMoney(questID)
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestLogRewardSkillPoints?action=edit&amp;redlink=1]
--- @return void
function GetQuestLogRewardSkillPoints()
end

--- Returns information about the spell reward of the current selected quest.
--- [https://wow.gamepedia.com/wiki/API_GetQuestLogRewardSpell]
...
--- [https://wow.gamepedia.com/wiki/API_GetQuestLogRewardTitle?action=edit&amp;redlink=1]
--- @return void
function GetQuestLogRewardTitle()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestLogRewardXP?action=edit&amp;redlink=1]
--- @return void
function GetQuestLogRewardXP()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestLogSpecialItemCooldown?action=edit&amp;redlink=1]
--- @return void
function GetQuestLogSpecialItemCooldown()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestLogSpecialItemInfo?action=edit&amp;redlink=1]
--- @return void
function GetQuestLogSpecialItemInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestLogSpellLink?action=edit&amp;redlink=1]
--- @return void
function GetQuestLogSpellLink()
end

--- Gets the seconds left for the current quest that is being timed.
--- [https://wow.gamepedia.com/wiki/API_GetQuestLogTimeLeft]
--- @return unknown @ timeLeft
function GetQuestLogTimeLeft()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestMoneyToGet?action=edit&amp;redlink=1]
--- @return void
function GetQuestMoneyToGet()
end

--- Returns information about a quest objective.
--- [https://wow.gamepedia.com/wiki/API_GetQuestObjectiveInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetQuestPOIBlobCount?action=edit&amp;redlink=1]
--- @return void
function GetQuestPOIBlobCount()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestPOILeaderBoard?action=edit&amp;redlink=1]
--- @return void
function GetQuestPOILeaderBoard()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestPOIs?action=edit&amp;redlink=1]
--- @return void
function GetQuestPOIs()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestPortraitGiver?action=edit&amp;redlink=1]
--- @return void
function GetQuestPortraitGiver()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestPortraitTurnIn?action=edit&amp;redlink=1]
--- @return void
function GetQuestPortraitTurnIn()
end

--- Returns a quest's objective completion percentage.
--- [https://wow.gamepedia.com/wiki/API_GetQuestProgressBarPercent]
--- @param questID number @ Unique identifier of the quest.
...
--- [https://wow.gamepedia.com/wiki/API_GetQuestResetTime]
...
--- [https://wow.gamepedia.com/wiki/API_GetQuestReward]
--- @param itemChoice number @ The quest reward chosen
--- @return void
function GetQuestReward(itemChoice)
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestSortIndex?action=edit&amp;redlink=1]
--- @return void
function GetQuestSortIndex()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestSpellLink?action=edit&amp;redlink=1]
--- @return void
function GetQuestSpellLink()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestText?action=edit&amp;redlink=1]
--- @return void
function GetQuestText()
end

--- [https://wow.gamepedia.com/wiki/API_GetQuestUiMapID?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetRFDungeonInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetRaidDifficultyID]
--- @return number @ difficultyID
function GetRaidDifficultyID()
end

--- [https://wow.gamepedia.com/wiki/API_GetRaidProfileFlattenedOptions?action=edit&amp;redlink=1]
--- @return void
function GetRaidProfileFlattenedOptions()
end

--- [https://wow.gamepedia.com/wiki/API_GetRaidProfileName?action=edit&amp;redlink=1]
--- @return void
function GetRaidProfileName()
end

--- [https://wow.gamepedia.com/wiki/API_GetRaidProfileOption?action=edit&amp;redlink=1]
--- @return void
function GetRaidProfileOption()
end

--- [https://wow.gamepedia.com/wiki/API_GetRaidProfileSavedPosition?action=edit&amp;redlink=1]
--- @return void
function GetRaidProfileSavedPosition()
end

--- Gets information about a raid member.
--- [https://wow.gamepedia.com/wiki/API_GetRaidRosterInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetRaidTargetIndex]
--- @param unit string @ UnitId
--- @return number @ index
function GetRaidTargetIndex(unit)
end

--- [https://wow.gamepedia.com/wiki/API_GetRandomDungeonBestChoice?action=edit&amp;redlink=1]
--- @return void
function GetRandomDungeonBestChoice()
end

--- [https://wow.gamepedia.com/wiki/API_GetRandomScenarioBestChoice?action=edit&amp;redlink=1]
--- @return void
function GetRandomScenarioBestChoice()
end

--- [https://wow.gamepedia.com/wiki/API_GetRandomScenarioInfo?action=edit&amp;redlink=1]
--- @return void
function GetRandomScenarioInfo()
end

--- Returns the player's ranged critical hit chance.
--- [https://wow.gamepedia.com/wiki/API_GetRangedCritChance]
--- @return number @ critChance
function GetRangedCritChance()
end

--- Returns the player's ranged haste amount granted through buffs.
--- [https://wow.gamepedia.com/wiki/API_GetRangedHaste]
--- @return number @ haste
function GetRangedHaste()
end

--- [https://wow.gamepedia.com/wiki/API_GetRatedBattleGroundInfo?action=edit&amp;redlink=1]
--- @return void
function GetRatedBattleGroundInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetReadyCheckStatus?action=edit&amp;redlink=1]
--- @return void
function GetReadyCheckStatus()
end

--- [https://wow.gamepedia.com/wiki/API_GetReadyCheckTimeLeft?action=edit&amp;redlink=1]
--- @return void
function GetReadyCheckTimeLeft()
end

--- [https://wow.gamepedia.com/wiki/API_GetReagentBankCost?action=edit&amp;redlink=1]
--- @return void
function GetReagentBankCost()
end

--- Returns the map instance name.
--- [https://wow.gamepedia.com/wiki/API_GetRealZoneText]
...
--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_GetRealmID]
--- @return number @ realmID
function GetRealmID()
end

--- GetRealmName() and GetNormalizedRealmName() return the name of the character's realm in different formats.
--- [https://wow.gamepedia.com/wiki/API_GetRealmName]
--- @return string @ realmName
function GetRealmName()
end

--- [https://wow.gamepedia.com/wiki/API_GetRecruitingGuildInfo?action=edit&amp;redlink=1]
--- @return void
function GetRecruitingGuildInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetRecruitingGuildSelection?action=edit&amp;redlink=1]
--- @return void
function GetRecruitingGuildSelection()
end

--- [https://wow.gamepedia.com/wiki/API_GetRecruitingGuildSettings?action=edit&amp;redlink=1]
--- @return void
function GetRecruitingGuildSettings()
end

--- [https://wow.gamepedia.com/wiki/API_GetReleaseTimeRemaining?action=edit&amp;redlink=1]
--- @return void
function GetReleaseTimeRemaining()
end

--- Arguments none
--- [https://wow.gamepedia.com/wiki/API_GetRepairAllCost]
--- @return number, boolean @ repairAllCost, canRepair
function GetRepairAllCost()
end

--- [https://wow.gamepedia.com/wiki/API_GetResSicknessDuration?action=edit&amp;redlink=1]
--- @return void
function GetResSicknessDuration()
end

--- Returns whether the player is in a rested (earning double XP for kills) or normal state.
--- [https://wow.gamepedia.com/wiki/API_GetRestState]
...
--- [https://wow.gamepedia.com/wiki/API_GetRestrictedAccountData]
--- @return number, number, number @ rLevel, rMoney, profCap
function GetRestrictedAccountData()
end

--- [https://wow.gamepedia.com/wiki/API_GetRewardArtifactXP?action=edit&amp;redlink=1]
--- @return void
function GetRewardArtifactXP()
end

--- [https://wow.gamepedia.com/wiki/API_GetRewardHonor?action=edit&amp;redlink=1]
--- @return void
function GetRewardHonor()
end

--- [https://wow.gamepedia.com/wiki/API_GetRewardMoney?action=edit&amp;redlink=1]
--- @return void
function GetRewardMoney()
end

--- [https://wow.gamepedia.com/wiki/API_GetRewardNumSkillUps?action=edit&amp;redlink=1]
--- @return void
function GetRewardNumSkillUps()
end

--- [https://wow.gamepedia.com/wiki/API_GetRewardPackArtifactPower?action=edit&amp;redlink=1]
--- @return void
function GetRewardPackArtifactPower()
end

--- [https://wow.gamepedia.com/wiki/API_GetRewardPackCurrencies?action=edit&amp;redlink=1]
--- @return void
function GetRewardPackCurrencies()
end

--- [https://wow.gamepedia.com/wiki/API_GetRewardPackItems?action=edit&amp;redlink=1]
--- @return void
function GetRewardPackItems()
end

--- [https://wow.gamepedia.com/wiki/API_GetRewardPackMoney?action=edit&amp;redlink=1]
--- @return void
function GetRewardPackMoney()
end

--- [https://wow.gamepedia.com/wiki/API_GetRewardPackTitle?action=edit&amp;redlink=1]
--- @return void
function GetRewardPackTitle()
end

--- [https://wow.gamepedia.com/wiki/API_GetRewardPackTitleName?action=edit&amp;redlink=1]
--- @return void
function GetRewardPackTitleName()
end

--- [https://wow.gamepedia.com/wiki/API_GetRewardSkillLineID?action=edit&amp;redlink=1]
--- @return void
function GetRewardSkillLineID()
end

--- [https://wow.gamepedia.com/wiki/API_GetRewardSkillPoints?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetRewardSpell]
...
--- [https://wow.gamepedia.com/wiki/API_GetRewardText]
--- @return string @ reward
function GetRewardText()
end

--- [https://wow.gamepedia.com/wiki/API_GetRewardTitle?action=edit&amp;redlink=1]
--- @return void
function GetRewardTitle()
end

--- Returns the experience reward of the quest most recently discussed with an NPC.
--- [https://wow.gamepedia.com/wiki/API_GetRewardXP]
--- @return number @ xp
function GetRewardXP()
end

--- Gets the cooldown information about a Death Knight's Rune
--- [https://wow.gamepedia.com/wiki/API_GetRuneCooldown]
...
--- [https://wow.gamepedia.com/wiki/API_GetRuneCount]
...
--- [https://wow.gamepedia.com/wiki/API_GetRunningMacro?action=edit&amp;redlink=1]
--- @return void
function GetRunningMacro()
end

--- [https://wow.gamepedia.com/wiki/API_GetRunningMacroButton?action=edit&amp;redlink=1]
--- @return void
function GetRunningMacroButton()
end

--- Retrieves the SavedInstanceChatLink to a specific instance.
--- [https://wow.gamepedia.com/wiki/API_GetSavedInstanceChatLink]
...
--- [https://wow.gamepedia.com/wiki/API_GetSavedInstanceEncounterInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetSavedInstanceInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetSavedWorldBossInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetScenariosChoiceOrder]
...
--- [https://wow.gamepedia.com/wiki/API_GetScreenWidth]
--- @return number @ screenWidth
function GetScreenWidth()
end

--- [https://wow.gamepedia.com/wiki/API_GetScriptCPUUsage?action=edit&amp;redlink=1]
--- @return void
function GetScriptCPUUsage()
end

--- [https://wow.gamepedia.com/wiki/API_GetSecondsUntilParentalControlsKick?action=edit&amp;redlink=1]
--- @return void
function GetSecondsUntilParentalControlsKick()
end

--- Returns the information for the selected race's current archaeology artifact.
--- [https://wow.gamepedia.com/wiki/API_GetSelectedArtifactInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetSelectedDisplayChannel?action=edit&amp;redlink=1]
--- @return void
function GetSelectedDisplayChannel()
end

--- [https://wow.gamepedia.com/wiki/API_GetSelectedFaction?action=edit&amp;redlink=1]
--- @return void
function GetSelectedFaction()
end

--- [https://wow.gamepedia.com/wiki/API_GetSelectedWarGameType?action=edit&amp;redlink=1]
--- @return void
function GetSelectedWarGameType()
end

--- Used to determine the amount of COD gold is entered for a mail that is sent.
--- [https://wow.gamepedia.com/wiki/API_GetSendMailCOD]
--- @return void
function GetSendMailCOD()
end

--- Returns information about an item attached in the send mail frame.
--- [https://wow.gamepedia.com/wiki/API_GetSendMailItem]
...
--- [https://wow.gamepedia.com/wiki/API_GetSendMailItemLink]
...
--- [https://wow.gamepedia.com/wiki/API_GetSendMailMoney?action=edit&amp;redlink=1]
--- @return void
function GetSendMailMoney()
end

--- [https://wow.gamepedia.com/wiki/API_GetSendMailPrice]
--- @return number @ sendPrice
function GetSendMailPrice()
end

--- Returns the expansion level currently active on the server.
--- [https://wow.gamepedia.com/wiki/API_GetServerExpansionLevel]
--- @return number @ serverExpansionLevel
function GetServerExpansionLevel()
end

--- Returns the server's Unix time.
--- [https://wow.gamepedia.com/wiki/API_GetServerTime]
--- @return number @ timestamp
function GetServerTime()
end

--- Returns the time since you opened the game client.
--- [https://wow.gamepedia.com/wiki/API_GetSessionTime]
--- @return number @ sessionTime
function GetSessionTime()
end

--- [https://wow.gamepedia.com/wiki/API_GetSetBonusesForSpecializationByItemID?action=edit&amp;redlink=1]
--- @return void
function GetSetBonusesForSpecializationByItemID()
end

--- [https://wow.gamepedia.com/wiki/API_GetShapeshiftForm]
...
--- [https://wow.gamepedia.com/wiki/API_GetShapeshiftFormCooldown]
...
--- [https://wow.gamepedia.com/wiki/API_GetShapeshiftFormID]
--- @return number @ index
function GetShapeshiftFormID()
end

--- Retrieves information about an available shapeshift form or similar ability.
--- [https://wow.gamepedia.com/wiki/API_GetShapeshiftFormInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetSocketItemBoundTradeable]
...
--- [https://wow.gamepedia.com/wiki/API_GetSocketItemInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetSocketItemRefundable]
...
--- [https://wow.gamepedia.com/wiki/API_GetSocketTypes]
--- @return void
function GetSocketTypes()
end

--- [https://wow.gamepedia.com/wiki/API_GetSortBagsRightToLeft?action=edit&amp;redlink=1]
--- @return void
function GetSortBagsRightToLeft()
end

--- [https://wow.gamepedia.com/wiki/API_GetSpecChangeCost?action=edit&amp;redlink=1]
--- @return void
function GetSpecChangeCost()
end

--- Returns the index of the player's current specialization.
--- [https://wow.gamepedia.com/wiki/API_GetSpecialization]
...
--- [https://wow.gamepedia.com/wiki/API_GetSpecializationInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetSpecializationInfoByID]
...
--- Returns information about the specified specialization.
--- [https://wow.gamepedia.com/wiki/API_GetSpecializationInfoForClassID]
...
--- [https://wow.gamepedia.com/wiki/API_GetSpecializationInfoForSpecID?action=edit&amp;redlink=1]
--- @return void
function GetSpecializationInfoForSpecID()
end

--- Returns the mastery spellID of the current player's specializiation.
--- [https://wow.gamepedia.com/wiki/API_GetSpecializationMasterySpells]
...
--- [https://wow.gamepedia.com/wiki/API_GetSpecializationNameForSpecID?action=edit&amp;redlink=1]
--- @return void
function GetSpecializationNameForSpecID()
end

--- Returns the role a specialization is intended to perform.
--- [https://wow.gamepedia.com/wiki/API_GetSpecializationRole]
...
--- Returns the role a specialization is intended to perform.
--- [https://wow.gamepedia.com/wiki/API_GetSpecializationRoleByID]
...
--- [https://wow.gamepedia.com/wiki/API_GetSpecializationSpells]
...
--- [https://wow.gamepedia.com/wiki/API_GetSpecsForSpell?action=edit&amp;redlink=1]
--- @return void
function GetSpecsForSpell()
end

--- [https://wow.gamepedia.com/wiki/API_GetSpeed?action=edit&amp;redlink=1]
--- @return void
function GetSpeed()
end

--- Get information about a spell's Autocast.
--- [https://wow.gamepedia.com/wiki/API_GetSpellAutocast]
...
--- [https://wow.gamepedia.com/wiki/API_GetSpellAvailableLevel?action=edit&amp;redlink=1]
--- @return void
function GetSpellAvailableLevel()
end

--- Gives the (unmodified) cooldown and global cooldown of an ability in milliseconds.
--- [https://wow.gamepedia.com/wiki/API_GetSpellBaseCooldown]
...
--- [https://wow.gamepedia.com/wiki/API_GetSpellBonusDamage]
...
--- [https://wow.gamepedia.com/wiki/API_GetSpellBonusHealing]
--- @return number @ bonusHeal
function GetSpellBonusHealing()
end

--- Retrieves information about a specific spellbook item.
--- [https://wow.gamepedia.com/wiki/API_GetSpellBookItemInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetSpellBookItemName]
...
--- [https://wow.gamepedia.com/wiki/API_GetSpellBookItemTexture]
...
--- Returns information about the charges of a charge-accumulating player ability.
--- [https://wow.gamepedia.com/wiki/API_GetSpellCharges]
--- @param spellId_or_spellName unknown
--- @return number, number, number, number, number @ currentCharges, maxCharges, cooldownStart, cooldownDuration, chargeModRate
function GetSpellCharges(spellId_or_spellName)
end

--- [https://wow.gamepedia.com/wiki/API_GetSpellConfirmationPromptsInfo?action=edit&amp;redlink=1]
--- @return void
function GetSpellConfirmationPromptsInfo()
end

--- Retrieves the cooldown data of the spell specified.
--- [https://wow.gamepedia.com/wiki/API_GetSpellCooldown]
...
--- [https://wow.gamepedia.com/wiki/API_GetSpellCount?action=edit&amp;redlink=1]
--- @return void
function GetSpellCount()
end

--- Returns a players critical hit chance with spells for a certain school.
--- [https://wow.gamepedia.com/wiki/API_GetSpellCritChance]
...
--- [https://wow.gamepedia.com/wiki/API_GetSpellDescription]
...
--- [https://wow.gamepedia.com/wiki/API_GetSpellHitModifier]
--- @return number @ hitModifier
function GetSpellHitModifier()
end

--- Returns information about a spell
--- [https://wow.gamepedia.com/wiki/API_GetSpellInfo]
--- @param spellId_or_spellName unknown
...
--- [https://wow.gamepedia.com/wiki/API_GetSpellLevelLearned?action=edit&amp;redlink=1]
--- @return void
function GetSpellLevelLearned()
end

--- Returns a hyperlink for a spell.
--- [https://wow.gamepedia.com/wiki/API_GetSpellLink]
...
--- [https://wow.gamepedia.com/wiki/API_GetSpellLossOfControlCooldown]
...
--- [https://wow.gamepedia.com/wiki/API_GetSpellPenetration?action=edit&amp;redlink=1]
--- @return void
function GetSpellPenetration()
end

--- Returns a table describing the resource cost of a spell.
--- [https://wow.gamepedia.com/wiki/API_GetSpellPowerCost]
--- @param spellName_or_spellID unknown
--- @return table @ costs
function GetSpellPowerCost(spellName_or_spellID)
end

--- [https://wow.gamepedia.com/wiki/API_GetSpellQueueWindow?action=edit&amp;redlink=1]
--- @return void
function GetSpellQueueWindow()
end

--- [https://wow.gamepedia.com/wiki/API_GetSpellRank?action=edit&amp;redlink=1]
--- @return void
function GetSpellRank()
end

--- [https://wow.gamepedia.com/wiki/API_GetSpellSubtext?action=edit&amp;redlink=1]
--- @return void
function GetSpellSubtext()
end

--- Retrieves information about the specified line of spells
--- [https://wow.gamepedia.com/wiki/API_GetSpellTabInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetSpellTexture]
--- @param spellId_or_spellName unknown
--- @return number @ icon
function GetSpellTexture(spellId_or_spellName)
end

--- [https://wow.gamepedia.com/wiki/API_GetSpellTradeSkillLink?action=edit&amp;redlink=1]
--- @return void
function GetSpellTradeSkillLink()
end

--- [https://wow.gamepedia.com/wiki/API_GetSpellsForCharacterUpgradeTier?action=edit&amp;redlink=1]
--- @return void
function GetSpellsForCharacterUpgradeTier()
end

--- [https://wow.gamepedia.com/wiki/API_GetStablePetFoodTypes]
...
--- [https://wow.gamepedia.com/wiki/API_GetStablePetInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetStatistic]
...
--- [https://wow.gamepedia.com/wiki/API_GetStatisticsCategoryList]
--- @return table @ categories
function GetStatisticsCategoryList()
end

--- [https://wow.gamepedia.com/wiki/API_GetSturdiness?action=edit&amp;redlink=1]
--- @return void
function GetSturdiness()
end

--- Returns the subzone name.
--- [https://wow.gamepedia.com/wiki/API_GetSubZoneText]
--- @return string @ subzone
function GetSubZoneText()
end

--- [https://wow.gamepedia.com/wiki/API_GetSuggestedGroupSize?action=edit&amp;redlink=1]
--- @return void
function GetSuggestedGroupSize()
end

--- Returns information about the cooldown time of the RaF Summon Friend ability.
--- [https://wow.gamepedia.com/wiki/API_GetSummonFriendCooldown]
--- @return number, number @ start, duration
function GetSummonFriendCooldown()
end

--- [https://wow.gamepedia.com/wiki/API_GetTabardCreationCost?action=edit&amp;redlink=1]
--- @return void
function GetTabardCreationCost()
end

--- [https://wow.gamepedia.com/wiki/API_GetTabardInfo?action=edit&amp;redlink=1]
--- @return void
function GetTabardInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetTalentInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetTalentInfoByID]
--- @param talentID number @ Talent ID.
--- @param specGroupIndex number @ Index of active specialization group (GetActiveSpecGroup)
--- @param isInspect boolean @ ? - If non-nil, returns information based on inspectedUnit/classId.
--- @param inspectUnit unknown
...
--- [https://wow.gamepedia.com/wiki/API_GetTalentInfoBySpecialization]
...
--- [https://wow.gamepedia.com/wiki/API_GetTalentLink?action=edit&amp;redlink=1]
--- @return void
function GetTalentLink()
end

--- Returns the column of the selected talent for a given tier.
--- [https://wow.gamepedia.com/wiki/API_GetTalentTierInfo]
--- @param tier number @ Talent tier from 1 to MAX_TALENT_TIERS
--- @param specGroupIndex number @ Index of active specialization group (GetActiveSpecGroup)
--- @param isInspect boolean @ ? - If non-nil, returns information based on inspectedUnit.
...
--- [https://wow.gamepedia.com/wiki/API_GetTaskPOIs?action=edit&amp;redlink=1]
--- @return void
function GetTaskPOIs()
end

--- [https://wow.gamepedia.com/wiki/API_GetTasksTable?action=edit&amp;redlink=1]
--- @return void
function GetTasksTable()
end

--- [https://wow.gamepedia.com/wiki/API_GetTaxiBenchmarkMode?action=edit&amp;redlink=1]
--- @return void
function GetTaxiBenchmarkMode()
end

--- [https://wow.gamepedia.com/wiki/API_GetTaxiMapID?action=edit&amp;redlink=1]
--- @return void
function GetTaxiMapID()
end

--- [https://wow.gamepedia.com/wiki/API_GetTempShapeshiftBarIndex?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetText]
...
--- [https://wow.gamepedia.com/wiki/API_GetThreatStatusColor]
...
--- [https://wow.gamepedia.com/wiki/API_GetTickTime]
--- @return number @ elapsed
function GetTickTime()
end

--- Returns the system uptime of your computer in seconds, with millisecond precision.
--- [https://wow.gamepedia.com/wiki/API_GetTime]
--- @return number @ seconds
function GetTime()
end

--- Returns a monotonic timestamp in seconds, with millisecond precision.
--- [https://wow.gamepedia.com/wiki/API_GetTimePreciseSec]
--- @return number @ seconds
function GetTimePreciseSec()
end

--- [https://wow.gamepedia.com/wiki/API_GetTimeToWellRested?action=edit&amp;redlink=1]
--- @return void
function GetTimeToWellRested()
end

--- Returns the name of a Title ID.
--- [https://wow.gamepedia.com/wiki/API_GetTitleName]
...
--- [https://wow.gamepedia.com/wiki/API_GetTitleText]
--- @return string @ title
function GetTitleText()
end

--- [https://wow.gamepedia.com/wiki/API_GetToolTipInfo?action=edit&amp;redlink=1]
--- @return void
function GetToolTipInfo()
end

--- Returns the total number of Achievement Points earned.
--- [https://wow.gamepedia.com/wiki/API_GetTotalAchievementPoints]
--- @return number @ points
function GetTotalAchievementPoints()
end

--- [https://wow.gamepedia.com/wiki/API_GetTotemCannotDismiss?action=edit&amp;redlink=1]
--- @return void
function GetTotemCannotDismiss()
end

--- [https://wow.gamepedia.com/wiki/API_GetTotemInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetTotemTimeLeft]
...
--- [https://wow.gamepedia.com/wiki/API_GetTrackedAchievements]
...
--- [https://wow.gamepedia.com/wiki/API_GetTrackingInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetTradePlayerItemInfo?action=edit&amp;redlink=1]
--- @return void
function GetTradePlayerItemInfo()
end

--- Returns a single value: chat-ready item link.
--- [https://wow.gamepedia.com/wiki/API_GetTradePlayerItemLink]
--- @param i unknown
...
--- [https://wow.gamepedia.com/wiki/API_GetTradeTargetItemInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetTrainerServiceAbilityReq]
...
--- [https://wow.gamepedia.com/wiki/API_GetTrainerServiceCost]
...
--- [https://wow.gamepedia.com/wiki/API_GetTrainerServiceDescription]
...
--- [https://wow.gamepedia.com/wiki/API_GetTrainerServiceIcon]
...
--- [https://wow.gamepedia.com/wiki/API_GetTrainerServiceInfo]
--- @param id unknown @ Index of the trainer service to retrieve information about. Note that indices are affected by the trainer filter. (See GetTrainerServiceTypeFilter and SetTrainerServiceTypeFilter.)
--- @return unknown, unknown, unknown, unknown @ name, rank, category, expanded
function GetTrainerServiceInfo(id)
end

--- [https://wow.gamepedia.com/wiki/API_GetTrainerServiceItemLink]
...
--- [https://wow.gamepedia.com/wiki/API_GetTrainerServiceLevelReq]
...
--- [https://wow.gamepedia.com/wiki/API_GetTrainerServiceNumAbilityReq?action=edit&amp;redlink=1]
--- @return void
function GetTrainerServiceNumAbilityReq()
end

--- [https://wow.gamepedia.com/wiki/API_GetTrainerServiceSkillLine]
...
--- [https://wow.gamepedia.com/wiki/API_GetTrainerServiceSkillReq]
--- @param index unknown
--- @return unknown, unknown, unknown @ skillName, skillLevel, hasReq
function GetTrainerServiceSkillReq(index)
end

--- [https://wow.gamepedia.com/wiki/API_GetTrainerServiceStepIndex?action=edit&amp;redlink=1]
--- @return void
function GetTrainerServiceStepIndex()
end

--- Returns the status of a skill filter in the trainer window.
--- [https://wow.gamepedia.com/wiki/API_GetTrainerServiceTypeFilter]
--- @param type string @ Possible values:
--- @return boolean @ status
function GetTrainerServiceTypeFilter(type)
end

--- [https://wow.gamepedia.com/wiki/API_GetTrainerTradeskillRankValues?action=edit&amp;redlink=1]
--- @return void
function GetTrainerTradeskillRankValues()
end

--- [https://wow.gamepedia.com/wiki/API_GetTreasurePickerItemInfo?action=edit&amp;redlink=1]
--- @return void
function GetTreasurePickerItemInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GetTutorialsEnabled?action=edit&amp;redlink=1]
--- @return void
function GetTutorialsEnabled()
end

--- [https://wow.gamepedia.com/wiki/API_GetUICameraInfo?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetUnitChargedPowerPoints]
--- @param unit string
--- @return number @ pointIndices
function GetUnitChargedPowerPoints(unit)
end

--- [https://wow.gamepedia.com/wiki/API_GetUnitHealthModifier?action=edit&amp;redlink=1]
--- @return void
function GetUnitHealthModifier()
end

--- [https://wow.gamepedia.com/wiki/API_GetUnitMaxHealthModifier?action=edit&amp;redlink=1]
--- @return void
function GetUnitMaxHealthModifier()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_GetUnitPowerBarInfo]
...
--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_GetUnitPowerBarInfoByID]
...
--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_GetUnitPowerBarStrings]
--- @param unitToken string @ UnitId
...
--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_GetUnitPowerBarStringsByID]
--- @param barID number @ from UnitPowerBarID()
--- @return void
...
--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_GetUnitPowerBarTextureInfo]
...
--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_GetUnitPowerBarTextureInfoByID]
--- @param barID number
--- @param textureIndex number
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetUnitPowerModifier?action=edit&amp;redlink=1]
--- @return void
function GetUnitPowerModifier()
end

--- Returns a value representing the moving speed of a unit. Added in Patch 3.0.1.
--- [https://wow.gamepedia.com/wiki/API_GetUnitSpeed]
...
--- [https://wow.gamepedia.com/wiki/API_GetVehicleBarIndex?action=edit&amp;redlink=1]
--- @return void
function GetVehicleBarIndex()
end

--- [https://wow.gamepedia.com/wiki/API_GetVehicleUIIndicator?action=edit&amp;redlink=1]
--- @return void
function GetVehicleUIIndicator()
end

--- [https://wow.gamepedia.com/wiki/API_GetVehicleUIIndicatorSeat?action=edit&amp;redlink=1]
--- @return void
function GetVehicleUIIndicatorSeat()
end

--- [https://wow.gamepedia.com/wiki/API_GetVersatilityBonus?action=edit&amp;redlink=1]
--- @return void
function GetVersatilityBonus()
end

--- [https://wow.gamepedia.com/wiki/API_GetVideoCaps?action=edit&amp;redlink=1]
--- @return void
function GetVideoCaps()
end

--- [https://wow.gamepedia.com/wiki/API_GetVideoOptions?action=edit&amp;redlink=1]
--- @return void
function GetVideoOptions()
end

--- Returns the item link of an item in void storage.
--- [https://wow.gamepedia.com/wiki/API_GetVoidItemHyperlinkString]
...
--- [https://wow.gamepedia.com/wiki/API_GetVoidItemInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetVoidStorageSlotPageIndex?action=edit&amp;redlink=1]
--- @return void
function GetVoidStorageSlotPageIndex()
end

--- Returns the total Void Transfer cost [1]
--- [https://wow.gamepedia.com/wiki/API_GetVoidTransferCost]
--- @return number @ cost
function GetVoidTransferCost()
end

--- Returns info about the item being deposited into the Void Storage [1]
--- [https://wow.gamepedia.com/wiki/API_GetVoidTransferDepositInfo]
--- @param slotIndex number @ Index ranging from 1 to 9 (VOID_DEPOSIT_MAX)
...
--- [https://wow.gamepedia.com/wiki/API_GetVoidTransferWithdrawalInfo]
--- @param slotIndex number @ Index ranging from 1 to 9 (VOID_WITHDRAW_MAX)
--- @return number, string @ itemID, textureName
function GetVoidTransferWithdrawalInfo(slotIndex)
end

--- [https://wow.gamepedia.com/wiki/API_GetVoidUnlockCost?action=edit&amp;redlink=1]
--- @return void
function GetVoidUnlockCost()
end

--- [https://wow.gamepedia.com/wiki/API_GetWarGameQueueStatus?action=edit&amp;redlink=1]
--- @return void
function GetWarGameQueueStatus()
end

--- [https://wow.gamepedia.com/wiki/API_GetWarGameTypeInfo?action=edit&amp;redlink=1]
--- @return void
function GetWarGameTypeInfo()
end

--- Returns information about the faction that is currently being watched.
--- [https://wow.gamepedia.com/wiki/API_GetWatchedFactionInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetWeaponEnchantInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetWebTicket]
--- @return void
function GetWebTicket()
end

--- [https://wow.gamepedia.com/wiki/API_GetWorldElapsedTime]
...
--- [https://wow.gamepedia.com/wiki/API_GetWorldElapsedTimers?action=edit&amp;redlink=1]
--- @return void
function GetWorldElapsedTimers()
end

--- [https://wow.gamepedia.com/wiki/API_GetWorldMapActionButtonSpellInfo?action=edit&amp;redlink=1]
--- @return void
function GetWorldMapActionButtonSpellInfo()
end

--- Get information regarding a world PvP zone (e.g. Wintergrasp or Tol Barad).
--- [https://wow.gamepedia.com/wiki/API_GetWorldPVPAreaInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GetWorldPVPQueueStatus?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GetXPExhaustion]
--- @return number @ exhaustionThreshold
function GetXPExhaustion()
end

--- Returns PVP info for the current zone.
--- [https://wow.gamepedia.com/wiki/API_GetZonePVPInfo]
...
--- [https://wow.gamepedia.com/wiki/API_GroupHasOfflineMember?action=edit&amp;redlink=1]
--- @return void
function GroupHasOfflineMember()
end

--- [https://wow.gamepedia.com/wiki/API_GuildControlAddRank?action=edit&amp;redlink=1]
--- @return void
function GuildControlAddRank()
end

--- [https://wow.gamepedia.com/wiki/API_GuildControlDelRank]
--- @param index number @ must be between 1 and the value returned by GuildControlGetNumRanks().
--- @return void
function GuildControlDelRank(index)
end

--- [https://wow.gamepedia.com/wiki/API_GuildControlGetAllowedShifts?action=edit&amp;redlink=1]
--- @return void
function GuildControlGetAllowedShifts()
end

--- [https://wow.gamepedia.com/wiki/API_GuildControlGetNumRanks?action=edit&amp;redlink=1]
--- @return void
function GuildControlGetNumRanks()
end

--- [https://wow.gamepedia.com/wiki/API_GuildControlGetRankName]
--- @param index number @ the rank index
--- @return void
function GuildControlGetRankName(index)
end

--- [https://wow.gamepedia.com/wiki/API_GuildControlSaveRank]
...
--- [https://wow.gamepedia.com/wiki/API_GuildControlSetRank]
...
--- [https://wow.gamepedia.com/wiki/API_GuildControlSetRankFlag]
...
--- [https://wow.gamepedia.com/wiki/API_GuildControlShiftRankDown?action=edit&amp;redlink=1]
--- @return void
function GuildControlShiftRankDown()
end

--- [https://wow.gamepedia.com/wiki/API_GuildControlShiftRankUp?action=edit&amp;redlink=1]
--- @return void
function GuildControlShiftRankUp()
end

--- Demotes a specified player if you have that privilege.
--- [https://wow.gamepedia.com/wiki/API_GuildDemote]
...
--- Disbands your guild.
--- [https://wow.gamepedia.com/wiki/API_GuildDisband]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_GuildInfo]
--- @return void
function GuildInfo()
end

--- [https://wow.gamepedia.com/wiki/API_GuildInvite]
--- @param playername unknown
--- @return void
function GuildInvite(playername)
end

--- [https://wow.gamepedia.com/wiki/API_GuildLeave]
--- @return void
function GuildLeave()
end

--- [https://wow.gamepedia.com/wiki/API_GuildMasterAbsent?action=edit&amp;redlink=1]
--- @return void
function GuildMasterAbsent()
end

--- [https://wow.gamepedia.com/wiki/API_GuildNewsSetSticky?action=edit&amp;redlink=1]
--- @return void
function GuildNewsSetSticky()
end

--- [https://wow.gamepedia.com/wiki/API_GuildNewsSort?action=edit&amp;redlink=1]
--- @return void
function GuildNewsSort()
end

--- Promotes a specified player if you have that privilege.
--- [https://wow.gamepedia.com/wiki/API_GuildPromote]
...
--- [https://wow.gamepedia.com/wiki/API_GuildRosterSetOfficerNote]
...
--- Sets the public note of a guild member.
--- [https://wow.gamepedia.com/wiki/API_GuildRosterSetPublicNote]
--- @param index unknown @ The position a member is in the guild roster.  This can be found by counting from the top down to the member or by selecting the member and using the GetGuildRosterSelection() function.
...
--- [https://wow.gamepedia.com/wiki/API_GuildSetLeader]
--- @param name string @ name of the character you wish to promote to Guild Leader.
--- @return void
function GuildSetLeader(name)
end

--- [https://wow.gamepedia.com/wiki/API_GuildSetMOTD]
--- @param message unknown
--- @return void
function GuildSetMOTD(message)
end

--- [https://wow.gamepedia.com/wiki/API_GuildUninvite]
--- @return void
function GuildUninvite()
end

--- [https://wow.gamepedia.com/wiki/API_HandleAtlasMemberCommand?action=edit&amp;redlink=1]
--- @return void
function HandleAtlasMemberCommand()
end

--- [https://wow.gamepedia.com/wiki/API_HasAPEffectsSpellPower?action=edit&amp;redlink=1]
--- @return void
function HasAPEffectsSpellPower()
end

--- Tests if an action slot is occupied.
--- [https://wow.gamepedia.com/wiki/API_HasAction]
...
--- [https://wow.gamepedia.com/wiki/API_HasAlternateForm]
--- @return boolean, boolean @ hasAlternateForm, inAlternateForm
function HasAlternateForm()
end

--- [https://wow.gamepedia.com/wiki/API_HasArtifactEquipped?action=edit&amp;redlink=1]
--- @return void
function HasArtifactEquipped()
end

--- [https://wow.gamepedia.com/wiki/API_HasAttachedGlyph?action=edit&amp;redlink=1]
--- @return void
function HasAttachedGlyph()
end

--- [https://wow.gamepedia.com/wiki/API_HasBonusActionBar?action=edit&amp;redlink=1]
--- @return void
function HasBonusActionBar()
end

--- [https://wow.gamepedia.com/wiki/API_HasBoundGemProposed?action=edit&amp;redlink=1]
--- @return void
function HasBoundGemProposed()
end

--- [https://wow.gamepedia.com/wiki/API_HasCompletedAnyAchievement?action=edit&amp;redlink=1]
--- @return void
function HasCompletedAnyAchievement()
end

--- [https://wow.gamepedia.com/wiki/API_HasDualWieldPenalty?action=edit&amp;redlink=1]
--- @return void
function HasDualWieldPenalty()
end

--- Returns whether the player currently has an extra action bar/button.
--- [https://wow.gamepedia.com/wiki/API_HasExtraActionBar]
...
--- [https://wow.gamepedia.com/wiki/API_HasFullControl]
--- @return boolean @ hasControl
function HasFullControl()
end

--- [https://wow.gamepedia.com/wiki/API_HasIgnoreDualWieldWeapon?action=edit&amp;redlink=1]
--- @return void
function HasIgnoreDualWieldWeapon()
end

--- [https://wow.gamepedia.com/wiki/API_HasInboxItem?action=edit&amp;redlink=1]
--- @return void
function HasInboxItem()
end

--- Returns whether the player is in a random party formed by the dungeon finder system.
--- [https://wow.gamepedia.com/wiki/API_HasLFGRestrictions]
--- @return number @ isRestricted
function HasLFGRestrictions()
end

--- [https://wow.gamepedia.com/wiki/API_HasLoadedCUFProfiles?action=edit&amp;redlink=1]
--- @return void
function HasLoadedCUFProfiles()
end

--- [https://wow.gamepedia.com/wiki/API_HasNewMail?action=edit&amp;redlink=1]
--- @return void
function HasNewMail()
end

--- [https://wow.gamepedia.com/wiki/API_HasNoReleaseAura?action=edit&amp;redlink=1]
--- @return void
function HasNoReleaseAura()
end

--- [https://wow.gamepedia.com/wiki/API_HasOverrideActionBar?action=edit&amp;redlink=1]
--- @return void
function HasOverrideActionBar()
end

--- [https://wow.gamepedia.com/wiki/API_HasPendingGlyphCast?action=edit&amp;redlink=1]
--- @return void
function HasPendingGlyphCast()
end

--- Returns how many abilities your pet has available.
--- [https://wow.gamepedia.com/wiki/API_HasPetSpells]
--- @return unknown, string @ hasPetSpells, petToken
function HasPetSpells()
end

--- Returns True if the player has a pet User Interface.
--- [https://wow.gamepedia.com/wiki/API_HasPetUI]
--- @return boolean, boolean @ hasUI, isHunterPet
function HasPetUI()
end

--- [https://wow.gamepedia.com/wiki/API_HasSPEffectsAttackPower?action=edit&amp;redlink=1]
--- @return void
function HasSPEffectsAttackPower()
end

--- [https://wow.gamepedia.com/wiki/API_HasSendMailItem?action=edit&amp;redlink=1]
--- @return void
function HasSendMailItem()
end

--- [https://wow.gamepedia.com/wiki/API_HasTempShapeshiftActionBar?action=edit&amp;redlink=1]
--- @return void
function HasTempShapeshiftActionBar()
end

--- [https://wow.gamepedia.com/wiki/API_HasVehicleActionBar?action=edit&amp;redlink=1]
--- @return void
function HasVehicleActionBar()
end

--- HasWandEquipped();
--- [https://wow.gamepedia.com/wiki/API_HasWandEquipped]
--- @return void
function HasWandEquipped()
end

--- [https://wow.gamepedia.com/wiki/API_HaveQuestData?action=edit&amp;redlink=1]
--- @return void
function HaveQuestData()
end

--- [https://wow.gamepedia.com/wiki/API_HaveQuestRewardData?action=edit&amp;redlink=1]
--- @return void
function HaveQuestRewardData()
end

--- [https://wow.gamepedia.com/wiki/API_HearthAndResurrectFromArea?action=edit&amp;redlink=1]
--- @return void
function HearthAndResurrectFromArea()
end

--- [https://wow.gamepedia.com/wiki/API_HideRepairCursor]
--- @return void
function HideRepairCursor()
end

--- Returns true during pre-rendered movie-like cinematics.
--- [https://wow.gamepedia.com/wiki/API_InCinematic]
--- @return boolean @ inCinematic
function InCinematic()
end

--- Determines whether in-combat lockdown restrictions are active.
--- [https://wow.gamepedia.com/wiki/API_InCombatLockdown]
--- @return unknown @ inLockdown
function InCombatLockdown()
end

--- Returns whether or not you are in a guild party.
--- [https://wow.gamepedia.com/wiki/API_InGuildParty]
...
--- [https://wow.gamepedia.com/wiki/API_InitiateRolePoll]
--- @return void
function InitiateRolePoll()
end

--- Opens the Trade window with selected target.
--- [https://wow.gamepedia.com/wiki/API_InitiateTrade]
--- @param unit string @ unitId to initiate trade with, e.g. target.
--- @return void
function InitiateTrade(unit)
end

--- [https://wow.gamepedia.com/wiki/API_InteractUnit?action=edit&amp;redlink=1]
--- @return void
function InteractUnit()
end

--- [https://wow.gamepedia.com/wiki/API_Is64BitClient?action=edit&amp;redlink=1]
--- @return void
function Is64BitClient()
end

--- Returns if the account has been secured with Blizzard Mobile Authenticator.
--- [https://wow.gamepedia.com/wiki/API_IsAccountSecured]
...
--- [https://wow.gamepedia.com/wiki/API_IsAchievementEligible]
...
--- [https://wow.gamepedia.com/wiki/API_IsActionInRange]
...
--- [https://wow.gamepedia.com/wiki/API_IsActiveBattlefieldArena]
--- @return boolean, boolean @ isArena, isRegistered
function IsActiveBattlefieldArena()
end

--- [https://wow.gamepedia.com/wiki/API_IsActiveQuestLegendary?action=edit&amp;redlink=1]
--- @return void
function IsActiveQuestLegendary()
end

--- [https://wow.gamepedia.com/wiki/API_IsActiveQuestTrivial?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_IsAddOnLoadOnDemand]
--- @param index_or_name unknown
...
--- [https://wow.gamepedia.com/wiki/API_IsAddOnLoaded]
--- @param index_or_name unknown
--- @return number, number @ loaded, finished
function IsAddOnLoaded(index_or_name)
end

--- [https://wow.gamepedia.com/wiki/API_IsAddonVersionCheckEnabled?action=edit&amp;redlink=1]
--- @return void
function IsAddonVersionCheckEnabled()
end

--- Returns whether the player can teleport to/from an LFG instance.
--- [https://wow.gamepedia.com/wiki/API_IsAllowedToUserTeleport]
...
--- [https://wow.gamepedia.com/wiki/API_IsAltKeyDown]
--- @return void
function IsAltKeyDown()
end

--- [https://wow.gamepedia.com/wiki/API_IsArenaSkirmish?action=edit&amp;redlink=1]
--- @return void
function IsArenaSkirmish()
end

--- [https://wow.gamepedia.com/wiki/API_IsArenaTeamCaptain?action=edit&amp;redlink=1]
--- @return void
function IsArenaTeamCaptain()
end

--- [https://wow.gamepedia.com/wiki/API_IsArtifactCompletionHistoryAvailable?action=edit&amp;redlink=1]
--- @return void
function IsArtifactCompletionHistoryAvailable()
end

--- [https://wow.gamepedia.com/wiki/API_IsArtifactPowerItem?action=edit&amp;redlink=1]
--- @return void
function IsArtifactPowerItem()
end

--- [https://wow.gamepedia.com/wiki/API_IsArtifactRelicItem?action=edit&amp;redlink=1]
--- @return void
function IsArtifactRelicItem()
end

--- [https://wow.gamepedia.com/wiki/API_IsAtStableMaster?action=edit&amp;redlink=1]
--- @return void
function IsAtStableMaster()
end

--- Determine whether action slot is an attack action.
--- [https://wow.gamepedia.com/wiki/API_IsAttackAction]
--- @param actionSlot number @ The action slot to test.
...
--- [https://wow.gamepedia.com/wiki/API_IsAttackSpell]
...
--- [https://wow.gamepedia.com/wiki/API_IsAutoRepeatAction]
--- @param actionSlot number @ The action slot to query.
--- @return boolean @ isRepeating
function IsAutoRepeatAction(actionSlot)
end

--- [https://wow.gamepedia.com/wiki/API_IsAutoRepeatSpell?action=edit&amp;redlink=1]
--- @return void
function IsAutoRepeatSpell()
end

--- [https://wow.gamepedia.com/wiki/API_IsAvailableQuestTrivial?action=edit&amp;redlink=1]
--- @return void
function IsAvailableQuestTrivial()
end

--- [https://wow.gamepedia.com/wiki/API_IsBNLogin?action=edit&amp;redlink=1]
--- @return void
function IsBNLogin()
end

--- [https://wow.gamepedia.com/wiki/API_IsBagSlotFlagEnabledOnOtherBags?action=edit&amp;redlink=1]
--- @return void
function IsBagSlotFlagEnabledOnOtherBags()
end

--- [https://wow.gamepedia.com/wiki/API_IsBagSlotFlagEnabledOnOtherBankBags?action=edit&amp;redlink=1]
--- @return void
function IsBagSlotFlagEnabledOnOtherBankBags()
end

--- [https://wow.gamepedia.com/wiki/API_IsBarberShopStyleValid?action=edit&amp;redlink=1]
--- @return void
function IsBarberShopStyleValid()
end

--- Returns whether an item was purchased from the in-game store.
--- [https://wow.gamepedia.com/wiki/API_IsBattlePayItem]
...
--- [https://wow.gamepedia.com/wiki/API_IsBindingForGamePad?action=edit&amp;redlink=1]
--- @return void
function IsBindingForGamePad()
end

--- [https://wow.gamepedia.com/wiki/API_IsBreadcrumbQuest?action=edit&amp;redlink=1]
--- @return void
function IsBreadcrumbQuest()
end

--- [https://wow.gamepedia.com/wiki/API_IsCastingGlyph?action=edit&amp;redlink=1]
--- @return void
function IsCastingGlyph()
end

--- [https://wow.gamepedia.com/wiki/API_IsCemeterySelectionAvailable?action=edit&amp;redlink=1]
--- @return void
function IsCemeterySelectionAvailable()
end

--- [https://wow.gamepedia.com/wiki/API_IsCharacterNewlyBoosted?action=edit&amp;redlink=1]
--- @return void
function IsCharacterNewlyBoosted()
end

--- [https://wow.gamepedia.com/wiki/API_IsChatAFK?action=edit&amp;redlink=1]
--- @return void
function IsChatAFK()
end

--- [https://wow.gamepedia.com/wiki/API_IsChatChannelRaid?action=edit&amp;redlink=1]
--- @return void
function IsChatChannelRaid()
end

--- [https://wow.gamepedia.com/wiki/API_IsChatDND?action=edit&amp;redlink=1]
--- @return void
function IsChatDND()
end

--- [https://wow.gamepedia.com/wiki/API_IsCompetitiveModeEnabled?action=edit&amp;redlink=1]
--- @return void
function IsCompetitiveModeEnabled()
end

--- Tests if the action is linked to a consumable item.
--- [https://wow.gamepedia.com/wiki/API_IsConsumableAction]
...
--- [https://wow.gamepedia.com/wiki/API_IsConsumableItem]
...
--- [https://wow.gamepedia.com/wiki/API_IsConsumableSpell?action=edit&amp;redlink=1]
--- @return void
function IsConsumableSpell()
end

--- [https://wow.gamepedia.com/wiki/API_IsContainerFiltered?action=edit&amp;redlink=1]
--- @return void
function IsContainerFiltered()
end

--- [https://wow.gamepedia.com/wiki/API_IsContainerItemAnUpgrade?action=edit&amp;redlink=1]
--- @return void
function IsContainerItemAnUpgrade()
end

--- There are three seperate levels of IsModifierKeyDown() type API functions but they all do the same basic function and return true if the specified key is currently pressed down.
--- [https://wow.gamepedia.com/wiki/API_IsControlKeyDown]
--- @return void
function IsControlKeyDown()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_IsCorruptedItem]
...
--- [https://wow.gamepedia.com/wiki/API_IsCosmeticItem?action=edit&amp;redlink=1]
--- @return void
function IsCosmeticItem()
end

--- Determine whether an action is currently executing.
--- [https://wow.gamepedia.com/wiki/API_IsCurrentAction]
--- @param actionSlot number @ action slot ID to query.
--- @return number @ isCurrent
function IsCurrentAction(actionSlot)
end

--- [https://wow.gamepedia.com/wiki/API_IsCurrentItem?action=edit&amp;redlink=1]
--- @return void
function IsCurrentItem()
end

--- [https://wow.gamepedia.com/wiki/API_IsCurrentQuestFailed?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_IsCurrentSpell]
--- @param spellID boolean @ spell ID to query.
--- @return boolean @ isCurrent
function IsCurrentSpell(spellID)
end

--- [https://wow.gamepedia.com/wiki/API_IsDebugBuild?action=edit&amp;redlink=1]
--- @return void
function IsDebugBuild()
end

--- [https://wow.gamepedia.com/wiki/API_IsDemonHunterAvailable?action=edit&amp;redlink=1]
--- @return void
function IsDemonHunterAvailable()
end

--- [https://wow.gamepedia.com/wiki/API_IsDesaturateSupported?action=edit&amp;redlink=1]
--- @return void
function IsDesaturateSupported()
end

--- [https://wow.gamepedia.com/wiki/API_IsDisplayChannelModerator?action=edit&amp;redlink=1]
--- @return void
function IsDisplayChannelModerator()
end

--- [https://wow.gamepedia.com/wiki/API_IsDisplayChannelOwner?action=edit&amp;redlink=1]
--- @return void
function IsDisplayChannelOwner()
end

--- [https://wow.gamepedia.com/wiki/API_IsDressableItem?action=edit&amp;redlink=1]
--- @return void
function IsDressableItem()
end

--- Returns if your character is Dual wielding.
--- [https://wow.gamepedia.com/wiki/API_IsDualWielding]
--- @return boolean @ isDualWield
function IsDualWielding()
end

--- [https://wow.gamepedia.com/wiki/API_IsEncounterInProgress?action=edit&amp;redlink=1]
--- @return void
function IsEncounterInProgress()
end

--- [https://wow.gamepedia.com/wiki/API_IsEncounterLimitingResurrections?action=edit&amp;redlink=1]
--- @return void
function IsEncounterLimitingResurrections()
end

--- [https://wow.gamepedia.com/wiki/API_IsEncounterSuppressingRelease?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_IsEquippableItem]
--- @param itemId_or_itemName_or_itemLink unknown
...
--- [https://wow.gamepedia.com/wiki/API_IsEquippedAction]
...
--- [https://wow.gamepedia.com/wiki/API_IsEquippedItem]
...
--- [https://wow.gamepedia.com/wiki/API_IsEquippedItemType]
--- @param type string @ ItemType) - any valid inventory type, item class, or item subclass
--- @return boolean @ isEquipped
function IsEquippedItemType(type)
end

--- [https://wow.gamepedia.com/wiki/API_IsEuropeanNumbers?action=edit&amp;redlink=1]
--- @return void
function IsEuropeanNumbers()
end

--- [https://wow.gamepedia.com/wiki/API_IsEveryoneAssistant?action=edit&amp;redlink=1]
--- @return void
function IsEveryoneAssistant()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_IsExpansionTrial]
...
--- [https://wow.gamepedia.com/wiki/API_IsFactionInactive]
...
--- [https://wow.gamepedia.com/wiki/API_IsFalling]
--- @return unknown @ falling
function IsFalling()
end

--- This function is only for determining if the loot window is related to fishing.
--- [https://wow.gamepedia.com/wiki/API_IsFishingLoot]
--- @return void
function IsFishingLoot()
end

--- Checks if the character's current location is classified as being a flyable area.
--- [https://wow.gamepedia.com/wiki/API_IsFlyableArea]
--- @return unknown @ canFly
function IsFlyableArea()
end

--- Checks whether the player is currently flying.
--- [https://wow.gamepedia.com/wiki/API_IsFlying]
--- @return unknown @ flying
function IsFlying()
end

--- Returns true if the client downloaded has the GM MPQs attached, returns false otherwise.
--- [https://wow.gamepedia.com/wiki/API_IsGMClient]
--- @return void
function IsGMClient()
end

--- [https://wow.gamepedia.com/wiki/API_IsGUIDInGroup?action=edit&amp;redlink=1]
--- @return void
function IsGUIDInGroup()
end

--- [https://wow.gamepedia.com/wiki/API_IsGamePadCursorControlEnabled?action=edit&amp;redlink=1]
--- @return void
function IsGamePadCursorControlEnabled()
end

--- [https://wow.gamepedia.com/wiki/API_IsGamePadFreelookEnabled?action=edit&amp;redlink=1]
--- @return void
function IsGamePadFreelookEnabled()
end

--- This function checks if you are the guild master or not.
--- [https://wow.gamepedia.com/wiki/API_IsGuildLeader]
--- @return boolean @ isGuildLeader
function IsGuildLeader()
end

--- [https://wow.gamepedia.com/wiki/API_IsGuildMember?action=edit&amp;redlink=1]
--- @return void
function IsGuildMember()
end

--- [https://wow.gamepedia.com/wiki/API_IsGuildRankAssignmentAllowed?action=edit&amp;redlink=1]
--- @return void
function IsGuildRankAssignmentAllowed()
end

--- [https://wow.gamepedia.com/wiki/API_IsHarmfulItem?action=edit&amp;redlink=1]
--- @return void
function IsHarmfulItem()
end

--- [https://wow.gamepedia.com/wiki/API_IsHarmfulSpell?action=edit&amp;redlink=1]
--- @return void
function IsHarmfulSpell()
end

--- [https://wow.gamepedia.com/wiki/API_IsHelpfulItem?action=edit&amp;redlink=1]
--- @return void
function IsHelpfulItem()
end

--- [https://wow.gamepedia.com/wiki/API_IsHelpfulSpell?action=edit&amp;redlink=1]
--- @return void
function IsHelpfulSpell()
end

--- [https://wow.gamepedia.com/wiki/API_IsInActiveWorldPVP?action=edit&amp;redlink=1]
--- @return void
function IsInActiveWorldPVP()
end

--- [https://wow.gamepedia.com/wiki/API_IsInArenaTeam?action=edit&amp;redlink=1]
--- @return void
function IsInArenaTeam()
end

--- [https://wow.gamepedia.com/wiki/API_IsInAuthenticatedRank?action=edit&amp;redlink=1]
--- @return void
function IsInAuthenticatedRank()
end

--- Returns true during cinematics produced dynamically by the game engine.[citation needed]
--- [https://wow.gamepedia.com/wiki/API_IsInCinematicScene]
--- @return boolean @ inCinematicScene
function IsInCinematicScene()
end

--- Returns whether the player is in a [specific type of] group.
--- [https://wow.gamepedia.com/wiki/API_IsInGroup]
...
--- [https://wow.gamepedia.com/wiki/API_IsInGuild]
--- @return boolean @ isGuildMember
function IsInGuild()
end

--- [https://wow.gamepedia.com/wiki/API_IsInGuildGroup?action=edit&amp;redlink=1]
--- @return void
function IsInGuildGroup()
end

--- Checks whether the player is in an instance and the type of instance.
--- [https://wow.gamepedia.com/wiki/API_IsInInstance]
--- @return number, string @ inInstance, instanceType
function IsInInstance()
end

--- [https://wow.gamepedia.com/wiki/API_IsInJailersTower?action=edit&amp;redlink=1]
--- @return void
function IsInJailersTower()
end

--- [https://wow.gamepedia.com/wiki/API_IsInLFGDungeon?action=edit&amp;redlink=1]
--- @return void
function IsInLFGDungeon()
end

--- Indicates whether the player is in a [specific type of] raid group.
--- [https://wow.gamepedia.com/wiki/API_IsInRaid]
--- @param groupType number @ To check for a specific type of group, provide one of:
--- @return boolean @ isInRaid
function IsInRaid(groupType)
end

--- [https://wow.gamepedia.com/wiki/API_IsInScenarioGroup?action=edit&amp;redlink=1]
--- @return void
function IsInScenarioGroup()
end

--- Returns whether the player's character is currently indoors. Most mounts are not usable indoors.
--- [https://wow.gamepedia.com/wiki/API_IsIndoors]
--- @return unknown @ indoors
function IsIndoors()
end

--- [https://wow.gamepedia.com/wiki/API_IsInsane?action=edit&amp;redlink=1]
--- @return void
function IsInsane()
end

--- [https://wow.gamepedia.com/wiki/API_IsInventoryItemAnUpgrade?action=edit&amp;redlink=1]
--- @return void
function IsInventoryItemAnUpgrade()
end

--- Returns whether an inventory item is locked, usually as it awaits pending action.
--- [https://wow.gamepedia.com/wiki/API_IsInventoryItemLocked]
...
--- [https://wow.gamepedia.com/wiki/API_IsInventoryItemProfessionBag?action=edit&amp;redlink=1]
--- @return void
function IsInventoryItemProfessionBag()
end

--- [https://wow.gamepedia.com/wiki/API_IsItemAction?action=edit&amp;redlink=1]
--- @return void
function IsItemAction()
end

--- Returns whether the item is in usable range of the unit.
--- [https://wow.gamepedia.com/wiki/API_IsItemInRange]
...
--- [https://wow.gamepedia.com/wiki/API_IsJailersTowerLayerTimeLocked?action=edit&amp;redlink=1]
--- @return void
function IsJailersTowerLayerTimeLocked()
end

--- [https://wow.gamepedia.com/wiki/API_IsKeyDown?action=edit&amp;redlink=1]
--- @return void
function IsKeyDown()
end
...
--- [https://wow.gamepedia.com/wiki/API_IsLFGComplete]
--- @return boolean @ isComplete
function IsLFGComplete()
end

--- [https://wow.gamepedia.com/wiki/API_IsLFGDungeonJoinable?action=edit&amp;redlink=1]
--- @return void
function IsLFGDungeonJoinable()
end

--- There are three seperate levels of IsModifierKeyDown() type API functions but they all do the same basic function and return true if the specified key is currently pressed down.
--- [https://wow.gamepedia.com/wiki/API_IsLeftAltKeyDown]
--- @return void
function IsLeftAltKeyDown()
end

--- There are three seperate levels of IsModifierKeyDown() type API functions but they all do the same basic function and return true if the specified key is currently pressed down.
--- [https://wow.gamepedia.com/wiki/API_IsLeftControlKeyDown]
--- @return void
function IsLeftControlKeyDown()
end

--- [https://wow.gamepedia.com/wiki/API_IsLeftMetaKeyDown?action=edit&amp;redlink=1]
--- @return void
function IsLeftMetaKeyDown()
end

--- There are three seperate levels of IsModifierKeyDown() type API functions but they all do the same basic function and return true if the specified key is currently pressed down.
--- [https://wow.gamepedia.com/wiki/API_IsLeftShiftKeyDown]
--- @return void
function IsLeftShiftKeyDown()
end

--- [https://wow.gamepedia.com/wiki/API_IsLegacyDifficulty?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_IsLinuxClient]
--- @return void
function IsLinuxClient()
end

--- [https://wow.gamepedia.com/wiki/API_IsLoggedIn?action=edit&amp;redlink=1]
--- @return void
function IsLoggedIn()
end

--- Checks to see if client is running on a Macintosh.
--- [https://wow.gamepedia.com/wiki/API_IsMacClient]
--- @return boolean @ isMac
function IsMacClient()
end

--- [https://wow.gamepedia.com/wiki/API_IsMasterLooter?action=edit&amp;redlink=1]
--- @return void
function IsMasterLooter()
end

--- [https://wow.gamepedia.com/wiki/API_IsMetaKeyDown?action=edit&amp;redlink=1]
--- @return void
function IsMetaKeyDown()
end

--- Indicates whether the modifier keys for the selected action are pressed.
--- [https://wow.gamepedia.com/wiki/API_IsModifiedClick]
...
--- There are three seperate levels of IsModifierKeyDown() type API functions but they all do the same basic function and return true if the specified key is currently pressed down.
--- [https://wow.gamepedia.com/wiki/API_IsModifierKeyDown]
--- @return unknown @ anyModKeyIsDown
function IsModifierKeyDown()
end

--- Checks to see if the player is mounted or not.
--- [https://wow.gamepedia.com/wiki/API_IsMounted]
--- @return void
function IsMounted()
end

--- Returns whether a mouse button is being held down.
--- [https://wow.gamepedia.com/wiki/API_IsMouseButtonDown]
...
--- [https://wow.gamepedia.com/wiki/API_IsMouselooking]
--- @return void
function IsMouselooking()
end

--- [https://wow.gamepedia.com/wiki/API_IsMovieLocal?action=edit&amp;redlink=1]
--- @return void
function IsMovieLocal()
end

--- Returns if the movie exists and can be played. Exceptions apply.
--- [https://wow.gamepedia.com/wiki/API_IsMoviePlayable]
...
--- [https://wow.gamepedia.com/wiki/API_IsOnGlueScreen]
--- @return boolean @ isOnGlueScreen
function IsOnGlueScreen()
end

--- [https://wow.gamepedia.com/wiki/API_IsOnGroundFloorInJailersTower?action=edit&amp;redlink=1]
--- @return void
function IsOnGroundFloorInJailersTower()
end

--- [https://wow.gamepedia.com/wiki/API_IsOnTournamentRealm?action=edit&amp;redlink=1]
--- @return void
function IsOnTournamentRealm()
end

--- Returns whether the player's character is currently outside of the map.
--- [https://wow.gamepedia.com/wiki/API_IsOutOfBounds]
--- @return number @ oob
function IsOutOfBounds()
end

--- Returns whether the player's character is currently outdoors.
--- [https://wow.gamepedia.com/wiki/API_IsOutdoors]
--- @return unknown @ outdoors
function IsOutdoors()
end

--- [https://wow.gamepedia.com/wiki/API_IsOutlineModeSupported?action=edit&amp;redlink=1]
--- @return void
function IsOutlineModeSupported()
end

--- [https://wow.gamepedia.com/wiki/API_IsPVPTimerRunning?action=edit&amp;redlink=1]
--- @return void
function IsPVPTimerRunning()
end

--- [https://wow.gamepedia.com/wiki/API_IsPartyLFG?action=edit&amp;redlink=1]
--- @return void
function IsPartyLFG()
end

--- [https://wow.gamepedia.com/wiki/API_IsPartyWorldPVP?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_IsPassiveSpell]
...
--- [https://wow.gamepedia.com/wiki/API_IsPendingGlyphRemoval?action=edit&amp;redlink=1]
--- @return void
function IsPendingGlyphRemoval()
end

--- [https://wow.gamepedia.com/wiki/API_IsPetActive?action=edit&amp;redlink=1]
--- @return void
function IsPetActive()
end

--- [https://wow.gamepedia.com/wiki/API_IsPetAttackAction?action=edit&amp;redlink=1]
--- @return void
function IsPetAttackAction()
end

--- boolean attackStatus = IsPetAttackActive(integer index)
--- [https://wow.gamepedia.com/wiki/API_IsPetAttackActive]
--- @return void
function IsPetAttackActive()
end

--- [https://wow.gamepedia.com/wiki/API_IsPlayerInWorld?action=edit&amp;redlink=1]
--- @return void
function IsPlayerInWorld()
end

--- [https://wow.gamepedia.com/wiki/API_IsPlayerMoving?action=edit&amp;redlink=1]
--- @return void
function IsPlayerMoving()
end

--- Returns whether the player is currently neutral (vs Alliance/Horde).
--- [https://wow.gamepedia.com/wiki/API_IsPlayerNeutral]
--- @return boolean @ isNeutral
function IsPlayerNeutral()
end

--- Returns whether the player has learned a particular spell.
--- [https://wow.gamepedia.com/wiki/API_IsPlayerSpell]
--- @param spellID number @ Spell ID of the spell to query, e.g. 1953 for [Blink].
--- @return boolean @ isKnown
function IsPlayerSpell(spellID)
end

--- [https://wow.gamepedia.com/wiki/API_IsPossessBarVisible?action=edit&amp;redlink=1]
--- @return void
function IsPossessBarVisible()
end

--- [https://wow.gamepedia.com/wiki/API_IsPublicBuild?action=edit&amp;redlink=1]
--- @return void
function IsPublicBuild()
end

--- [https://wow.gamepedia.com/wiki/API_IsPvpTalentSpell?action=edit&amp;redlink=1]
--- @return void
function IsPvpTalentSpell()
end

--- Returns true if the currently loaded quest in the quest window is completable.
--- [https://wow.gamepedia.com/wiki/API_IsQuestCompletable]
--- @return boolean @ isQuestCompletable
function IsQuestCompletable()
end

--- [https://wow.gamepedia.com/wiki/API_IsQuestIDValidSpellTarget?action=edit&amp;redlink=1]
--- @return void
function IsQuestIDValidSpellTarget()
end

--- [https://wow.gamepedia.com/wiki/API_IsQuestItemHidden?action=edit&amp;redlink=1]
--- @return void
function IsQuestItemHidden()
end

--- [https://wow.gamepedia.com/wiki/API_IsQuestLogSpecialItemInRange?action=edit&amp;redlink=1]
--- @return void
function IsQuestLogSpecialItemInRange()
end

--- [https://wow.gamepedia.com/wiki/API_IsQuestSequenced?action=edit&amp;redlink=1]
--- @return void
function IsQuestSequenced()
end

--- [https://wow.gamepedia.com/wiki/API_IsRaidMarkerActive?action=edit&amp;redlink=1]
--- @return void
function IsRaidMarkerActive()
end

--- [https://wow.gamepedia.com/wiki/API_IsRangedWeapon?action=edit&amp;redlink=1]
--- @return void
function IsRangedWeapon()
end

--- [https://wow.gamepedia.com/wiki/API_IsReagentBankUnlocked?action=edit&amp;redlink=1]
--- @return void
function IsReagentBankUnlocked()
end

--- Returns true if a given character name is recognized by the client.
--- [https://wow.gamepedia.com/wiki/API_IsRecognizedName]
...
--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_IsRecruitAFriendLinked]
--- @return boolean @ isRafLinked
function IsRecruitAFriendLinked()
end

--- [https://wow.gamepedia.com/wiki/API_IsReplacingUnit?action=edit&amp;redlink=1]
--- @return void
function IsReplacingUnit()
end

--- Checks to see if Player is resting.
--- [https://wow.gamepedia.com/wiki/API_IsResting]
--- @return boolean @ resting
function IsResting()
end

--- [https://wow.gamepedia.com/wiki/API_IsRestrictedAccount?action=edit&amp;redlink=1]
--- @return void
function IsRestrictedAccount()
end

--- There are three seperate levels of IsModifierKeyDown() type API functions but they all do the same basic function and return true if the specified key is currently pressed down.
--- [https://wow.gamepedia.com/wiki/API_IsRightAltKeyDown]
--- @return void
function IsRightAltKeyDown()
end

--- There are three seperate levels of IsModifierKeyDown() type API functions but they all do the same basic function and return true if the specified key is currently pressed down.
--- [https://wow.gamepedia.com/wiki/API_IsRightControlKeyDown]
--- @return void
function IsRightControlKeyDown()
end

--- [https://wow.gamepedia.com/wiki/API_IsRightMetaKeyDown?action=edit&amp;redlink=1]
--- @return void
function IsRightMetaKeyDown()
end

--- There are three seperate levels of IsModifierKeyDown() type API functions but they all do the same basic function and return true if the specified key is currently pressed down.
--- [https://wow.gamepedia.com/wiki/API_IsRightShiftKeyDown]
--- @return void
function IsRightShiftKeyDown()
end

--- [https://wow.gamepedia.com/wiki/API_IsSelectedSpellBookItem?action=edit&amp;redlink=1]
--- @return void
function IsSelectedSpellBookItem()
end

--- [https://wow.gamepedia.com/wiki/API_IsServerControlledBackfill?action=edit&amp;redlink=1]
--- @return void
function IsServerControlledBackfill()
end

--- There are three seperate levels of IsModifierKeyDown() type API functions but they all do the same basic function and return true if the specified key is currently pressed down.
--- [https://wow.gamepedia.com/wiki/API_IsShiftKeyDown]
--- @return void
function IsShiftKeyDown()
end

--- Returns whether a given spell is specific to a specialization and/or class.
--- [https://wow.gamepedia.com/wiki/API_IsSpellClassOrSpec]
...
--- [https://wow.gamepedia.com/wiki/API_IsSpellInRange]
...
--- [https://wow.gamepedia.com/wiki/API_IsSpellKnown]
...
--- [https://wow.gamepedia.com/wiki/API_IsSpellKnownOrOverridesKnown?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_IsSpellOverlayed]
--- @param spellID number @ the spell ID number
--- @return boolean @ isTrue
function IsSpellOverlayed(spellID)
end

--- [https://wow.gamepedia.com/wiki/API_IsSpellValidForPendingGlyph?action=edit&amp;redlink=1]
--- @return void
function IsSpellValidForPendingGlyph()
end

--- [https://wow.gamepedia.com/wiki/API_IsSplashFramePrimaryFeatureUnlocked?action=edit&amp;redlink=1]
--- @return void
function IsSplashFramePrimaryFeatureUnlocked()
end

--- [https://wow.gamepedia.com/wiki/API_IsStackableAction?action=edit&amp;redlink=1]
--- @return void
function IsStackableAction()
end

--- Indicates whether the player is stealthed.
--- [https://wow.gamepedia.com/wiki/API_IsStealthed]
--- @return boolean @ stealthed
function IsStealthed()
end

--- [https://wow.gamepedia.com/wiki/API_IsStoryQuest?action=edit&amp;redlink=1]
--- @return void
function IsStoryQuest()
end

--- [https://wow.gamepedia.com/wiki/API_IsSubZonePVPPOI?action=edit&amp;redlink=1]
--- @return void
function IsSubZonePVPPOI()
end

--- Returns whether the player character is submerged in water.
--- [https://wow.gamepedia.com/wiki/API_IsSubmerged]
--- @return unknown @ isSubmerged
function IsSubmerged()
end

--- Returns whether the player character is swimming.
--- [https://wow.gamepedia.com/wiki/API_IsSwimming]
--- @return number @ isSwimming
function IsSwimming()
end

--- Indicates whether the given spell is learned from a talent.
--- [https://wow.gamepedia.com/wiki/API_IsTalentSpell]
...
--- [https://wow.gamepedia.com/wiki/API_IsTestBuild?action=edit&amp;redlink=1]
--- @return void
function IsTestBuild()
end

--- Returns whether threat warnings are currently enabled.
--- [https://wow.gamepedia.com/wiki/API_IsThreatWarningEnabled]
--- @return boolean @ enabled
function IsThreatWarningEnabled()
end

--- Returns whether the player can use a title.
--- [https://wow.gamepedia.com/wiki/API_IsTitleKnown]
...
--- [https://wow.gamepedia.com/wiki/API_IsTrialAccount]
--- @return boolean @ isTrialAccount
function IsTrialAccount()
end

--- [https://wow.gamepedia.com/wiki/API_IsTutorialFlagged?action=edit&amp;redlink=1]
--- @return void
function IsTutorialFlagged()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_IsUnitModelReadyForUI]
--- @param unitToken string
...
--- [https://wow.gamepedia.com/wiki/API_IsUsingFixedTimeStep?action=edit&amp;redlink=1]
--- @return void
function IsUsingFixedTimeStep()
end

--- [https://wow.gamepedia.com/wiki/API_IsUsingVehicleControls?action=edit&amp;redlink=1]
--- @return void
function IsUsingVehicleControls()
end

--- [https://wow.gamepedia.com/wiki/API_IsVehicleAimAngleAdjustable?action=edit&amp;redlink=1]
--- @return void
function IsVehicleAimAngleAdjustable()
end

--- [https://wow.gamepedia.com/wiki/API_IsVehicleAimPowerAdjustable?action=edit&amp;redlink=1]
--- @return void
function IsVehicleAimPowerAdjustable()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_IsVeteranTrialAccount]
--- @return boolean @ isVeteranTrialAccount
function IsVeteranTrialAccount()
end

--- [https://wow.gamepedia.com/wiki/API_IsVoidStorageReady?action=edit&amp;redlink=1]
--- @return void
function IsVoidStorageReady()
end

--- Returns whether the player is currently in a War Game.
--- [https://wow.gamepedia.com/wiki/API_IsWargame]
--- @return boolean @ isWargame
function IsWargame()
end

--- Checks to see if client is running on Windows.
--- [https://wow.gamepedia.com/wiki/API_IsWindowsClient]
--- @return void
function IsWindowsClient()
end

--- [https://wow.gamepedia.com/wiki/API_IsXPUserDisabled?action=edit&amp;redlink=1]
--- @return void
function IsXPUserDisabled()
end

--- [https://wow.gamepedia.com/wiki/API_ItemAddedToArtifact?action=edit&amp;redlink=1]
--- @return void
function ItemAddedToArtifact()
end

--- [https://wow.gamepedia.com/wiki/API_ItemCanTargetGarrisonFollowerAbility?action=edit&amp;redlink=1]
--- @return void
function ItemCanTargetGarrisonFollowerAbility()
end

--- [https://wow.gamepedia.com/wiki/API_ItemHasRange?action=edit&amp;redlink=1]
--- @return void
function ItemHasRange()
end

--- Get the creator of an item text.
--- [https://wow.gamepedia.com/wiki/API_ItemTextGetCreator]
--- @return string @ creatorName
function ItemTextGetCreator()
end

--- Get the name of the current item text.
--- [https://wow.gamepedia.com/wiki/API_ItemTextGetItem]
--- @return string @ textName
function ItemTextGetItem()
end

--- Get the material which an item text is written on.
--- [https://wow.gamepedia.com/wiki/API_ItemTextGetMaterial]
--- @return string @ materialName
function ItemTextGetMaterial()
end

--- Get the number of the current item text page.
--- [https://wow.gamepedia.com/wiki/API_ItemTextGetPage]
--- @return number @ pageNum
function ItemTextGetPage()
end

--- Get the page contents of the current item text.
--- [https://wow.gamepedia.com/wiki/API_ItemTextGetText]
--- @return string @ pageBody
function ItemTextGetText()
end

--- Determine if there is a page after the current page.
--- [https://wow.gamepedia.com/wiki/API_ItemTextHasNextPage]
--- @return number @ hasNext
function ItemTextHasNextPage()
end

--- [https://wow.gamepedia.com/wiki/API_ItemTextIsFullPage?action=edit&amp;redlink=1]
--- @return void
function ItemTextIsFullPage()
end

--- Request the next page of an Item Text
--- [https://wow.gamepedia.com/wiki/API_ItemTextNextPage]
--- @return void
function ItemTextNextPage()
end

--- Request the previous page of an Item Text.
--- [https://wow.gamepedia.com/wiki/API_ItemTextPrevPage]
--- @return void
function ItemTextPrevPage()
end

--- [https://wow.gamepedia.com/wiki/API_JoinArena?action=edit&amp;redlink=1]
--- @return void
function JoinArena()
end

--- Queues the player, or the player's group, for a battlefield instance.
--- [https://wow.gamepedia.com/wiki/API_JoinBattlefield]
...
--- [https://wow.gamepedia.com/wiki/API_JoinChannelByName]
...
--- [https://wow.gamepedia.com/wiki/API_JoinLFG?action=edit&amp;redlink=1]
--- @return void
function JoinLFG()
end

--- Seems to have the same effect as API_JoinChannelByName.
--- [https://wow.gamepedia.com/wiki/API_JoinPermanentChannel]
...
--- [https://wow.gamepedia.com/wiki/API_JoinRatedBattlefield?action=edit&amp;redlink=1]
--- @return void
function JoinRatedBattlefield()
end

--- [https://wow.gamepedia.com/wiki/API_JoinSingleLFG?action=edit&amp;redlink=1]
--- @return void
function JoinSingleLFG()
end

--- Queue for a arena either solo or as a group.
--- [https://wow.gamepedia.com/wiki/API_JoinSkirmish]
...
--- [https://wow.gamepedia.com/wiki/API_JoinTemporaryChannel]
--- @param channelName string @ The name of the channel to join
--- @param password string @ optional) - The channel password, nil if none.
--- @param frameID number @ optional) - The chat frame ID number to add the channel to. Use Frame:GetID() to retrieve it for chat frame objects.
--- @param hasVoice boolean @ nil) - Enable voice chat for this channel.
...
--- [https://wow.gamepedia.com/wiki/API_JumpOrAscendStart]
--- @return void
function JumpOrAscendStart()
end

--- Starts the article load process.
--- [https://wow.gamepedia.com/wiki/API_KBArticle_BeginLoading]
...
--- [https://wow.gamepedia.com/wiki/API_KBArticle_GetData]
...
--- [https://wow.gamepedia.com/wiki/API_KBArticle_IsLoaded]
--- @return boolean @ loaded
function KBArticle_IsLoaded()
end

--- [https://wow.gamepedia.com/wiki/API_KBQuery_BeginLoading?action=edit&amp;redlink=1]
--- @return void
function KBQuery_BeginLoading()
end

--- [https://wow.gamepedia.com/wiki/API_KBQuery_GetArticleHeaderCount?action=edit&amp;redlink=1]
--- @return void
function KBQuery_GetArticleHeaderCount()
end

--- [https://wow.gamepedia.com/wiki/API_KBQuery_GetArticleHeaderData?action=edit&amp;redlink=1]
--- @return void
function KBQuery_GetArticleHeaderData()
end

--- [https://wow.gamepedia.com/wiki/API_KBQuery_GetTotalArticleCount?action=edit&amp;redlink=1]
--- @return void
function KBQuery_GetTotalArticleCount()
end

--- [https://wow.gamepedia.com/wiki/API_KBQuery_IsLoaded?action=edit&amp;redlink=1]
--- @return void
function KBQuery_IsLoaded()
end

--- Starts the loading of articles.
--- [https://wow.gamepedia.com/wiki/API_KBSetup_BeginLoading]
...
--- [https://wow.gamepedia.com/wiki/API_KBSetup_GetArticleHeaderCount]
--- @return number @ count
function KBSetup_GetArticleHeaderCount()
end

--- Returns header information about an article.
--- [https://wow.gamepedia.com/wiki/API_KBSetup_GetArticleHeaderData]
...
--- [https://wow.gamepedia.com/wiki/API_KBSetup_GetCategoryCount]
--- @return number @ count
function KBSetup_GetCategoryCount()
end

--- Returns information about a category.
--- [https://wow.gamepedia.com/wiki/API_KBSetup_GetCategoryData]
...
--- [https://wow.gamepedia.com/wiki/API_KBSetup_GetLanguageCount]
--- @return number @ count
function KBSetup_GetLanguageCount()
end

--- Returns information about a language.
--- [https://wow.gamepedia.com/wiki/API_KBSetup_GetLanguageData]
...
--- [https://wow.gamepedia.com/wiki/API_KBSetup_GetSubCategoryCount]
...
--- [https://wow.gamepedia.com/wiki/API_KBSetup_GetSubCategoryData]
...
--- [https://wow.gamepedia.com/wiki/API_KBSetup_GetTotalArticleCount]
--- @return number @ count
function KBSetup_GetTotalArticleCount()
end

--- Determine if the article list is loaded.
--- [https://wow.gamepedia.com/wiki/API_KBSetup_IsLoaded]
--- @return boolean @ loaded
function KBSetup_IsLoaded()
end

--- Returns the server message of the day.
--- [https://wow.gamepedia.com/wiki/API_KBSystem_GetMOTD]
--- @return string @ motd
function KBSystem_GetMOTD()
end

--- Returns the current server notice.
--- [https://wow.gamepedia.com/wiki/API_KBSystem_GetServerNotice]
--- @return string @ notice
function KBSystem_GetServerNotice()
end

--- Returns the current server status.
--- [https://wow.gamepedia.com/wiki/API_KBSystem_GetServerStatus]
--- @return string @ status
function KBSystem_GetServerStatus()
end

--- Teleports the player to or from an LFG dungeon.
--- [https://wow.gamepedia.com/wiki/API_LFGTeleport]
...
--- [https://wow.gamepedia.com/wiki/API_LearnPvpTalent]
...
--- [https://wow.gamepedia.com/wiki/API_LearnPvpTalents?action=edit&amp;redlink=1]
--- @return void
function LearnPvpTalents()
end

--- Learns the name of a specified talent in a specified tab.
--- [https://wow.gamepedia.com/wiki/API_LearnTalent]
--- @param talentID string @ Talent ID
--- @return void
function LearnTalent(talentID)
end

--- [https://wow.gamepedia.com/wiki/API_LearnTalents?action=edit&amp;redlink=1]
--- @return void
function LearnTalents()
end

--- Leaves the current battlefield
--- [https://wow.gamepedia.com/wiki/API_LeaveBattlefield]
--- @return void
function LeaveBattlefield()
end

--- [https://wow.gamepedia.com/wiki/API_LeaveChannelByLocalID?action=edit&amp;redlink=1]
--- @return void
function LeaveChannelByLocalID()
end

--- Leaves the channel with the specified name.
--- [https://wow.gamepedia.com/wiki/API_LeaveChannelByName]
--- @param channelName string @ The name of the channel to leave
--- @return void
function LeaveChannelByName(channelName)
end

--- [https://wow.gamepedia.com/wiki/API_LeaveLFG?action=edit&amp;redlink=1]
--- @return void
function LeaveLFG()
end

--- [https://wow.gamepedia.com/wiki/API_LeaveSingleLFG?action=edit&amp;redlink=1]
--- @return void
function LeaveSingleLFG()
end

--- Lists members in the given channel to the chat window.
--- [https://wow.gamepedia.com/wiki/API_ListChannelByName]
...
--- [https://wow.gamepedia.com/wiki/API_ListChannels]
--- @return void
function ListChannels()
end

--- Request the loading of an On-Demand AddOn.
--- [https://wow.gamepedia.com/wiki/API_LoadAddOn]
--- @param index_or_name unknown
...
--- [https://wow.gamepedia.com/wiki/API_LoadBindings]
...
--- [https://wow.gamepedia.com/wiki/API_LoadURLIndex?action=edit&amp;redlink=1]
--- @return void
function LoadURLIndex()
end

--- [https://wow.gamepedia.com/wiki/API_LoggingChat]
--- @param newState boolean @ toggles chat logging
--- @return boolean @ isLogging
function LoggingChat(newState)
end

--- [https://wow.gamepedia.com/wiki/API_LoggingCombat]
...
--- [https://wow.gamepedia.com/wiki/API_Logout]
--- @return void
function Logout()
end

--- [https://wow.gamepedia.com/wiki/API_LootMoneyNotify?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_LootSlot]
...
--- [https://wow.gamepedia.com/wiki/API_LootSlotHasItem]
...
--- [https://wow.gamepedia.com/wiki/API_MouseOverrideCinematicDisable?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_MouselookStart]
--- @return void
function MouselookStart()
end

--- Exits mouse look mode; allows mouse input to move the mouse cursor.
--- [https://wow.gamepedia.com/wiki/API_MouselookStop]
--- @return void
function MouselookStop()
end

--- [https://wow.gamepedia.com/wiki/API_MoveAndSteerStart?action=edit&amp;redlink=1]
--- @return void
function MoveAndSteerStart()
end

--- [https://wow.gamepedia.com/wiki/API_MoveAndSteerStop?action=edit&amp;redlink=1]
--- @return void
function MoveAndSteerStop()
end

--- The player begins moving backward at the specified time.
--- [https://wow.gamepedia.com/wiki/API_MoveBackwardStart]
...
--- [https://wow.gamepedia.com/wiki/API_MoveBackwardStop]
...
--- [https://wow.gamepedia.com/wiki/API_MoveForwardStart]
...
--- [https://wow.gamepedia.com/wiki/API_MoveForwardStop]
--- @param startTime unknown
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_MoveViewDownStart]
...
--- [https://wow.gamepedia.com/wiki/API_MoveViewDownStop]
--- @return void
function MoveViewDownStop()
end

--- Begins zooming the camera in.
--- [https://wow.gamepedia.com/wiki/API_MoveViewInStart]
...
--- [https://wow.gamepedia.com/wiki/API_MoveViewInStop]
--- @return void
function MoveViewInStop()
end

--- Begins rotating the camera to the left around your character.
--- [https://wow.gamepedia.com/wiki/API_MoveViewLeftStart]
--- @param speed number @ Speed at which to begin rotating.
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_MoveViewLeftStop]
--- @return void
function MoveViewLeftStop()
end

--- Begins zooming the camera out.
--- [https://wow.gamepedia.com/wiki/API_MoveViewOutStart]
--- @param speed number @ Speed at which to begin zooming.
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_MoveViewOutStop]
--- @return void
function MoveViewOutStop()
end

--- Begins rotating the camera to the right around your character.
--- [https://wow.gamepedia.com/wiki/API_MoveViewRightStart]
--- @param speed number @ Speed at which to begin rotating.
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_MoveViewRightStop]
--- @return void
function MoveViewRightStop()
end

--- Begins rotating the camera up around your character.
--- [https://wow.gamepedia.com/wiki/API_MoveViewUpStart]
--- @param speed number @ Speed at which to begin rotating.
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_MoveViewUpStop]
--- @return void
function MoveViewUpStop()
end

--- [https://wow.gamepedia.com/wiki/API_MultiSampleAntiAliasingSupported?action=edit&amp;redlink=1]
--- @return void
function MultiSampleAntiAliasingSupported()
end

--- Mutes a sound file.
--- [https://wow.gamepedia.com/wiki/API_MuteSoundFile]
...
--- [https://wow.gamepedia.com/wiki/API_NeutralPlayerSelectFaction]
--- @param factionIndex number @ to choose the Horde, 2 to choose the Alliance.
--- @return void
function NeutralPlayerSelectFaction(factionIndex)
end

--- [https://wow.gamepedia.com/wiki/API_NextView?action=edit&amp;redlink=1]
--- @return void
function NextView()
end
...
--- [https://wow.gamepedia.com/wiki/API_NoPlayTime]
--- @return number @ isUnhealthy
function NoPlayTime()
end

--- Generates an error message saying you cannot do that while dead.
--- [https://wow.gamepedia.com/wiki/API_NotWhileDeadError]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_NotifyInspect]
...
--- [https://wow.gamepedia.com/wiki/API_NumTaxiNodes]
--- @return number @ numNodes
function NumTaxiNodes()
end

--- [https://wow.gamepedia.com/wiki/API_OfferPetition]
--- @return void
function OfferPetition()
end

--- [https://wow.gamepedia.com/wiki/API_OpenTrainer?action=edit&amp;redlink=1]
--- @return void
function OpenTrainer()
end

--- [https://wow.gamepedia.com/wiki/API_OpeningCinematic?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_PartialPlayTime]
--- @return void
function PartialPlayTime()
end

--- [https://wow.gamepedia.com/wiki/API_PartyLFGStartBackfill?action=edit&amp;redlink=1]
--- @return void
function PartyLFGStartBackfill()
end

--- Permanently abandons your pet.
--- [https://wow.gamepedia.com/wiki/API_PetAbandon]
--- @return void
function PetAbandon()
end

--- Switches your pet to aggressive mode; does nothing.
--- [https://wow.gamepedia.com/wiki/API_PetAggressiveMode]
--- @return void
function PetAggressiveMode()
end

--- Switches pet to Assist mode.
--- [https://wow.gamepedia.com/wiki/API_PetAssistMode]
--- @return void
function PetAssistMode()
end

--- Instruct your pet to attack your target.
--- [https://wow.gamepedia.com/wiki/API_PetAttack]
--- @return void
function PetAttack()
end

--- Retuns true if the pet is abandonable.
--- [https://wow.gamepedia.com/wiki/API_PetCanBeAbandoned]
--- @return boolean @ canAbandon
function PetCanBeAbandoned()
end

--- [https://wow.gamepedia.com/wiki/API_PetCanBeDismissed?action=edit&amp;redlink=1]
--- @return void
function PetCanBeDismissed()
end

--- Retuns true if the pet can be renamed.
--- [https://wow.gamepedia.com/wiki/API_PetCanBeRenamed]
--- @return boolean @ canRename
function PetCanBeRenamed()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_PetDefensiveAssistMode]
--- @return void
function PetDefensiveAssistMode()
end

--- Set your pet in defensive mode.
--- [https://wow.gamepedia.com/wiki/API_PetDefensiveMode]
--- @return void
function PetDefensiveMode()
end

--- Dismiss your pet.
--- [https://wow.gamepedia.com/wiki/API_PetDismiss]
--- @return void
function PetDismiss()
end

--- Instruct your pet to follow you.
--- [https://wow.gamepedia.com/wiki/API_PetFollow]
--- @return void
function PetFollow()
end

--- Determine if player has a pet with an action bar.
--- [https://wow.gamepedia.com/wiki/API_PetHasActionBar]
--- @return number @ hasActionBar
function PetHasActionBar()
end

--- [https://wow.gamepedia.com/wiki/API_PetHasSpellbook?action=edit&amp;redlink=1]
--- @return void
function PetHasSpellbook()
end

--- [https://wow.gamepedia.com/wiki/API_PetMoveTo?action=edit&amp;redlink=1]
--- @return void
function PetMoveTo()
end

--- Set your pet into passive mode.
--- [https://wow.gamepedia.com/wiki/API_PetPassiveMode]
--- @return void
function PetPassiveMode()
end

--- [https://wow.gamepedia.com/wiki/API_PetRename]
...
--- [https://wow.gamepedia.com/wiki/API_PetStopAttack]
--- @return void
function PetStopAttack()
end

--- [https://wow.gamepedia.com/wiki/API_PetUsesPetFrame?action=edit&amp;redlink=1]
--- @return void
function PetUsesPetFrame()
end

--- Instruct your pet to remain still.
--- [https://wow.gamepedia.com/wiki/API_PetWait]
--- @return void
function PetWait()
end

--- Pick up an action for drag-and-drop.
--- [https://wow.gamepedia.com/wiki/API_PickupAction]
...
--- [https://wow.gamepedia.com/wiki/API_PickupBagFromSlot]
...
--- [https://wow.gamepedia.com/wiki/API_PickupCompanion]
...
--- [https://wow.gamepedia.com/wiki/API_PickupContainerItem]
...
--- [https://wow.gamepedia.com/wiki/API_PickupGuildBankItem?action=edit&amp;redlink=1]
--- @return void
function PickupGuildBankItem()
end

--- [https://wow.gamepedia.com/wiki/API_PickupGuildBankMoney?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_PickupInventoryItem]
...
--- [https://wow.gamepedia.com/wiki/API_PickupItem]
--- @param itemID_or_itemString_or_itemName_or_itemLink unknown
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_PickupMacro]
...
--- [https://wow.gamepedia.com/wiki/API_PickupMerchantItem]
--- @param index number @ The index of the item in the merchant's inventory.
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_PickupPetAction]
...
--- [https://wow.gamepedia.com/wiki/API_PickupPetSpell]
--- @param spellID number
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_PickupSpellBookItem]
--- @param spellName_or_index unknown
...
--- [https://wow.gamepedia.com/wiki/API_PickupStablePet]
--- @param index unknown
--- @return void
function PickupStablePet(index)
end

--- [https://wow.gamepedia.com/wiki/API_PickupTalent?action=edit&amp;redlink=1]
--- @return void
function PickupTalent()
end

--- Picks up an amount of money from the player's trading offer, placing it on the cursor.
--- [https://wow.gamepedia.com/wiki/API_PickupTradeMoney]
--- @param copper number @ amount of money, in copper, to pick up.
--- @return void
function PickupTradeMoney(copper)
end

--- [https://wow.gamepedia.com/wiki/API_PitchDownStart?action=edit&amp;redlink=1]
--- @return void
function PitchDownStart()
end

--- [https://wow.gamepedia.com/wiki/API_PitchDownStop?action=edit&amp;redlink=1]
--- @return void
function PitchDownStop()
end

--- [https://wow.gamepedia.com/wiki/API_PitchUpStart?action=edit&amp;redlink=1]
--- @return void
function PitchUpStart()
end

--- [https://wow.gamepedia.com/wiki/API_PitchUpStop?action=edit&amp;redlink=1]
--- @return void
function PitchUpStop()
end

--- Place the drag-and-drop item as an action.
--- [https://wow.gamepedia.com/wiki/API_PlaceAction]
--- @param actionSlot number @ The action slot to place the action into.
--- @return void
function PlaceAction(actionSlot)
end

--- [https://wow.gamepedia.com/wiki/API_PlaceRaidMarker?action=edit&amp;redlink=1]
--- @return void
function PlaceRaidMarker()
end

--- [https://wow.gamepedia.com/wiki/API_PlayAutoAcceptQuestSound?action=edit&amp;redlink=1]
--- @return void
function PlayAutoAcceptQuestSound()
end

--- Plays the specified sound file on loop to the Music sound channel.
--- [https://wow.gamepedia.com/wiki/API_PlayMusic]
...
--- [https://wow.gamepedia.com/wiki/API_PlaySound]
...
--- [https://wow.gamepedia.com/wiki/API_PlaySoundFile]
...
--- [https://wow.gamepedia.com/wiki/API_PlayVocalErrorSoundID?action=edit&amp;redlink=1]
--- @return void
function PlayVocalErrorSoundID()
end

--- [https://wow.gamepedia.com/wiki/API_PlayerCanTeleport?action=edit&amp;redlink=1]
--- @return void
function PlayerCanTeleport()
end

--- [https://wow.gamepedia.com/wiki/API_PlayerEffectiveAttackPower?action=edit&amp;redlink=1]
--- @return void
function PlayerEffectiveAttackPower()
end

--- [https://wow.gamepedia.com/wiki/API_PlayerHasHearthstone?action=edit&amp;redlink=1]
--- @return void
function PlayerHasHearthstone()
end

--- Determines if player has a specific toy in their toybox
--- [https://wow.gamepedia.com/wiki/API_PlayerHasToy]
--- @param itemId number @ itemId of a toy.
--- @return unknown @ hasToy
function PlayerHasToy(itemId)
end

--- [https://wow.gamepedia.com/wiki/API_PlayerIsPVPInactive?action=edit&amp;redlink=1]
--- @return void
function PlayerIsPVPInactive()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_PlayerVehicleHasComboPoints]
...
--- [https://wow.gamepedia.com/wiki/API_PortGraveyard]
--- @return void
function PortGraveyard()
end

--- [https://wow.gamepedia.com/wiki/API_PreloadMovie?action=edit&amp;redlink=1]
--- @return void
function PreloadMovie()
end

--- [https://wow.gamepedia.com/wiki/API_PrevView?action=edit&amp;redlink=1]
--- @return void
function PrevView()
end

--- [https://wow.gamepedia.com/wiki/API_ProcessExceptionClient?action=edit&amp;redlink=1]
--- @return void
function ProcessExceptionClient()
end

--- [https://wow.gamepedia.com/wiki/API_ProcessQuestLogRewardFactions?action=edit&amp;redlink=1]
--- @return void
function ProcessQuestLogRewardFactions()
end

--- [https://wow.gamepedia.com/wiki/API_PromoteToAssistant?action=edit&amp;redlink=1]
--- @return void
function PromoteToAssistant()
end

--- [https://wow.gamepedia.com/wiki/API_PromoteToLeader]
--- @param unitId_or_playerName unknown
--- @return void
function PromoteToLeader(unitId_or_playerName)
end

--- [https://wow.gamepedia.com/wiki/API_PurchaseSlot?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_PutItemInBackpack]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_PutItemInBag]
...
--- [https://wow.gamepedia.com/wiki/API_QueryGuildBankLog?action=edit&amp;redlink=1]
--- @return void
function QueryGuildBankLog()
end

--- [https://wow.gamepedia.com/wiki/API_QueryGuildBankTab?action=edit&amp;redlink=1]
--- @return void
function QueryGuildBankTab()
end

--- [https://wow.gamepedia.com/wiki/API_QueryGuildBankText?action=edit&amp;redlink=1]
--- @return void
function QueryGuildBankText()
end

--- [https://wow.gamepedia.com/wiki/API_QueryGuildEventLog?action=edit&amp;redlink=1]
--- @return void
function QueryGuildEventLog()
end

--- [https://wow.gamepedia.com/wiki/API_QueryGuildMembersForRecipe?action=edit&amp;redlink=1]
--- @return void
function QueryGuildMembersForRecipe()
end

--- [https://wow.gamepedia.com/wiki/API_QueryGuildNews?action=edit&amp;redlink=1]
--- @return void
function QueryGuildNews()
end

--- [https://wow.gamepedia.com/wiki/API_QueryGuildRecipes?action=edit&amp;redlink=1]
--- @return void
function QueryGuildRecipes()
end

--- Throws an error when the choose reward method doesn't work.
--- [https://wow.gamepedia.com/wiki/API_QuestChooseRewardError]
--- @return void
function QuestChooseRewardError()
end

--- [https://wow.gamepedia.com/wiki/API_QuestFlagsPVP?action=edit&amp;redlink=1]
--- @return void
function QuestFlagsPVP()
end

--- Returns whether the last-offered quest was automatically accepted.
--- [https://wow.gamepedia.com/wiki/API_QuestGetAutoAccept]
--- @return unknown @ isAutoAccepted
function QuestGetAutoAccept()
end

--- [https://wow.gamepedia.com/wiki/API_QuestGetAutoLaunched?action=edit&amp;redlink=1]
--- @return void
function QuestGetAutoLaunched()
end

--- [https://wow.gamepedia.com/wiki/API_QuestHasPOIInfo?action=edit&amp;redlink=1]
--- @return void
function QuestHasPOIInfo()
end

--- Returns whether the currently offered quest is a daily quest.
--- [https://wow.gamepedia.com/wiki/API_QuestIsDaily]
--- @return number @ isDaily
function QuestIsDaily()
end

--- [https://wow.gamepedia.com/wiki/API_QuestIsFromAdventureMap?action=edit&amp;redlink=1]
--- @return void
function QuestIsFromAdventureMap()
end

--- [https://wow.gamepedia.com/wiki/API_QuestIsFromAreaTrigger?action=edit&amp;redlink=1]
--- @return void
function QuestIsFromAreaTrigger()
end

--- Returns whether the currently offered quest is a weekly quest.
--- [https://wow.gamepedia.com/wiki/API_QuestIsWeekly]
...
--- [https://wow.gamepedia.com/wiki/API_QuestLogPushQuest]
--- @return void
function QuestLogPushQuest()
end

--- [https://wow.gamepedia.com/wiki/API_QuestLogRewardHasTreasurePicker?action=edit&amp;redlink=1]
--- @return void
function QuestLogRewardHasTreasurePicker()
end

--- [https://wow.gamepedia.com/wiki/API_QuestLogShouldShowPortrait?action=edit&amp;redlink=1]
--- @return void
function QuestLogShouldShowPortrait()
end

--- [https://wow.gamepedia.com/wiki/API_QuestMapUpdateAllQuests?action=edit&amp;redlink=1]
--- @return void
function QuestMapUpdateAllQuests()
end

--- Returns WorldMap POI icon information for the given quest.
--- [https://wow.gamepedia.com/wiki/API_QuestPOIGetIconInfo]
...
--- [https://wow.gamepedia.com/wiki/API_QuestPOIGetSecondaryLocations?action=edit&amp;redlink=1]
--- @return void
function QuestPOIGetSecondaryLocations()
end

--- [https://wow.gamepedia.com/wiki/API_QuestPOIUpdateIcons?action=edit&amp;redlink=1]
--- @return void
function QuestPOIUpdateIcons()
end

--- Quits the game.
--- [https://wow.gamepedia.com/wiki/API_Quit]
--- @return void
function Quit()
end

--- [https://wow.gamepedia.com/wiki/API_RaidProfileExists?action=edit&amp;redlink=1]
--- @return void
function RaidProfileExists()
end

--- [https://wow.gamepedia.com/wiki/API_RaidProfileHasUnsavedChanges?action=edit&amp;redlink=1]
--- @return void
function RaidProfileHasUnsavedChanges()
end

--- Performs a random roll between two numbers.
--- [https://wow.gamepedia.com/wiki/API_RandomRoll]
...
--- [https://wow.gamepedia.com/wiki/API_ReagentBankButtonIDToInvSlotID?action=edit&amp;redlink=1]
--- @return void
function ReagentBankButtonIDToInvSlotID()
end

--- [https://wow.gamepedia.com/wiki/API_RedockChatWindows?action=edit&amp;redlink=1]
--- @return void
function RedockChatWindows()
end

--- [https://wow.gamepedia.com/wiki/API_RefreshLFGList?action=edit&amp;redlink=1]
--- @return void
function RefreshLFGList()
end

--- [https://wow.gamepedia.com/wiki/API_RegisterStaticConstants?action=edit&amp;redlink=1]
--- @return void
function RegisterStaticConstants()
end

--- Rejects an Dungeon Finder group invitation and leaves the queue.
--- [https://wow.gamepedia.com/wiki/API_RejectProposal]
--- @return void
function RejectProposal()
end

--- [https://wow.gamepedia.com/wiki/API_RemoveAutoQuestPopUp?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_RemoveChatWindowChannel]
...
--- [https://wow.gamepedia.com/wiki/API_RemoveChatWindowMessages]
--- @param index number @ chat window index, ascending from 1.
...
--- [https://wow.gamepedia.com/wiki/API_RemoveItemFromArtifact]
--- @return boolean @ keystoneRemoved
function RemoveItemFromArtifact()
end

--- [https://wow.gamepedia.com/wiki/API_RemovePvpTalent?action=edit&amp;redlink=1]
--- @return void
function RemovePvpTalent()
end

--- [https://wow.gamepedia.com/wiki/API_RemoveTalent?action=edit&amp;redlink=1]
--- @return void
function RemoveTalent()
end

--- Un-marks an achievement for tracking in the WatchFrame.
--- [https://wow.gamepedia.com/wiki/API_RemoveTrackedAchievement]
--- @param achievementId number @ ID of the achievement to add to tracking.
--- @return void
function RemoveTrackedAchievement(achievementId)
end

--- [https://wow.gamepedia.com/wiki/API_RenamePetition]
--- @param name string @ The new name of the group being created by the petition
--- @return void
function RenamePetition(name)
end

--- [https://wow.gamepedia.com/wiki/API_ReopenInteraction?action=edit&amp;redlink=1]
--- @return void
function ReopenInteraction()
end

--- Repairs all equipped and inventory items.
--- [https://wow.gamepedia.com/wiki/API_RepairAllItems]
...
--- [https://wow.gamepedia.com/wiki/API_ReplaceEnchant]
--- @return void
function ReplaceEnchant()
end

--- Impeaches the current Guild Master.
--- [https://wow.gamepedia.com/wiki/API_ReplaceGuildMaster]
--- @return void
function ReplaceGuildMaster()
end

--- Confirms that an enchant applied to the trade frame should replace an existing enchant.
--- [https://wow.gamepedia.com/wiki/API_ReplaceTradeEnchant]
--- @return void
function ReplaceTradeEnchant()
end

--- Releases your ghost to the graveyard.
--- [https://wow.gamepedia.com/wiki/API_RepopMe]
--- @return void
function RepopMe()
end

--- [https://wow.gamepedia.com/wiki/API_ReportBug?action=edit&amp;redlink=1]
--- @return void
function ReportBug()
end

--- [https://wow.gamepedia.com/wiki/API_ReportPlayerIsPVPAFK?action=edit&amp;redlink=1]
--- @return void
function ReportPlayerIsPVPAFK()
end

--- [https://wow.gamepedia.com/wiki/API_ReportSuggestion?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_RequestBottomLeftActionBar?action=edit&amp;redlink=1]
--- @return void
function RequestBottomLeftActionBar()
end

--- Requests information about guild applicants received trough the Guild Finder.
--- [https://wow.gamepedia.com/wiki/API_RequestGuildApplicantsList]
--- @return void
function RequestGuildApplicantsList()
end

--- [https://wow.gamepedia.com/wiki/API_RequestGuildChallengeInfo?action=edit&amp;redlink=1]
--- @return void
function RequestGuildChallengeInfo()
end

--- [https://wow.gamepedia.com/wiki/API_RequestGuildMembership?action=edit&amp;redlink=1]
--- @return void
function RequestGuildMembership()
end

--- [https://wow.gamepedia.com/wiki/API_RequestGuildMembershipList?action=edit&amp;redlink=1]
--- @return void
function RequestGuildMembershipList()
end

--- [https://wow.gamepedia.com/wiki/API_RequestGuildPartyState?action=edit&amp;redlink=1]
--- @return void
function RequestGuildPartyState()
end

--- [https://wow.gamepedia.com/wiki/API_RequestGuildRecruitmentSettings?action=edit&amp;redlink=1]
--- @return void
function RequestGuildRecruitmentSettings()
end

--- [https://wow.gamepedia.com/wiki/API_RequestGuildRewards?action=edit&amp;redlink=1]
--- @return void
function RequestGuildRewards()
end

--- [https://wow.gamepedia.com/wiki/API_RequestLFDPartyLockInfo?action=edit&amp;redlink=1]
--- @return void
function RequestLFDPartyLockInfo()
end

--- [https://wow.gamepedia.com/wiki/API_RequestLFDPlayerLockInfo?action=edit&amp;redlink=1]
--- @return void
function RequestLFDPlayerLockInfo()
end

--- [https://wow.gamepedia.com/wiki/API_RequestPVPOptionsEnabled?action=edit&amp;redlink=1]
--- @return void
function RequestPVPOptionsEnabled()
end

--- [https://wow.gamepedia.com/wiki/API_RequestPVPRewards?action=edit&amp;redlink=1]
--- @return void
function RequestPVPRewards()
end

--- Sends a request to the server to send back information about the instance.
--- [https://wow.gamepedia.com/wiki/API_RequestRaidInfo]
--- @return void
function RequestRaidInfo()
end

--- Requests information about battleground rewards.
--- [https://wow.gamepedia.com/wiki/API_RequestRandomBattlegroundInstanceInfo]
--- @return void
function RequestRandomBattlegroundInstanceInfo()
end

--- Requests information about the player's rated PvP stats from the server.
--- [https://wow.gamepedia.com/wiki/API_RequestRatedInfo]
--- @return void
function RequestRatedInfo()
end

--- [https://wow.gamepedia.com/wiki/API_RequestRecruitingGuildsList?action=edit&amp;redlink=1]
--- @return void
function RequestRecruitingGuildsList()
end

--- Send a request to the server to get an update of the time played.
--- [https://wow.gamepedia.com/wiki/API_RequestTimePlayed]
--- @return void
function RequestTimePlayed()
end

--- [https://wow.gamepedia.com/wiki/API_RequeueSkirmish?action=edit&amp;redlink=1]
--- @return void
function RequeueSkirmish()
end

--- [https://wow.gamepedia.com/wiki/API_ResetAddOns?action=edit&amp;redlink=1]
--- @return void
function ResetAddOns()
end

--- [https://wow.gamepedia.com/wiki/API_ResetCPUUsage?action=edit&amp;redlink=1]
--- @return void
function ResetCPUUsage()
end

--- [https://wow.gamepedia.com/wiki/API_ResetChatColors?action=edit&amp;redlink=1]
--- @return void
function ResetChatColors()
end

--- [https://wow.gamepedia.com/wiki/API_ResetChatWindows?action=edit&amp;redlink=1]
--- @return void
function ResetChatWindows()
end

--- Resets mouse cursor.
--- [https://wow.gamepedia.com/wiki/API_ResetCursor]
--- @return void
function ResetCursor()
end

--- [https://wow.gamepedia.com/wiki/API_ResetDisabledAddOns?action=edit&amp;redlink=1]
--- @return void
function ResetDisabledAddOns()
end

--- Resets all instances the currently playing character is associated with.
--- [https://wow.gamepedia.com/wiki/API_ResetInstances]
--- @return void
function ResetInstances()
end

--- [https://wow.gamepedia.com/wiki/API_ResetSetMerchantFilter?action=edit&amp;redlink=1]
--- @return void
function ResetSetMerchantFilter()
end

--- Starts with the first tutorial again
--- [https://wow.gamepedia.com/wiki/API_ResetTutorials]
--- @return void
function ResetTutorials()
end

--- [https://wow.gamepedia.com/wiki/API_ResetView?action=edit&amp;redlink=1]
--- @return void
function ResetView()
end

--- [https://wow.gamepedia.com/wiki/API_ResistancePercent?action=edit&amp;redlink=1]
--- @return void
function ResistancePercent()
end

--- [https://wow.gamepedia.com/wiki/API_RespondInstanceLock?action=edit&amp;redlink=1]
--- @return void
function RespondInstanceLock()
end

--- [https://wow.gamepedia.com/wiki/API_RespondMailLockSendItem?action=edit&amp;redlink=1]
--- @return void
function RespondMailLockSendItem()
end

--- [https://wow.gamepedia.com/wiki/API_RespondToInviteConfirmation?action=edit&amp;redlink=1]
--- @return void
function RespondToInviteConfirmation()
end

--- Requests the graphics engine to restart.
--- [https://wow.gamepedia.com/wiki/API_RestartGx]
--- @return void
function RestartGx()
end

--- [https://wow.gamepedia.com/wiki/API_RestoreRaidProfileFromCopy?action=edit&amp;redlink=1]
--- @return void
function RestoreRaidProfileFromCopy()
end

--- [https://wow.gamepedia.com/wiki/API_ResurrectGetOfferer?action=edit&amp;redlink=1]
--- @return void
function ResurrectGetOfferer()
end

--- [https://wow.gamepedia.com/wiki/API_ResurrectHasSickness?action=edit&amp;redlink=1]
--- @return void
function ResurrectHasSickness()
end

--- [https://wow.gamepedia.com/wiki/API_ResurrectHasTimer?action=edit&amp;redlink=1]
--- @return void
function ResurrectHasTimer()
end

--- [https://wow.gamepedia.com/wiki/API_RetrieveCorpse]
--- @return void
function RetrieveCorpse()
end

--- [https://wow.gamepedia.com/wiki/API_ReturnInboxItem?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_RollOnLoot]
...
--- [https://wow.gamepedia.com/wiki/API_RunBinding]
...
--- [https://wow.gamepedia.com/wiki/API_RunMacro]
...
--- [https://wow.gamepedia.com/wiki/API_RunMacroText]
...
--- [https://wow.gamepedia.com/wiki/API_RunScript]
--- @param script string @ The code which is to be executed.
--- @return void
function RunScript(script)
end

--- [https://wow.gamepedia.com/wiki/API_SaveAddOns?action=edit&amp;redlink=1]
--- @return void
function SaveAddOns()
end

--- Writes the current in-memory key bindings to disk.
--- [https://wow.gamepedia.com/wiki/API_SaveBindings]
...
--- [https://wow.gamepedia.com/wiki/API_SaveRaidProfileCopy?action=edit&amp;redlink=1]
--- @return void
function SaveRaidProfileCopy()
end

--- [https://wow.gamepedia.com/wiki/API_SaveView]
...
--- [https://wow.gamepedia.com/wiki/API_Screenshot]
--- @return void
function Screenshot()
end

--- [https://wow.gamepedia.com/wiki/API_ScriptsDisallowedForBeta?action=edit&amp;redlink=1]
--- @return void
function ScriptsDisallowedForBeta()
end

--- [https://wow.gamepedia.com/wiki/API_SearchLFGGetEncounterResults?action=edit&amp;redlink=1]
--- @return void
function SearchLFGGetEncounterResults()
end

--- [https://wow.gamepedia.com/wiki/API_SearchLFGGetJoinedID?action=edit&amp;redlink=1]
--- @return void
function SearchLFGGetJoinedID()
end

--- Returns how many players listed in raid browser for selected LFG id.
--- [https://wow.gamepedia.com/wiki/API_SearchLFGGetNumResults]
...
--- [https://wow.gamepedia.com/wiki/API_SearchLFGGetPartyResults]
...
--- [https://wow.gamepedia.com/wiki/API_SearchLFGGetResults]
--- @param index number @ Index of the player to query, ascending from 1 to totalResults return value from SearchLFGGetNumResults.
...
--- [https://wow.gamepedia.com/wiki/API_SearchLFGJoin]
...
--- [https://wow.gamepedia.com/wiki/API_SearchLFGLeave?action=edit&amp;redlink=1]
--- @return void
function SearchLFGLeave()
end

--- [https://wow.gamepedia.com/wiki/API_SearchLFGSort?action=edit&amp;redlink=1]
--- @return void
function SearchLFGSort()
end

--- Evaluates macro options in the string and returns the appropriate sub-string or nil
--- [https://wow.gamepedia.com/wiki/API_SecureCmdOptionParse]
...
--- [https://wow.gamepedia.com/wiki/API_SelectActiveQuest?action=edit&amp;redlink=1]
--- @return void
function SelectActiveQuest()
end

--- [https://wow.gamepedia.com/wiki/API_SelectAvailableQuest?action=edit&amp;redlink=1]
--- @return void
function SelectAvailableQuest()
end

--- [https://wow.gamepedia.com/wiki/API_SelectTrainerService]
...
--- [https://wow.gamepedia.com/wiki/API_SelectedRealmName]
--- @return string @ realmName
function SelectedRealmName()
end

--- [https://wow.gamepedia.com/wiki/API_SellCursorItem?action=edit&amp;redlink=1]
--- @return void
function SellCursorItem()
end

--- Sends a chat message.
--- [https://wow.gamepedia.com/wiki/API_SendChatMessage]
...
--- [https://wow.gamepedia.com/wiki/API_SendMail]
...
--- [https://wow.gamepedia.com/wiki/API_SendPlayerChoiceResponse]
...
--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_SendSubscriptionInterstitialResponse]
...
--- [https://wow.gamepedia.com/wiki/API_SendSystemMessage]
...
--- [https://wow.gamepedia.com/wiki/API_SetAchievementComparisonUnit]
--- @return void
function SetAchievementComparisonUnit()
end

--- Starts a search for achievements containing the specified text.
--- [https://wow.gamepedia.com/wiki/API_SetAchievementSearchString]
...
--- [https://wow.gamepedia.com/wiki/API_SetActionBarToggles]
...
--- [https://wow.gamepedia.com/wiki/API_SetActionUIButton?action=edit&amp;redlink=1]
--- @return void
function SetActionUIButton()
end

--- [https://wow.gamepedia.com/wiki/API_SetAddonVersionCheck?action=edit&amp;redlink=1]
--- @return void
function SetAddonVersionCheck()
end

--- [https://wow.gamepedia.com/wiki/API_SetAllowDangerousScripts?action=edit&amp;redlink=1]
--- @return void
function SetAllowDangerousScripts()
end

--- [https://wow.gamepedia.com/wiki/API_SetAllowLowLevelRaid?action=edit&amp;redlink=1]
--- @return void
function SetAllowLowLevelRaid()
end

--- Sets whether guild invitations should be automatically declined.
--- [https://wow.gamepedia.com/wiki/API_SetAutoDeclineGuildInvites]
...
--- [https://wow.gamepedia.com/wiki/API_SetBackpackAutosortDisabled?action=edit&amp;redlink=1]
--- @return void
function SetBackpackAutosortDisabled()
end

--- [https://wow.gamepedia.com/wiki/API_SetBagPortraitTexture?action=edit&amp;redlink=1]
--- @return void
function SetBagPortraitTexture()
end

--- [https://wow.gamepedia.com/wiki/API_SetBagSlotFlag?action=edit&amp;redlink=1]
--- @return void
function SetBagSlotFlag()
end

--- [https://wow.gamepedia.com/wiki/API_SetBankAutosortDisabled?action=edit&amp;redlink=1]
--- @return void
function SetBankAutosortDisabled()
end

--- [https://wow.gamepedia.com/wiki/API_SetBankBagSlotFlag?action=edit&amp;redlink=1]
--- @return void
function SetBankBagSlotFlag()
end

--- [https://wow.gamepedia.com/wiki/API_SetBarSlotFromIntro?action=edit&amp;redlink=1]
--- @return void
function SetBarSlotFromIntro()
end

--- [https://wow.gamepedia.com/wiki/API_SetBarberShopAlternateFormFrame?action=edit&amp;redlink=1]
--- @return void
function SetBarberShopAlternateFormFrame()
end

--- Set the faction to show on the battlefield scoreboard
--- [https://wow.gamepedia.com/wiki/API_SetBattlefieldScoreFaction]
...
--- [https://wow.gamepedia.com/wiki/API_SetBinding]
...
--- [https://wow.gamepedia.com/wiki/API_SetBindingClick]
--- @param key string @ Any binding string accepted by World of Warcraft. For example: ALT-CTRL-F, SHIFT-T, W, BUTTON4.
...
--- [https://wow.gamepedia.com/wiki/API_SetBindingItem]
--- @param key string @ Any binding string accepted by World of Warcraft. For example: ALT-CTRL-F, SHIFT-T, W, BUTTON4.
...
--- [https://wow.gamepedia.com/wiki/API_SetBindingMacro]
--- @param key string @ Any binding string accepted by World of Warcraft. For example: ALT-CTRL-F, SHIFT-T, W, BUTTON4.
--- @param macroName_or_macroId unknown
--- @return number @ ok
...
--- [https://wow.gamepedia.com/wiki/API_SetBindingSpell]
--- @param key string @ Any binding string accepted by World of Warcraft. For example: ALT-CTRL-F, SHIFT-T, W, BUTTON4.
...
--- [https://wow.gamepedia.com/wiki/API_SetCemeteryPreference?action=edit&amp;redlink=1]
--- @return void
function SetCemeteryPreference()
end

--- Sets the channel owner.
--- [https://wow.gamepedia.com/wiki/API_SetChannelOwner]
...
--- [https://wow.gamepedia.com/wiki/API_SetChannelPassword]
...
--- [https://wow.gamepedia.com/wiki/API_SetChatColorNameByClass?action=edit&amp;redlink=1]
--- @return void
function SetChatColorNameByClass()
end

--- [https://wow.gamepedia.com/wiki/API_SetChatWindowAlpha?action=edit&amp;redlink=1]
--- @return void
function SetChatWindowAlpha()
end

--- [https://wow.gamepedia.com/wiki/API_SetChatWindowColor?action=edit&amp;redlink=1]
--- @return void
function SetChatWindowColor()
end

--- [https://wow.gamepedia.com/wiki/API_SetChatWindowDocked?action=edit&amp;redlink=1]
--- @return void
function SetChatWindowDocked()
end

--- [https://wow.gamepedia.com/wiki/API_SetChatWindowLocked?action=edit&amp;redlink=1]
--- @return void
function SetChatWindowLocked()
end

--- [https://wow.gamepedia.com/wiki/API_SetChatWindowName?action=edit&amp;redlink=1]
--- @return void
function SetChatWindowName()
end

--- [https://wow.gamepedia.com/wiki/API_SetChatWindowSavedDimensions?action=edit&amp;redlink=1]
--- @return void
function SetChatWindowSavedDimensions()
end

--- [https://wow.gamepedia.com/wiki/API_SetChatWindowSavedPosition?action=edit&amp;redlink=1]
--- @return void
function SetChatWindowSavedPosition()
end

--- [https://wow.gamepedia.com/wiki/API_SetChatWindowShown?action=edit&amp;redlink=1]
--- @return void
function SetChatWindowShown()
end

--- [https://wow.gamepedia.com/wiki/API_SetChatWindowSize?action=edit&amp;redlink=1]
--- @return void
function SetChatWindowSize()
end

--- [https://wow.gamepedia.com/wiki/API_SetChatWindowUninteractable?action=edit&amp;redlink=1]
--- @return void
function SetChatWindowUninteractable()
end

--- Sets the key used to open the console overlay for the current session.
--- [https://wow.gamepedia.com/wiki/API_SetConsoleKey]
...
--- [https://wow.gamepedia.com/wiki/API_SetCurrentGraphicsSetting?action=edit&amp;redlink=1]
--- @return void
function SetCurrentGraphicsSetting()
end

--- [https://wow.gamepedia.com/wiki/API_SetCurrentGuildBankTab?action=edit&amp;redlink=1]
--- @return void
function SetCurrentGuildBankTab()
end

--- Changes your character's displayed title.
--- [https://wow.gamepedia.com/wiki/API_SetCurrentTitle]
...
--- [https://wow.gamepedia.com/wiki/API_SetCursor]
...
--- [https://wow.gamepedia.com/wiki/API_SetCursorVirtualItem?action=edit&amp;redlink=1]
--- @return void
function SetCursorVirtualItem()
end

--- [https://wow.gamepedia.com/wiki/API_SetDefaultVideoOptions?action=edit&amp;redlink=1]
--- @return void
function SetDefaultVideoOptions()
end

--- Changes the player's current dungeon difficulty.
--- [https://wow.gamepedia.com/wiki/API_SetDungeonDifficultyID]
--- @param difficultyIndex number @ 1 → 5 Player
--- @return void
function SetDungeonDifficultyID(difficultyIndex)
end

--- [https://wow.gamepedia.com/wiki/API_SetEuropeanNumbers?action=edit&amp;redlink=1]
--- @return void
function SetEuropeanNumbers()
end

--- [https://wow.gamepedia.com/wiki/API_SetEveryoneIsAssistant?action=edit&amp;redlink=1]
--- @return void
function SetEveryoneIsAssistant()
end

--- Clears the inactive flag on the specified faction.
--- [https://wow.gamepedia.com/wiki/API_SetFactionActive]
...
--- [https://wow.gamepedia.com/wiki/API_SetFactionInactive]
--- @param index number @ The index of the faction to mark inactive, ascending from 1.
--- @return void
function SetFactionInactive(index)
end

--- [https://wow.gamepedia.com/wiki/API_SetFocusedAchievement?action=edit&amp;redlink=1]
--- @return void
function SetFocusedAchievement()
end

--- [https://wow.gamepedia.com/wiki/API_SetGamePadCursorControl?action=edit&amp;redlink=1]
--- @return void
function SetGamePadCursorControl()
end

--- [https://wow.gamepedia.com/wiki/API_SetGamePadFreeLook?action=edit&amp;redlink=1]
--- @return void
function SetGamePadFreeLook()
end

--- [https://wow.gamepedia.com/wiki/API_SetGuildApplicantSelection?action=edit&amp;redlink=1]
--- @return void
function SetGuildApplicantSelection()
end

--- Sets a guild bank tab's name and icon.
--- [https://wow.gamepedia.com/wiki/API_SetGuildBankTabInfo]
...
--- [https://wow.gamepedia.com/wiki/API_SetGuildBankTabItemWithdraw?action=edit&amp;redlink=1]
--- @return void
function SetGuildBankTabItemWithdraw()
end

--- Edits permissions for a bank tab.
--- [https://wow.gamepedia.com/wiki/API_SetGuildBankTabPermissions]
--- @param tab number @ Bank Tab to edit.
...
--- [https://wow.gamepedia.com/wiki/API_SetGuildBankText]
--- @param tab number @ Bank Tab to edit.
...
--- [https://wow.gamepedia.com/wiki/API_SetGuildBankWithdrawGoldLimit]
--- @param amount number @ the amount of gold to withdraw per day
--- @return void
function SetGuildBankWithdrawGoldLimit(amount)
end

--- [https://wow.gamepedia.com/wiki/API_SetGuildInfoText]
--- @param text unknown
--- @return void
function SetGuildInfoText(text)
end

--- [https://wow.gamepedia.com/wiki/API_SetGuildMemberRank?action=edit&amp;redlink=1]
--- @return void
function SetGuildMemberRank()
end

--- [https://wow.gamepedia.com/wiki/API_SetGuildNewsFilter?action=edit&amp;redlink=1]
--- @return void
function SetGuildNewsFilter()
end

--- [https://wow.gamepedia.com/wiki/API_SetGuildRecruitmentComment?action=edit&amp;redlink=1]
--- @return void
function SetGuildRecruitmentComment()
end

--- [https://wow.gamepedia.com/wiki/API_SetGuildRecruitmentSettings?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_SetGuildRosterSelection]
--- @param index unknown
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_SetGuildRosterShowOffline]
...
--- [https://wow.gamepedia.com/wiki/API_SetGuildTradeSkillCategoryFilter?action=edit&amp;redlink=1]
--- @return void
function SetGuildTradeSkillCategoryFilter()
end

--- [https://wow.gamepedia.com/wiki/API_SetGuildTradeSkillItemNameFilter?action=edit&amp;redlink=1]
--- @return void
function SetGuildTradeSkillItemNameFilter()
end

--- [https://wow.gamepedia.com/wiki/API_SetInWorldUIVisibility?action=edit&amp;redlink=1]
--- @return void
function SetInWorldUIVisibility()
end

--- [https://wow.gamepedia.com/wiki/API_SetInsertItemsLeftToRight?action=edit&amp;redlink=1]
--- @return void
function SetInsertItemsLeftToRight()
end

--- [https://wow.gamepedia.com/wiki/API_SetInventoryPortraitTexture?action=edit&amp;redlink=1]
--- @return void
function SetInventoryPortraitTexture()
end

--- [https://wow.gamepedia.com/wiki/API_SetItemSearch?action=edit&amp;redlink=1]
--- @return void
function SetItemSearch()
end

--- [https://wow.gamepedia.com/wiki/API_SetItemUpgradeFromCursorItem?action=edit&amp;redlink=1]
--- @return void
function SetItemUpgradeFromCursorItem()
end

--- [https://wow.gamepedia.com/wiki/API_SetLFGBootVote?action=edit&amp;redlink=1]
--- @return void
function SetLFGBootVote()
end

--- Sets your comment in the LFG interface.
--- [https://wow.gamepedia.com/wiki/API_SetLFGComment]
--- @param comment unknown
--- @return void
function SetLFGComment(comment)
end

--- [https://wow.gamepedia.com/wiki/API_SetLFGDungeon?action=edit&amp;redlink=1]
--- @return void
function SetLFGDungeon()
end

--- [https://wow.gamepedia.com/wiki/API_SetLFGDungeonEnabled?action=edit&amp;redlink=1]
--- @return void
function SetLFGDungeonEnabled()
end

--- [https://wow.gamepedia.com/wiki/API_SetLFGHeaderCollapsed?action=edit&amp;redlink=1]
--- @return void
function SetLFGHeaderCollapsed()
end

--- [https://wow.gamepedia.com/wiki/API_SetLFGRoles?action=edit&amp;redlink=1]
--- @return void
function SetLFGRoles()
end

--- [https://wow.gamepedia.com/wiki/API_SetLegacyRaidDifficultyID?action=edit&amp;redlink=1]
--- @return void
function SetLegacyRaidDifficultyID()
end

--- [https://wow.gamepedia.com/wiki/API_SetLookingForGuildComment?action=edit&amp;redlink=1]
--- @return void
function SetLookingForGuildComment()
end

--- [https://wow.gamepedia.com/wiki/API_SetLookingForGuildSettings?action=edit&amp;redlink=1]
--- @return void
function SetLookingForGuildSettings()
end

--- [https://wow.gamepedia.com/wiki/API_SetLootMethod]
...
--- [https://wow.gamepedia.com/wiki/API_SetLootPortrait?action=edit&amp;redlink=1]
--- @return void
function SetLootPortrait()
end

--- Sets the player's loot specialization.
--- [https://wow.gamepedia.com/wiki/API_SetLootSpecialization]
...
--- [https://wow.gamepedia.com/wiki/API_SetMerchantFilter?action=edit&amp;redlink=1]
--- @return void
function SetMerchantFilter()
end

--- Assigns the given modifier key to the given action.
--- [https://wow.gamepedia.com/wiki/API_SetModifiedClick]
...
--- [https://wow.gamepedia.com/wiki/API_SetMouselookOverrideBinding?action=edit&amp;redlink=1]
--- @return void
function SetMouselookOverrideBinding()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_SetMoveEnabled]
--- @return void
function SetMoveEnabled()
end

--- Sets the totem spell for a specific totem bar slot.
--- [https://wow.gamepedia.com/wiki/API_SetMultiCastSpell]
...
--- [https://wow.gamepedia.com/wiki/API_SetNextBarberShopStyle]
...
--- [https://wow.gamepedia.com/wiki/API_SetOptOutOfLoot]
...
--- [https://wow.gamepedia.com/wiki/API_SetOverrideBinding]
...
--- [https://wow.gamepedia.com/wiki/API_SetOverrideBindingClick]
--- @param owner Frame @ The frame this binding belongs to; this can later be used to clear all override bindings belonging to a particular frame.
--- @param isPriority boolean @ true if this is a priority binding, false otherwise. Both types of override bindings take precedence over normal bindings.
--- @param key string @ Binding to bind the command to. For example, Q, ALT-Q, ALT-CTRL-SHIFT-Q, BUTTON5
...
--- [https://wow.gamepedia.com/wiki/API_SetOverrideBindingItem]
--- @param owner Frame @ The frame this binding belongs to; this can later be used to clear all override bindings belonging to a particular frame.
--- @param isPriority boolean @ true if this is a priority binding, false otherwise. Both types of override bindings take precedence over normal bindings.
--- @param key string @ Binding to bind the command to. For example, Q, ALT-Q, ALT-CTRL-SHIFT-Q, BUTTON5
...
--- [https://wow.gamepedia.com/wiki/API_SetOverrideBindingMacro]
--- @param owner Frame @ The frame this binding belongs to; this can later be used to clear all override bindings belonging to a particular frame.
--- @param isPriority boolean @ true if this is a priority binding, false otherwise. Both types of override bindings take precedence over normal bindings.
--- @param key string @ Binding to bind the command to. For example, Q, ALT-Q, ALT-CTRL-SHIFT-Q, BUTTON5
...
--- [https://wow.gamepedia.com/wiki/API_SetOverrideBindingSpell]
--- @param owner Frame @ The frame this binding belongs to; this can later be used to clear all override bindings belonging to a particular frame.
--- @param isPriority boolean @ true if this is a priority binding, false otherwise. Both types of override bindings take precedence over normal bindings.
--- @param key string @ Binding to bind the command to. For example, Q, ALT-Q, ALT-CTRL-SHIFT-Q, BUTTON5
...
--- [https://wow.gamepedia.com/wiki/API_SetPOIIconOverlapDistance?action=edit&amp;redlink=1]
--- @return void
function SetPOIIconOverlapDistance()
end

--- [https://wow.gamepedia.com/wiki/API_SetPOIIconOverlapPushDistance?action=edit&amp;redlink=1]
--- @return void
function SetPOIIconOverlapPushDistance()
end

--- Controls PvP combat flagging.
--- [https://wow.gamepedia.com/wiki/API_SetPVP]
...
--- [https://wow.gamepedia.com/wiki/API_SetPVPRoles]
...
--- [https://wow.gamepedia.com/wiki/API_SetPartyAssignment?action=edit&amp;redlink=1]
--- @return void
function SetPartyAssignment()
end

--- [https://wow.gamepedia.com/wiki/API_SetPetSlot?action=edit&amp;redlink=1]
--- @return void
function SetPetSlot()
end

--- [https://wow.gamepedia.com/wiki/API_SetPetStablePaperdoll]
...
--- [https://wow.gamepedia.com/wiki/API_SetPortraitTexture]
...
--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_SetPortraitTextureFromCreatureDisplayID]
--- @param textureObject unknown @ widget : Texture
...
--- [https://wow.gamepedia.com/wiki/API_SetPortraitToTexture]
...
--- [https://wow.gamepedia.com/wiki/API_SetRaidDifficultyID]
--- @param difficultyIndex number @ 3 → 10 Player
--- @return void
function SetRaidDifficultyID(difficultyIndex)
end

--- [https://wow.gamepedia.com/wiki/API_SetRaidProfileOption?action=edit&amp;redlink=1]
--- @return void
function SetRaidProfileOption()
end

--- [https://wow.gamepedia.com/wiki/API_SetRaidProfileSavedPosition?action=edit&amp;redlink=1]
--- @return void
function SetRaidProfileSavedPosition()
end

--- Move a raid member from his current subgroup into a different (non-full) subgroup.
--- [https://wow.gamepedia.com/wiki/API_SetRaidSubgroup]
--- @param index unknown
...
--- [https://wow.gamepedia.com/wiki/API_SetRaidTarget]
--- @param unit string @ UnitId
...
--- [https://wow.gamepedia.com/wiki/API_SetRaidTargetProtected?action=edit&amp;redlink=1]
--- @return void
function SetRaidTargetProtected()
end

--- [https://wow.gamepedia.com/wiki/API_SetRecruitingGuildSelection?action=edit&amp;redlink=1]
--- @return void
function SetRecruitingGuildSelection()
end

--- [https://wow.gamepedia.com/wiki/API_SetSavedInstanceExtend?action=edit&amp;redlink=1]
--- @return void
function SetSavedInstanceExtend()
end

--- Returns the index of the current resolution in effect
--- [https://wow.gamepedia.com/wiki/API_SetScreenResolution]
--- @param index unknown
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_SetSelectedArtifact]
--- @param raceIndex unknown @ int - Index of the race to select.
--- @return void
function SetSelectedArtifact(raceIndex)
end

--- [https://wow.gamepedia.com/wiki/API_SetSelectedDisplayChannel?action=edit&amp;redlink=1]
--- @return void
function SetSelectedDisplayChannel()
end

--- [https://wow.gamepedia.com/wiki/API_SetSelectedFaction?action=edit&amp;redlink=1]
--- @return void
function SetSelectedFaction()
end

--- [https://wow.gamepedia.com/wiki/API_SetSelectedScreenResolutionIndex?action=edit&amp;redlink=1]
--- @return void
function SetSelectedScreenResolutionIndex()
end

--- [https://wow.gamepedia.com/wiki/API_SetSelectedWarGameType?action=edit&amp;redlink=1]
--- @return void
function SetSelectedWarGameType()
end

--- [https://wow.gamepedia.com/wiki/API_SetSendMailCOD?action=edit&amp;redlink=1]
--- @return void
function SetSendMailCOD()
end

--- [https://wow.gamepedia.com/wiki/API_SetSendMailMoney?action=edit&amp;redlink=1]
--- @return void
function SetSendMailMoney()
end

--- [https://wow.gamepedia.com/wiki/API_SetSendMailShowing?action=edit&amp;redlink=1]
--- @return void
function SetSendMailShowing()
end

--- [https://wow.gamepedia.com/wiki/API_SetSortBagsRightToLeft?action=edit&amp;redlink=1]
--- @return void
function SetSortBagsRightToLeft()
end

--- Selects a specialization.
--- [https://wow.gamepedia.com/wiki/API_SetSpecialization]
...
--- [https://wow.gamepedia.com/wiki/API_SetSpellbookPetAction?action=edit&amp;redlink=1]
--- @return void
function SetSpellbookPetAction()
end

--- [https://wow.gamepedia.com/wiki/API_SetTaxiBenchmarkMode?action=edit&amp;redlink=1]
--- @return void
function SetTaxiBenchmarkMode()
end

--- [https://wow.gamepedia.com/wiki/API_SetTaxiMap]
...
--- [https://wow.gamepedia.com/wiki/API_SetTracking]
...
--- [https://wow.gamepedia.com/wiki/API_SetTradeCurrency?action=edit&amp;redlink=1]
--- @return void
function SetTradeCurrency()
end

--- Sets the amount of money offered as part of the player's trade offer.
--- [https://wow.gamepedia.com/wiki/API_SetTradeMoney]
...
--- [https://wow.gamepedia.com/wiki/API_SetTrainerServiceTypeFilter]
...
--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_SetTurnEnabled]
--- @return void
function SetTurnEnabled()
end

--- [https://wow.gamepedia.com/wiki/API_SetUIVisibility?action=edit&amp;redlink=1]
--- @return void
function SetUIVisibility()
end

--- [https://wow.gamepedia.com/wiki/API_SetView]
...
--- [https://wow.gamepedia.com/wiki/API_SetWatchedFactionIndex]
...
--- [https://wow.gamepedia.com/wiki/API_SetupFullscreenScale]
--- @return void
function SetupFullscreenScale()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_ShouldShowIslandsWeeklyPOI]
--- @return boolean @ show
function ShouldShowIslandsWeeklyPOI()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_ShouldShowSpecialSplashScreen]
--- @return boolean @ show
function ShouldShowSpecialSplashScreen()
end

--- Sets whether account-wide achievements are shown to other players.
--- [https://wow.gamepedia.com/wiki/API_ShowAccountAchievements]
...
--- [https://wow.gamepedia.com/wiki/API_ShowBossFrameWhenUninteractable?action=edit&amp;redlink=1]
--- @return void
function ShowBossFrameWhenUninteractable()
end

--- [https://wow.gamepedia.com/wiki/API_ShowBuybackSellCursor?action=edit&amp;redlink=1]
--- @return void
function ShowBuybackSellCursor()
end

--- [https://wow.gamepedia.com/wiki/API_ShowContainerSellCursor?action=edit&amp;redlink=1]
--- @return void
function ShowContainerSellCursor()
end

--- [https://wow.gamepedia.com/wiki/API_ShowInventorySellCursor?action=edit&amp;redlink=1]
--- @return void
function ShowInventorySellCursor()
end

--- Shows the completion dialog for a complete, auto-completable quest.
--- [https://wow.gamepedia.com/wiki/API_ShowQuestComplete]
...
--- [https://wow.gamepedia.com/wiki/API_ShowQuestOffer?action=edit&amp;redlink=1]
--- @return void
function ShowQuestOffer()
end

--- [https://wow.gamepedia.com/wiki/API_ShowRepairCursor]
--- @return void
function ShowRepairCursor()
end

--- [https://wow.gamepedia.com/wiki/API_SignPetition]
--- @return void
function SignPetition()
end

--- The player sits, stands, or begins to descend (while swimming or flying)
--- [https://wow.gamepedia.com/wiki/API_SitStandOrDescendStart]
--- @return void
function SitStandOrDescendStart()
end

--- [https://wow.gamepedia.com/wiki/API_SocketContainerItem?action=edit&amp;redlink=1]
--- @return void
function SocketContainerItem()
end

--- [https://wow.gamepedia.com/wiki/API_SocketInventoryItem?action=edit&amp;redlink=1]
--- @return void
function SocketInventoryItem()
end

--- Socked a Keystone to the selected artifact.
--- [https://wow.gamepedia.com/wiki/API_SocketItemToArtifact]
--- @return boolean @ keystoneAdded
function SocketItemToArtifact()
end

--- [https://wow.gamepedia.com/wiki/API_SolveArtifact?action=edit&amp;redlink=1]
--- @return void
function SolveArtifact()
end

--- [https://wow.gamepedia.com/wiki/API_SortBGList?action=edit&amp;redlink=1]
--- @return void
function SortBGList()
end

--- [https://wow.gamepedia.com/wiki/API_SortBags?action=edit&amp;redlink=1]
--- @return void
function SortBags()
end

--- [https://wow.gamepedia.com/wiki/API_SortBankBags?action=edit&amp;redlink=1]
--- @return void
function SortBankBags()
end

--- [https://wow.gamepedia.com/wiki/API_SortBattlefieldScoreData?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_SortGuildRoster]
--- @param level unknown
--- @return void
function SortGuildRoster(level)
end

--- [https://wow.gamepedia.com/wiki/API_SortGuildTradeSkill?action=edit&amp;redlink=1]
--- @return void
function SortGuildTradeSkill()
end

--- [https://wow.gamepedia.com/wiki/API_SortQuestSortTypes?action=edit&amp;redlink=1]
--- @return void
function SortQuestSortTypes()
end

--- [https://wow.gamepedia.com/wiki/API_SortQuests?action=edit&amp;redlink=1]
--- @return void
function SortQuests()
end

--- [https://wow.gamepedia.com/wiki/API_SortReagentBankBags?action=edit&amp;redlink=1]
--- @return void
function SortReagentBankBags()
end

--- [https://wow.gamepedia.com/wiki/API_Sound_ChatSystem_GetInputDriverNameByIndex?action=edit&amp;redlink=1]
--- @return void
function Sound_ChatSystem_GetInputDriverNameByIndex()
end

--- [https://wow.gamepedia.com/wiki/API_Sound_ChatSystem_GetNumInputDrivers?action=edit&amp;redlink=1]
--- @return void
function Sound_ChatSystem_GetNumInputDrivers()
end

--- [https://wow.gamepedia.com/wiki/API_Sound_ChatSystem_GetNumOutputDrivers?action=edit&amp;redlink=1]
--- @return void
function Sound_ChatSystem_GetNumOutputDrivers()
end

--- [https://wow.gamepedia.com/wiki/API_Sound_ChatSystem_GetOutputDriverNameByIndex?action=edit&amp;redlink=1]
--- @return void
function Sound_ChatSystem_GetOutputDriverNameByIndex()
end

--- [https://wow.gamepedia.com/wiki/API_Sound_GameSystem_GetInputDriverNameByIndex?action=edit&amp;redlink=1]
--- @return void
function Sound_GameSystem_GetInputDriverNameByIndex()
end

--- [https://wow.gamepedia.com/wiki/API_Sound_GameSystem_GetNumInputDrivers?action=edit&amp;redlink=1]
--- @return void
function Sound_GameSystem_GetNumInputDrivers()
end

--- [https://wow.gamepedia.com/wiki/API_Sound_GameSystem_GetNumOutputDrivers?action=edit&amp;redlink=1]
--- @return void
function Sound_GameSystem_GetNumOutputDrivers()
end

--- [https://wow.gamepedia.com/wiki/API_Sound_GameSystem_GetOutputDriverNameByIndex?action=edit&amp;redlink=1]
--- @return void
function Sound_GameSystem_GetOutputDriverNameByIndex()
end

--- [https://wow.gamepedia.com/wiki/API_Sound_GameSystem_RestartSoundSystem?action=edit&amp;redlink=1]
--- @return void
function Sound_GameSystem_RestartSoundSystem()
end

--- [https://wow.gamepedia.com/wiki/API_SpellCanTargetGarrisonFollower?action=edit&amp;redlink=1]
--- @return void
function SpellCanTargetGarrisonFollower()
end

--- [https://wow.gamepedia.com/wiki/API_SpellCanTargetGarrisonFollowerAbility?action=edit&amp;redlink=1]
--- @return void
function SpellCanTargetGarrisonFollowerAbility()
end

--- [https://wow.gamepedia.com/wiki/API_SpellCanTargetGarrisonMission?action=edit&amp;redlink=1]
--- @return void
function SpellCanTargetGarrisonMission()
end

--- [https://wow.gamepedia.com/wiki/API_SpellCanTargetItem?action=edit&amp;redlink=1]
--- @return void
function SpellCanTargetItem()
end

--- [https://wow.gamepedia.com/wiki/API_SpellCanTargetItemID?action=edit&amp;redlink=1]
--- @return void
function SpellCanTargetItemID()
end

--- [https://wow.gamepedia.com/wiki/API_SpellCanTargetQuest?action=edit&amp;redlink=1]
--- @return void
function SpellCanTargetQuest()
end

--- Checks if the spell awaiting target selection can be cast on a specified unit.
--- [https://wow.gamepedia.com/wiki/API_SpellCanTargetUnit]
--- @param unitId string @ UnitId) - The unit to check.
--- @return boolean @ canTarget
function SpellCanTargetUnit(unitId)
end

--- [https://wow.gamepedia.com/wiki/API_SpellCancelQueuedSpell?action=edit&amp;redlink=1]
--- @return void
function SpellCancelQueuedSpell()
end

--- Checks if the spell should be visible, depending on spellId and raid combat status
--- [https://wow.gamepedia.com/wiki/API_SpellGetVisibilityInfo]
...
--- [https://wow.gamepedia.com/wiki/API_SpellHasRange?action=edit&amp;redlink=1]
--- @return void
function SpellHasRange()
end

--- [https://wow.gamepedia.com/wiki/API_SpellIsAlwaysShown?action=edit&amp;redlink=1]
--- @return void
function SpellIsAlwaysShown()
end

--- [https://wow.gamepedia.com/wiki/API_SpellIsSelfBuff?action=edit&amp;redlink=1]
--- @return void
function SpellIsSelfBuff()
end

--- Returns whether a spell is about to be cast, waiting for the player to select a target.
--- [https://wow.gamepedia.com/wiki/API_SpellIsTargeting]
--- @return number @ isTargeting
function SpellIsTargeting()
end

--- Stops the current spellcasting.
--- [https://wow.gamepedia.com/wiki/API_SpellStopCasting]
--- @return number @ stopped
function SpellStopCasting()
end

--- Cancels the spell awaiting target selection.
--- [https://wow.gamepedia.com/wiki/API_SpellStopTargeting]
--- @return void
function SpellStopTargeting()
end

--- [https://wow.gamepedia.com/wiki/API_SpellTargetItem?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_SplitGuildBankItem?action=edit&amp;redlink=1]
--- @return void
function SplitGuildBankItem()
end

--- [https://wow.gamepedia.com/wiki/API_StartAttack?action=edit&amp;redlink=1]
--- @return void
function StartAttack()
end

--- [https://wow.gamepedia.com/wiki/API_StartAutoRun?action=edit&amp;redlink=1]
--- @return void
function StartAutoRun()
end

--- Invites the specified player to a duel.
--- [https://wow.gamepedia.com/wiki/API_StartDuel]
...
--- [https://wow.gamepedia.com/wiki/API_StartSpectatorWarGame?action=edit&amp;redlink=1]
--- @return void
function StartSpectatorWarGame()
end

--- [https://wow.gamepedia.com/wiki/API_StartWarGame?action=edit&amp;redlink=1]
--- @return void
function StartWarGame()
end

--- [https://wow.gamepedia.com/wiki/API_StartWarGameByName?action=edit&amp;redlink=1]
--- @return void
function StartWarGameByName()
end

--- [https://wow.gamepedia.com/wiki/API_StopAttack?action=edit&amp;redlink=1]
--- @return void
function StopAttack()
end

--- [https://wow.gamepedia.com/wiki/API_StopAutoRun?action=edit&amp;redlink=1]
--- @return void
function StopAutoRun()
end

--- [https://wow.gamepedia.com/wiki/API_StopCinematic?action=edit&amp;redlink=1]
--- @return void
function StopCinematic()
end

--- [https://wow.gamepedia.com/wiki/API_StopMacro?action=edit&amp;redlink=1]
--- @return void
function StopMacro()
end

--- Stops the currently played music file.
--- [https://wow.gamepedia.com/wiki/API_StopMusic]
--- @return void
function StopMusic()
end

--- Stops playing the specified sound.
--- [https://wow.gamepedia.com/wiki/API_StopSound]
...
--- [https://wow.gamepedia.com/wiki/API_StoreSecureReference?action=edit&amp;redlink=1]
--- @return void
function StoreSecureReference()
end

--- The player begins strafing left at the specified time.
--- [https://wow.gamepedia.com/wiki/API_StrafeLeftStart]
...
--- [https://wow.gamepedia.com/wiki/API_StrafeLeftStop]
--- @param startTime unknown
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_StrafeRightStart]
...
--- [https://wow.gamepedia.com/wiki/API_StrafeRightStop]
--- @param startTime unknown
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_Stuck]
--- @return void
function Stuck()
end

--- [https://wow.gamepedia.com/wiki/API_SubmitRequiredGuildRename?action=edit&amp;redlink=1]
--- @return void
function SubmitRequiredGuildRename()
end

--- Summons a player using the RaF system.
--- [https://wow.gamepedia.com/wiki/API_SummonFriend]
...
--- [https://wow.gamepedia.com/wiki/API_SummonRandomCritter]
--- @return void
function SummonRandomCritter()
end

--- [https://wow.gamepedia.com/wiki/API_SupportsClipCursor?action=edit&amp;redlink=1]
--- @return void
function SupportsClipCursor()
end

--- [https://wow.gamepedia.com/wiki/API_SurrenderArena?action=edit&amp;redlink=1]
--- @return void
function SurrenderArena()
end

--- Swaps two players in a raid.
--- [https://wow.gamepedia.com/wiki/API_SwapRaidSubgroup]
...
--- [https://wow.gamepedia.com/wiki/API_SwitchAchievementSearchTab?action=edit&amp;redlink=1]
--- @return void
function SwitchAchievementSearchTab()
end

--- Take all money attached in a given letter in your inbox.
--- [https://wow.gamepedia.com/wiki/API_TakeInboxItem]
--- @param index unknown
...
--- [https://wow.gamepedia.com/wiki/API_TakeInboxMoney]
--- @param index number @ a number representing a message in the inbox
--- @return void
function TakeInboxMoney(index)
end

--- [https://wow.gamepedia.com/wiki/API_TakeInboxTextItem?action=edit&amp;redlink=1]
--- @return void
function TakeInboxTextItem()
end

--- Begins travelling to the specified taxi map node, if possible.
--- [https://wow.gamepedia.com/wiki/API_TakeTaxiNode]
--- @param index number @ Taxi node index to begin travelling to, ascending from 1 to NumTaxiNodes().
--- @return void
function TakeTaxiNode(index)
end

--- [https://wow.gamepedia.com/wiki/API_TargetDirectionEnemy?action=edit&amp;redlink=1]
--- @return void
function TargetDirectionEnemy()
end

--- [https://wow.gamepedia.com/wiki/API_TargetDirectionFinished?action=edit&amp;redlink=1]
--- @return void
function TargetDirectionFinished()
end

--- [https://wow.gamepedia.com/wiki/API_TargetDirectionFriend?action=edit&amp;redlink=1]
--- @return void
function TargetDirectionFriend()
end

--- Selects the last targeted enemy as the current target.
--- [https://wow.gamepedia.com/wiki/API_TargetLastEnemy]
--- @return void
function TargetLastEnemy()
end

--- [https://wow.gamepedia.com/wiki/API_TargetLastFriend?action=edit&amp;redlink=1]
--- @return void
function TargetLastFriend()
end

--- Selects the last target as the current target.
--- [https://wow.gamepedia.com/wiki/API_TargetLastTarget]
--- @return void
function TargetLastTarget()
end

--- [https://wow.gamepedia.com/wiki/API_TargetNearest?action=edit&amp;redlink=1]
--- @return void
function TargetNearest()
end

--- Selects the nearest enemy as the current target.
--- [https://wow.gamepedia.com/wiki/API_TargetNearestEnemy]
--- @param reverse number @ true to cycle backwards; false to cycle forwards.
--- @return void
function TargetNearestEnemy(reverse)
end

--- [https://wow.gamepedia.com/wiki/API_TargetNearestEnemyPlayer?action=edit&amp;redlink=1]
--- @return void
function TargetNearestEnemyPlayer()
end

--- This function will select the nearest friendly unit.
--- [https://wow.gamepedia.com/wiki/API_TargetNearestFriend]
--- @param reverse boolean @ if true, reverses the order of targetting units.
--- @return void
function TargetNearestFriend(reverse)
end

--- [https://wow.gamepedia.com/wiki/API_TargetNearestFriendPlayer?action=edit&amp;redlink=1]
--- @return void
function TargetNearestFriendPlayer()
end

--- [https://wow.gamepedia.com/wiki/API_TargetNearestPartyMember?action=edit&amp;redlink=1]
--- @return void
function TargetNearestPartyMember()
end

--- [https://wow.gamepedia.com/wiki/API_TargetNearestRaidMember?action=edit&amp;redlink=1]
--- @return void
function TargetNearestRaidMember()
end

--- [https://wow.gamepedia.com/wiki/API_TargetPriorityHighlightEnd?action=edit&amp;redlink=1]
--- @return void
function TargetPriorityHighlightEnd()
end

--- [https://wow.gamepedia.com/wiki/API_TargetPriorityHighlightStart?action=edit&amp;redlink=1]
--- @return void
function TargetPriorityHighlightStart()
end

--- [https://wow.gamepedia.com/wiki/API_TargetSpellReplacesBonusTree?action=edit&amp;redlink=1]
--- @return void
function TargetSpellReplacesBonusTree()
end

--- [https://wow.gamepedia.com/wiki/API_TargetTotem?action=edit&amp;redlink=1]
--- @return void
function TargetTotem()
end

--- Targets the specified unit.
--- [https://wow.gamepedia.com/wiki/API_TargetUnit]
...
--- [https://wow.gamepedia.com/wiki/API_TaxiGetDestX]
...
--- [https://wow.gamepedia.com/wiki/API_TaxiGetDestY]
--- @return void
function TaxiGetDestY()
end

--- [https://wow.gamepedia.com/wiki/API_TaxiGetNodeSlot?action=edit&amp;redlink=1]
--- @return void
function TaxiGetNodeSlot()
end

--- [https://wow.gamepedia.com/wiki/API_TaxiGetSrcX]
--- @param destinationIndex number @ The final destination taxi node.
--- @param routeIndex number @ The index of the route to get the source from.
--- @return number @ sX
...
--- [https://wow.gamepedia.com/wiki/API_TaxiGetSrcY]
--- @param destinationIndex number @ The final destination taxi node.
--- @param routeIndex number @ The index of the route to get the source from.
--- @return number @ sY
...
--- [https://wow.gamepedia.com/wiki/API_TaxiIsDirectFlight?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_TaxiNodeCost]
...
--- [https://wow.gamepedia.com/wiki/API_TaxiNodeGetType]
...
--- [https://wow.gamepedia.com/wiki/API_TaxiNodeName]
...
--- [https://wow.gamepedia.com/wiki/API_TaxiNodePosition]
--- @param index unknown
--- @return unknown, unknown @ x, y
function TaxiNodePosition(index)
end

--- [https://wow.gamepedia.com/wiki/API_TaxiRequestEarlyLanding?action=edit&amp;redlink=1]
--- @return void
function TaxiRequestEarlyLanding()
end

--- Signals the client that an offer to resurrect the player has expired.
--- [https://wow.gamepedia.com/wiki/API_TimeoutResurrect]
--- @return void
function TimeoutResurrect()
end

--- [https://wow.gamepedia.com/wiki/API_ToggleAnimKitDisplay?action=edit&amp;redlink=1]
--- @return void
function ToggleAnimKitDisplay()
end

--- Turns auto-run on or off.
--- [https://wow.gamepedia.com/wiki/API_ToggleAutoRun]
--- @return void
function ToggleAutoRun()
end

--- [https://wow.gamepedia.com/wiki/API_ToggleDebugAIDisplay?action=edit&amp;redlink=1]
--- @return void
function ToggleDebugAIDisplay()
end

--- Controls PvP combat flagging.
--- [https://wow.gamepedia.com/wiki/API_TogglePVP]
--- @return void
function TogglePVP()
end

--- [https://wow.gamepedia.com/wiki/API_TogglePetAutocast?action=edit&amp;redlink=1]
--- @return void
function TogglePetAutocast()
end

--- Toggle between running and walking.
--- [https://wow.gamepedia.com/wiki/API_ToggleRun]
...
--- [https://wow.gamepedia.com/wiki/API_ToggleSelfHighlight?action=edit&amp;redlink=1]
--- @return void
function ToggleSelfHighlight()
end

--- Toggles sheathed or unsheathed weapons.
--- [https://wow.gamepedia.com/wiki/API_ToggleSheath]
--- @return void
function ToggleSheath()
end

--- [https://wow.gamepedia.com/wiki/API_ToggleSpellAutocast?action=edit&amp;redlink=1]
--- @return void
function ToggleSpellAutocast()
end

--- [https://wow.gamepedia.com/wiki/API_ToggleWindowed?action=edit&amp;redlink=1]
--- @return void
function ToggleWindowed()
end

--- [https://wow.gamepedia.com/wiki/API_TriggerTutorial?action=edit&amp;redlink=1]
--- @return void
function TriggerTutorial()
end

--- [https://wow.gamepedia.com/wiki/API_TurnInGuildCharter?action=edit&amp;redlink=1]
--- @return void
function TurnInGuildCharter()
end

--- The player begins turning left at the specified time.
--- [https://wow.gamepedia.com/wiki/API_TurnLeftStart]
...
--- [https://wow.gamepedia.com/wiki/API_TurnLeftStop]
...
--- [https://wow.gamepedia.com/wiki/API_TurnOrActionStart]
--- @return void
function TurnOrActionStart()
end

--- End Right click in the 3D game world.
--- [https://wow.gamepedia.com/wiki/API_TurnOrActionStop]
--- @return void
function TurnOrActionStop()
end

--- The player begins turning right at the specified time.
--- [https://wow.gamepedia.com/wiki/API_TurnRightStart]
...
--- [https://wow.gamepedia.com/wiki/API_TurnRightStop]
--- @param startTime unknown
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_UninviteUnit]
...
--- [https://wow.gamepedia.com/wiki/API_UnitAffectingCombat]
...
--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_UnitAlliedRaceInfo]
--- @param unit string
...
--- [https://wow.gamepedia.com/wiki/API_UnitArmor]
...
--- [https://wow.gamepedia.com/wiki/API_UnitAttackPower]
...
--- [https://wow.gamepedia.com/wiki/API_UnitAttackSpeed]
...
--- [https://wow.gamepedia.com/wiki/API_UnitAura]
--- @param unit string @ UnitId to query.
...
--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_UnitAuraBySlot]
--- @param unit string
...
--- [https://wow.gamepedia.com/wiki/API_UnitAuraSlots]
--- @param unit string @ UnitId to query.
...
--- [https://wow.gamepedia.com/wiki/API_UnitBattlePetLevel?action=edit&amp;redlink=1]
--- @return void
function UnitBattlePetLevel()
end

--- Returns the battle pet species ID of a specified unit.
--- [https://wow.gamepedia.com/wiki/API_UnitBattlePetSpeciesID]
--- @param unit string @ UnitId) - unit to return the species ID of.
--- @return number @ speciesID
function UnitBattlePetSpeciesID(unit)
end

--- [https://wow.gamepedia.com/wiki/API_UnitBattlePetType?action=edit&amp;redlink=1]
--- @return void
function UnitBattlePetType()
end

--- Retrieve info about an aura (a buff or debuff).
--- [https://wow.gamepedia.com/wiki/API_UnitBuff]
--- @param unit string @ UnitId to query.
--- @param index number @ Index incremented from 1 until no more results.
--- @param filter string @ ?Optional.  Could be nil. - Optional, case-insensitive filters separated by spaces or pipes.
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_UnitCanAssist]
...
--- [https://wow.gamepedia.com/wiki/API_UnitCanAttack]
...
--- [https://wow.gamepedia.com/wiki/API_UnitCanCooperate]
...
--- [https://wow.gamepedia.com/wiki/API_UnitCanPetBattle?action=edit&amp;redlink=1]
--- @return void
function UnitCanPetBattle()
end

--- Returns information about the spell currently being cast by the specified unit.
--- [https://wow.gamepedia.com/wiki/API_UnitCastingInfo]
...
--- [https://wow.gamepedia.com/wiki/API_UnitChannelInfo]
...
--- [https://wow.gamepedia.com/wiki/API_UnitChromieTimeID]
--- @param unit string
--- @return number @ ID
...
--- [https://wow.gamepedia.com/wiki/API_UnitClass]
...
--- Two functions provide the class of a specified unit:
--- [https://wow.gamepedia.com/wiki/API_UnitClassBase]
--- @param unitId string @ The UnitId of the unit to check (e.g. player or target)
...
--- [https://wow.gamepedia.com/wiki/API_UnitClassification]
--- @param unit string @ unitId of the unit to query, e.g. target
--- @return string @ classification
function UnitClassification(unit)
end

--- [https://wow.gamepedia.com/wiki/API_UnitControllingVehicle?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_UnitCreatureFamily]
...
--- [https://wow.gamepedia.com/wiki/API_UnitCreatureType]
...
--- [https://wow.gamepedia.com/wiki/API_UnitDamage]
...
--- Retrieve info about an aura (a buff or debuff).
--- [https://wow.gamepedia.com/wiki/API_UnitDebuff]
--- @param unit string @ UnitId to query.
--- @param index number @ Index incremented from 1 until no more results.
--- @param filter string @ ?Optional.  Could be nil. - Optional, case-insensitive filters separated by spaces or pipes.
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_UnitDetailedThreatSituation]
...
--- [https://wow.gamepedia.com/wiki/API_UnitDistanceSquared]
...
--- [https://wow.gamepedia.com/wiki/API_UnitEffectiveLevel]
--- @return void
function UnitEffectiveLevel()
end

--- Determines if the unit exists.
--- [https://wow.gamepedia.com/wiki/API_UnitExists]
--- @param unit string @ The UnitId of the unit to check (Tested with player, pet, party1, hostile target)
...
--- [https://wow.gamepedia.com/wiki/API_UnitFactionGroup]
--- @param unit string @ The UnitId of the unit to check (Tested with player, pet, party1, hostile target)
...
--- [https://wow.gamepedia.com/wiki/API_UnitFullName]
...
--- [https://wow.gamepedia.com/wiki/API_UnitGUID]
--- @param unit unknown @ UnitId - unit to look up the GUID of.
--- @return string @ guid
function UnitGUID(unit)
end

--- [https://wow.gamepedia.com/wiki/API_UnitGetAvailableRoles?action=edit&amp;redlink=1]
--- @return void
function UnitGetAvailableRoles()
end

--- Returns the predicted heals cast on the specified unit.
--- [https://wow.gamepedia.com/wiki/API_UnitGetIncomingHeals]
...
--- [https://wow.gamepedia.com/wiki/API_UnitGetTotalAbsorbs]
...
--- [https://wow.gamepedia.com/wiki/API_UnitGetTotalHealAbsorbs]
...
--- [https://wow.gamepedia.com/wiki/API_UnitHasLFGDeserter]
...
--- [https://wow.gamepedia.com/wiki/API_UnitHasLFGRandomCooldown]
--- @param unit unknown @ UnitId - the unit that would assist (e.g., player or target)
--- @return boolean @ hasRandomCooldown
function UnitHasLFGRandomCooldown(unit)
end

--- [https://wow.gamepedia.com/wiki/API_UnitHasRelicSlot?action=edit&amp;redlink=1]
--- @return void
function UnitHasRelicSlot()
end

--- [https://wow.gamepedia.com/wiki/API_UnitHasVehiclePlayerFrameUI?action=edit&amp;redlink=1]
--- @return void
function UnitHasVehiclePlayerFrameUI()
end

--- [https://wow.gamepedia.com/wiki/API_UnitHasVehicleUI?action=edit&amp;redlink=1]
--- @return void
function UnitHasVehicleUI()
end

--- Returns the current health of the specified unit.
--- [https://wow.gamepedia.com/wiki/API_UnitHealth]
...
--- [https://wow.gamepedia.com/wiki/API_UnitHealthMax]
...
--- [https://wow.gamepedia.com/wiki/API_UnitHonor]
--- @param unitID_or_unitName unknown
...
--- [https://wow.gamepedia.com/wiki/API_UnitHonorLevel]
--- @param unitID_or_PlayerName unknown
...
--- [https://wow.gamepedia.com/wiki/API_UnitHonorMax]
--- @param unitID_or_playerName unknown
--- @return number @ maxHonor
function UnitHonorMax(unitID_or_playerName)
end

--- [https://wow.gamepedia.com/wiki/API_UnitInAnyGroup?action=edit&amp;redlink=1]
--- @return void
function UnitInAnyGroup()
end

--- [https://wow.gamepedia.com/wiki/API_UnitInBattleground]
--- @param unit string @ The UnitId to query (e.g. player, party2, pet, target etc.)
--- @return number @ position
function UnitInBattleground(unit)
end

--- [https://wow.gamepedia.com/wiki/API_UnitInOtherParty?action=edit&amp;redlink=1]
--- @return void
function UnitInOtherParty()
end

--- Returns 1 if the unit is a player in your party, nil otherwise.
--- [https://wow.gamepedia.com/wiki/API_UnitInParty]
...
--- [https://wow.gamepedia.com/wiki/API_UnitInPartyShard]
--- @param unit string
...
--- [https://wow.gamepedia.com/wiki/API_UnitInRaid]
...
--- [https://wow.gamepedia.com/wiki/API_UnitInRange]
...
--- [https://wow.gamepedia.com/wiki/API_UnitInSubgroup?action=edit&amp;redlink=1]
--- @return void
function UnitInSubgroup()
end

--- Checks whether a specified unit is within an vehicle.
--- [https://wow.gamepedia.com/wiki/API_UnitInVehicle]
--- @param target unknown
--- @return unknown @ inVehicle
function UnitInVehicle(target)
end

--- [https://wow.gamepedia.com/wiki/API_UnitInVehicleControlSeat?action=edit&amp;redlink=1]
--- @return void
function UnitInVehicleControlSeat()
end

--- [https://wow.gamepedia.com/wiki/API_UnitInVehicleHidesPetFrame?action=edit&amp;redlink=1]
--- @return void
function UnitInVehicleHidesPetFrame()
end

--- Checks if a unit is AFK.
--- [https://wow.gamepedia.com/wiki/API_UnitIsAFK]
...
--- [https://wow.gamepedia.com/wiki/API_UnitIsBattlePet]
...
--- Four functions indicate whether a unit is a Battle Pet of a certain kind:
--- [https://wow.gamepedia.com/wiki/API_UnitIsBattlePetCompanion]
--- @param unit string @ UnitId) - unit to check, e.g. target.
...
--- [https://wow.gamepedia.com/wiki/API_UnitIsCharmed]
...
--- [https://wow.gamepedia.com/wiki/API_UnitIsConnected]
--- @param unit string
--- @return unknown @ isOnline
function UnitIsConnected(unit)
end

--- [https://wow.gamepedia.com/wiki/API_UnitIsControlling?action=edit&amp;redlink=1]
--- @return void
function UnitIsControlling()
end

--- [https://wow.gamepedia.com/wiki/API_UnitIsCorpse?action=edit&amp;redlink=1]
--- @return void
function UnitIsCorpse()
end

--- Checks if a unit is DND (Do Not Disturb).
--- [https://wow.gamepedia.com/wiki/API_UnitIsDND]
...
--- [https://wow.gamepedia.com/wiki/API_UnitIsDead]
...
--- [https://wow.gamepedia.com/wiki/API_UnitIsDeadOrGhost]
--- @param unit string @ the UnitId to query
...
--- [https://wow.gamepedia.com/wiki/API_UnitIsEnemy]
--- @return void
function UnitIsEnemy()
end

--- Returns whether a unit is feigning death.
--- [https://wow.gamepedia.com/wiki/API_UnitIsFeignDeath]
...
--- [https://wow.gamepedia.com/wiki/API_UnitIsFriend]
...
--- [https://wow.gamepedia.com/wiki/API_UnitIsGhost]
--- @param unit string @ the UnitId to query
...
--- [https://wow.gamepedia.com/wiki/API_UnitIsGroupAssistant]
...
--- [https://wow.gamepedia.com/wiki/API_UnitIsGroupLeader]
--- @param unit string @ UnitId
...
--- [https://wow.gamepedia.com/wiki/API_UnitIsInMyGuild?action=edit&amp;redlink=1]
--- @return void
function UnitIsInMyGuild()
end

--- [https://wow.gamepedia.com/wiki/API_UnitIsMercenary?action=edit&amp;redlink=1]
--- @return void
function UnitIsMercenary()
end

--- Four functions indicate whether a unit is a Battle Pet of a certain kind:
--- [https://wow.gamepedia.com/wiki/API_UnitIsOtherPlayersBattlePet]
--- @param unit string @ UnitId) - unit to check, e.g. target.
--- @return boolean @ isOtherPlayersBattlePet
function UnitIsOtherPlayersBattlePet(unit)
end

--- [https://wow.gamepedia.com/wiki/API_UnitIsOtherPlayersPet?action=edit&amp;redlink=1]
--- @return void
function UnitIsOtherPlayersPet()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_UnitIsOwnerOrControllerOfUnit]
...
--- [https://wow.gamepedia.com/wiki/API_UnitIsPVP]
--- @param unit unknown
...
--- [https://wow.gamepedia.com/wiki/API_UnitIsPVPFreeForAll]
--- @param unitId string @ UnitId) - The unit to check
--- @return boolean @ isFreeForAll
function UnitIsPVPFreeForAll(unitId)
end

--- [https://wow.gamepedia.com/wiki/API_UnitIsPVPSanctuary?action=edit&amp;redlink=1]
--- @return void
function UnitIsPVPSanctuary()
end

--- Checks if a specified unit is a player.
--- [https://wow.gamepedia.com/wiki/API_UnitIsPlayer]
--- @param unit string @ UnitId of the unit to check.
--- @return boolean @ isTrue
...
--- [https://wow.gamepedia.com/wiki/API_UnitIsPossessed]
--- @param unit string @ UnitId of the unit to check.
--- @return boolean @ isTrue
function UnitIsPossessed(unit)
end

--- [https://wow.gamepedia.com/wiki/API_UnitIsQuestBoss?action=edit&amp;redlink=1]
--- @return void
function UnitIsQuestBoss()
end

--- [https://wow.gamepedia.com/wiki/API_UnitIsRaidOfficer?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_UnitIsVisible]
--- @return void
function UnitIsVisible()
end

--- Four functions indicate whether a unit is a Battle Pet of a certain kind:
--- [https://wow.gamepedia.com/wiki/API_UnitIsWildBattlePet]
--- @param unit string @ UnitId) - unit to check, e.g. target.
--- @return unknown @ isWildBatlePet
function UnitIsWildBattlePet(unit)
end

--- [https://wow.gamepedia.com/wiki/API_UnitLeadsAnyGroup?action=edit&amp;redlink=1]
--- @return void
function UnitLeadsAnyGroup()
end

--- Returns the unit's level.
--- [https://wow.gamepedia.com/wiki/API_UnitLevel]
...
--- [https://wow.gamepedia.com/wiki/API_UnitName]
--- @param unit string @ The UnitId to query (e.g. player, party2, pet, target etc.)
--- @return string, string @ name, realm
function UnitName(unit)
end

--- [https://wow.gamepedia.com/wiki/API_UnitNameUnmodified?action=edit&amp;redlink=1]
--- @return void
function UnitNameUnmodified()
end

--- Returns true if a units' nameplate should appear in a widgets-only mode.
--- [https://wow.gamepedia.com/wiki/API_UnitNameplateShowsWidgetsOnly]
--- @param unit string
--- @return boolean @ nameplateShowsWidgetsOnly
function UnitNameplateShowsWidgetsOnly(unit)
end

--- [https://wow.gamepedia.com/wiki/API_UnitNumPowerBarTimers?action=edit&amp;redlink=1]
--- @return void
function UnitNumPowerBarTimers()
end

--- [https://wow.gamepedia.com/wiki/API_UnitOnTaxi]
...
--- [https://wow.gamepedia.com/wiki/API_UnitPVPName]
...
--- [https://wow.gamepedia.com/wiki/API_UnitPhaseReason]
--- @param unit string @ UnitId
...
--- [https://wow.gamepedia.com/wiki/API_UnitPlayerControlled]
...
--- [https://wow.gamepedia.com/wiki/API_UnitPlayerOrPetInParty]
...
--- [https://wow.gamepedia.com/wiki/API_UnitPlayerOrPetInRaid]
--- @param unit unknown
--- @return unknown @ isTrue
...
--- [https://wow.gamepedia.com/wiki/API_UnitPosition]
...
--- [https://wow.gamepedia.com/wiki/API_UnitPower]
--- @param unitToken string @ UnitId
...
--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_UnitPowerBarID]
--- @param unitToken string @ UnitId
--- @return number @ barID
function UnitPowerBarID(unitToken)
end

--- [https://wow.gamepedia.com/wiki/API_UnitPowerBarTimerInfo?action=edit&amp;redlink=1]
--- @return void
function UnitPowerBarTimerInfo()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_UnitPowerDisplayMod]
...
--- [https://wow.gamepedia.com/wiki/API_UnitPowerMax]
--- @param unitToken string @ UnitId
--- @param powerType unknown @ Enum.PowerType? - Type of resource (mana/rage/energy/etc) to query
--- @param unmodified boolean @ ? - Return the higher precision internal value (for graphical use only)
...
--- [https://wow.gamepedia.com/wiki/API_UnitPowerType]
...
--- [https://wow.gamepedia.com/wiki/API_UnitPvpClassification]
--- @param unit string @ UnitId
...
--- [https://wow.gamepedia.com/wiki/API_UnitQuestTrivialLevelRange]
--- @param unit string
...
--- [https://wow.gamepedia.com/wiki/API_UnitQuestTrivialLevelRangeScaling]
--- @param unit string
--- @return number @ levelRange
...
--- [https://wow.gamepedia.com/wiki/API_UnitRace]
--- @param unit string @ UnitId
...
--- [https://wow.gamepedia.com/wiki/API_UnitRangedAttackPower]
...
--- [https://wow.gamepedia.com/wiki/API_UnitRangedDamage]
...
--- [https://wow.gamepedia.com/wiki/API_UnitReaction]
...
--- [https://wow.gamepedia.com/wiki/API_UnitRealmRelationship]
...
--- [https://wow.gamepedia.com/wiki/API_UnitSelectionColor]
...
--- [https://wow.gamepedia.com/wiki/API_UnitSelectionType]
...
--- [https://wow.gamepedia.com/wiki/API_UnitSetRole]
...
--- [https://wow.gamepedia.com/wiki/API_UnitSex]
--- @param unit string @ UnitId
--- @return unknown @ gender
function UnitSex(unit)
end

--- [https://wow.gamepedia.com/wiki/API_UnitShouldDisplayName?action=edit&amp;redlink=1]
--- @return void
function UnitShouldDisplayName()
end

--- Returns the current spell haste percentage for a unit.
--- [https://wow.gamepedia.com/wiki/API_UnitSpellHaste]
--- @param unit string @ UnitId
...
--- [https://wow.gamepedia.com/wiki/API_UnitStagger]
...
--- [https://wow.gamepedia.com/wiki/API_UnitStat]
...
--- [https://wow.gamepedia.com/wiki/API_UnitSwitchToVehicleSeat?action=edit&amp;redlink=1]
--- @return void
function UnitSwitchToVehicleSeat()
end

--- [https://wow.gamepedia.com/wiki/API_UnitTargetsVehicleInRaidUI?action=edit&amp;redlink=1]
--- @return void
function UnitTargetsVehicleInRaidUI()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_UnitThreatPercentageOfLead]
--- @param unit string @ UnitId of the player or pet whose threat to request.
--- @param mobUnit string @ UnitId of the NPC whose threat table to query.
...
--- [https://wow.gamepedia.com/wiki/API_UnitThreatSituation]
--- @param unit string @ UnitId of the player or pet whose threat to request.
--- @param mobUnit string @ ? - UnitId of the NPC whose threat table to query.
...
--- [https://wow.gamepedia.com/wiki/API_UnitTreatAsPlayerForDisplay]
--- @param unit string
--- @return boolean @ treatAsPlayer
function UnitTreatAsPlayerForDisplay(unit)
end

--- [https://wow.gamepedia.com/wiki/API_UnitTrialBankedLevels?action=edit&amp;redlink=1]
--- @return void
function UnitTrialBankedLevels()
end

--- [https://wow.gamepedia.com/wiki/API_UnitTrialXP?action=edit&amp;redlink=1]
--- @return void
function UnitTrialXP()
end

--- Checks if a specified unit is currently in a vehicle, including transitioning between seats.
--- [https://wow.gamepedia.com/wiki/API_UnitUsingVehicle]
--- @param unit string @ UnitId of the unit to check.
--- @return boolean @ isTrue
function UnitUsingVehicle(unit)
end

--- [https://wow.gamepedia.com/wiki/API_UnitVehicleSeatCount?action=edit&amp;redlink=1]
--- @return void
function UnitVehicleSeatCount()
end

--- [https://wow.gamepedia.com/wiki/API_UnitVehicleSeatInfo?action=edit&amp;redlink=1]
--- @return void
function UnitVehicleSeatInfo()
end

--- [https://wow.gamepedia.com/wiki/API_UnitVehicleSkin?action=edit&amp;redlink=1]
--- @return void
function UnitVehicleSkin()
end

--- [https://wow.gamepedia.com/wiki/API_UnitWeaponAttackPower?action=edit&amp;redlink=1]
--- @return void
function UnitWeaponAttackPower()
end

--- Needs summary.
--- [https://wow.gamepedia.com/wiki/API_UnitWidgetSet]
--- @param unit string @ UnitId
...
--- [https://wow.gamepedia.com/wiki/API_UnitXP]
...
--- [https://wow.gamepedia.com/wiki/API_UnitXPMax]
--- @param unit string @ The UnitId to select as a target.
--- @return number @ XP
function UnitXPMax(unit)
end

--- [https://wow.gamepedia.com/wiki/API_UnlearnSpecialization?action=edit&amp;redlink=1]
--- @return void
function UnlearnSpecialization()
end

--- Pays for, and unlocks the Void Storage [1]
--- [https://wow.gamepedia.com/wiki/API_UnlockVoidStorage]
--- @return void
function UnlockVoidStorage()
end

--- Unmutes a sound file.
--- [https://wow.gamepedia.com/wiki/API_UnmuteSoundFile]
--- @param soundFile_or_fileDataID unknown
--- @return void
function UnmuteSoundFile(soundFile_or_fileDataID)
end

--- [https://wow.gamepedia.com/wiki/API_UpdateAddOnCPUUsage?action=edit&amp;redlink=1]
--- @return void
function UpdateAddOnCPUUsage()
end

--- [https://wow.gamepedia.com/wiki/API_UpdateAddOnMemoryUsage?action=edit&amp;redlink=1]
--- @return void
function UpdateAddOnMemoryUsage()
end

--- [https://wow.gamepedia.com/wiki/API_UpdateInventoryAlertStatus?action=edit&amp;redlink=1]
--- @return void
function UpdateInventoryAlertStatus()
end

--- [https://wow.gamepedia.com/wiki/API_UpdateWarGamesList?action=edit&amp;redlink=1]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_UpdateWindow]
--- @return void
function UpdateWindow()
end

--- [https://wow.gamepedia.com/wiki/API_UpgradeItem?action=edit&amp;redlink=1]
--- @return void
function UpgradeItem()
end

--- Perform the action in the specified action slot.
--- [https://wow.gamepedia.com/wiki/API_UseAction]
...
--- [https://wow.gamepedia.com/wiki/API_UseContainerItem]
...
--- [https://wow.gamepedia.com/wiki/API_UseHearthstone?action=edit&amp;redlink=1]
--- @return void
function UseHearthstone()
end

--- Use an item in a specific inventory slot.
--- [https://wow.gamepedia.com/wiki/API_UseInventoryItem]
...
--- [https://wow.gamepedia.com/wiki/API_UseItemByName]
...
--- [https://wow.gamepedia.com/wiki/API_UseQuestLogSpecialItem?action=edit&amp;redlink=1]
--- @return void
function UseQuestLogSpecialItem()
end

--- Use a toy in player's toybox.
--- [https://wow.gamepedia.com/wiki/API_UseToy]
--- @param itemId number @ itemId of a toy.
--- @return void
...
--- Use a toy in player's toybox.
--- [https://wow.gamepedia.com/wiki/API_UseToyByName]
--- @param name string @ localized?) name of a toy.
--- @return void
function UseToyByName(name)
end

--- [https://wow.gamepedia.com/wiki/API_UseWorldMapActionButtonSpellOnQuest?action=edit&amp;redlink=1]
--- @return void
function UseWorldMapActionButtonSpellOnQuest()
end

--- [https://wow.gamepedia.com/wiki/API_VehicleAimDecrement?action=edit&amp;redlink=1]
--- @return void
function VehicleAimDecrement()
end

--- [https://wow.gamepedia.com/wiki/API_VehicleAimDownStart?action=edit&amp;redlink=1]
--- @return void
function VehicleAimDownStart()
end

--- [https://wow.gamepedia.com/wiki/API_VehicleAimDownStop?action=edit&amp;redlink=1]
--- @return void
function VehicleAimDownStop()
end

--- [https://wow.gamepedia.com/wiki/API_VehicleAimGetAngle?action=edit&amp;redlink=1]
--- @return void
function VehicleAimGetAngle()
end

--- [https://wow.gamepedia.com/wiki/API_VehicleAimGetNormAngle?action=edit&amp;redlink=1]
--- @return void
function VehicleAimGetNormAngle()
end

--- [https://wow.gamepedia.com/wiki/API_VehicleAimGetNormPower?action=edit&amp;redlink=1]
--- @return void
function VehicleAimGetNormPower()
end

--- [https://wow.gamepedia.com/wiki/API_VehicleAimIncrement?action=edit&amp;redlink=1]
--- @return void
function VehicleAimIncrement()
end

--- [https://wow.gamepedia.com/wiki/API_VehicleAimRequestAngle?action=edit&amp;redlink=1]
--- @return void
function VehicleAimRequestAngle()
end

--- [https://wow.gamepedia.com/wiki/API_VehicleAimRequestNormAngle?action=edit&amp;redlink=1]
--- @return void
function VehicleAimRequestNormAngle()
end

--- [https://wow.gamepedia.com/wiki/API_VehicleAimSetNormPower?action=edit&amp;redlink=1]
--- @return void
function VehicleAimSetNormPower()
end

--- [https://wow.gamepedia.com/wiki/API_VehicleAimUpStart?action=edit&amp;redlink=1]
--- @return void
function VehicleAimUpStart()
end

--- [https://wow.gamepedia.com/wiki/API_VehicleAimUpStop?action=edit&amp;redlink=1]
--- @return void
function VehicleAimUpStop()
end

--- [https://wow.gamepedia.com/wiki/API_VehicleExit?action=edit&amp;redlink=1]
--- @return void
function VehicleExit()
end

--- [https://wow.gamepedia.com/wiki/API_VehicleNextSeat?action=edit&amp;redlink=1]
--- @return void
function VehicleNextSeat()
end

--- [https://wow.gamepedia.com/wiki/API_VehiclePrevSeat?action=edit&amp;redlink=1]
--- @return void
function VehiclePrevSeat()
end

--- [https://wow.gamepedia.com/wiki/API_ViewGuildRecipes?action=edit&amp;redlink=1]
--- @return void
function ViewGuildRecipes()
end

--- [https://wow.gamepedia.com/wiki/API_WarGameRespond?action=edit&amp;redlink=1]
--- @return void
function WarGameRespond()
end

--- [https://wow.gamepedia.com/wiki/API_WithdrawGuildBankMoney?action=edit&amp;redlink=1]
--- @return void
function WithdrawGuildBankMoney()
end

--- Returns the absolue value of the number.
--- [https://wow.gamepedia.com/wiki/API_abs]
...
--- [https://wow.gamepedia.com/wiki/API_acos]
--- @param cosine unknown
--- @return number @ radians
function acos(cosine)
end

--- [https://wow.gamepedia.com/wiki/API_addframetext?action=edit&amp;redlink=1]
--- @return void
function addframetext()
end

--- Computes trigonometric functions.
--- [https://wow.gamepedia.com/wiki/API_asin]
--- @param sine unknown
--- @return number @ radians
function asin(sine)
end

--- [https://wow.gamepedia.com/wiki/API_assert?action=edit&amp;redlink=1]
--- @return void
function assert()
end

--- Computes trigonometric functions.
--- [https://wow.gamepedia.com/wiki/API_atan]
--- @param tangent unknown
--- @return number @ radians
function atan(tangent)
end

--- [https://wow.gamepedia.com/wiki/API_atan2?action=edit&amp;redlink=1]
--- @return void
function atan2()
end

--- [https://wow.gamepedia.com/wiki/API_bit.arshift?action=edit&amp;redlink=1]
--- @return void
function bit.arshift()
end

--- [https://wow.gamepedia.com/wiki/API_bit.band?action=edit&amp;redlink=1]
--- @return void
function bit.band()
end

--- [https://wow.gamepedia.com/wiki/API_bit.bnot?action=edit&amp;redlink=1]
--- @return void
function bit.bnot()
end

--- [https://wow.gamepedia.com/wiki/API_bit.bor?action=edit&amp;redlink=1]
--- @return void
function bit.bor()
end

--- [https://wow.gamepedia.com/wiki/API_bit.bxor?action=edit&amp;redlink=1]
--- @return void
function bit.bxor()
end

--- [https://wow.gamepedia.com/wiki/API_bit.lshift?action=edit&amp;redlink=1]
--- @return void
function bit.lshift()
end

--- [https://wow.gamepedia.com/wiki/API_bit.mod?action=edit&amp;redlink=1]
--- @return void
function bit.mod()
end

--- [https://wow.gamepedia.com/wiki/API_bit.rshift?action=edit&amp;redlink=1]
--- @return void
function bit.rshift()
end

--- ceil(value) returns the ceiling of the value (the next highest whole number) i.e. rounds value up
--- [https://wow.gamepedia.com/wiki/API_ceil]
--- @param n unknown
--- @return unknown @ int
function ceil(n)
end
...
--- [https://wow.gamepedia.com/wiki/API_collectgarbage]
...
--- [https://wow.gamepedia.com/wiki/API_coroutine.create?action=edit&amp;redlink=1]
--- @return void
function coroutine.create()
end

--- [https://wow.gamepedia.com/wiki/API_coroutine.resume?action=edit&amp;redlink=1]
--- @return void
function coroutine.resume()
end

--- [https://wow.gamepedia.com/wiki/API_coroutine.running?action=edit&amp;redlink=1]
--- @return void
function coroutine.running()
end

--- [https://wow.gamepedia.com/wiki/API_coroutine.status?action=edit&amp;redlink=1]
--- @return void
function coroutine.status()
end

--- [https://wow.gamepedia.com/wiki/API_coroutine.wrap?action=edit&amp;redlink=1]
--- @return void
function coroutine.wrap()
end

--- [https://wow.gamepedia.com/wiki/API_coroutine.yield?action=edit&amp;redlink=1]
--- @return void
function coroutine.yield()
end

--- Computes trigonometric functions.
--- [https://wow.gamepedia.com/wiki/API_cos]
--- @param cosine unknown
--- @return number @ radians
function cos(cosine)
end
...
--- [https://wow.gamepedia.com/wiki/API_date]
...
--- [https://wow.gamepedia.com/wiki/API_debuglocals?action=edit&amp;redlink=1]
--- @return void
function debuglocals()
end

--- Starts the profiling timer.
--- [https://wow.gamepedia.com/wiki/API_debugprofilestart]
--- @return void
function debugprofilestart()
end

--- Returns the amount of time since profiling was started.
--- [https://wow.gamepedia.com/wiki/API_debugprofilestop]
...
--- [https://wow.gamepedia.com/wiki/API_debugstack]
...
--- [https://wow.gamepedia.com/wiki/API_deg?action=edit&amp;redlink=1]
--- @return void
function deg()
end

--- [https://wow.gamepedia.com/wiki/API_difftime?action=edit&amp;redlink=1]
--- @return void
function difftime()
end

--- [https://wow.gamepedia.com/wiki/API_error?action=edit&amp;redlink=1]
--- @return void
function error()
end

--- [https://wow.gamepedia.com/wiki/API_exp?action=edit&amp;redlink=1]
--- @return void
function exp()
end

--- Returns a random number within the specified interval.
--- [https://wow.gamepedia.com/wiki/API_fastrandom]
...
--- [https://wow.gamepedia.com/wiki/API_floor]
--- @param value unknown
--- @return unknown @ val
...
--- [https://wow.gamepedia.com/wiki/API_forceinsecure]
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_foreach]
--- @param tab unknown
--- @param func unknown
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_foreachi]
--- @param table unknown
--- @param f unknown
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_format]
...
--- [https://wow.gamepedia.com/wiki/API_frexp?action=edit&amp;redlink=1]
--- @return void
function frexp()
end

--- Returns the amount of memory in use by Lua (in kilobytes).
--- [https://wow.gamepedia.com/wiki/API_gcinfo]
--- @return number @ memoryInUse
function gcinfo()
end

--- [https://wow.gamepedia.com/wiki/API_geterrorhandler?action=edit&amp;redlink=1]
--- @return void
function geterrorhandler()
end

--- [https://wow.gamepedia.com/wiki/API_getfenv?action=edit&amp;redlink=1]
--- @return void
function getfenv()
end

--- [https://wow.gamepedia.com/wiki/API_getmetatable?action=edit&amp;redlink=1]
--- @return void
function getmetatable()
end

--- This is used to determine the size of a table. The size of a table is discussed at the top of this page.
--- [https://wow.gamepedia.com/wiki/API_getn]
--- @param table unknown
--- @return unknown @ size
function getn(table)
end

--- [https://wow.gamepedia.com/wiki/API_gmatch?action=edit&amp;redlink=1]
--- @return void
function gmatch()
end
...
--- [https://wow.gamepedia.com/wiki/API_gsub]
--- @param s unknown
...
--- [https://wow.gamepedia.com/wiki/API_hooksecurefunc]
...
--- [https://wow.gamepedia.com/wiki/API_ipairs]
--- @param table unknown
...
--- [https://wow.gamepedia.com/wiki/API_issecure]
...
--- [https://wow.gamepedia.com/wiki/API_issecurevariable]
...
--- [https://wow.gamepedia.com/wiki/API_ldexp?action=edit&amp;redlink=1]
--- @return void
function ldexp()
end

--- Parse a string as Lua code and return it as a reference to a function.
--- [https://wow.gamepedia.com/wiki/API_loadstring]
...
--- [https://wow.gamepedia.com/wiki/API_log?action=edit&amp;redlink=1]
--- @return void
function log()
end

--- [https://wow.gamepedia.com/wiki/API_log10?action=edit&amp;redlink=1]
--- @return void
function log10()
end

--- [https://wow.gamepedia.com/wiki/API_math.abs?action=edit&amp;redlink=1]
--- @return void
function math.abs()
end

--- [https://wow.gamepedia.com/wiki/API_math.acos?action=edit&amp;redlink=1]
--- @return void
function math.acos()
end

--- [https://wow.gamepedia.com/wiki/API_math.asin?action=edit&amp;redlink=1]
--- @return void
function math.asin()
end

--- [https://wow.gamepedia.com/wiki/API_math.atan?action=edit&amp;redlink=1]
--- @return void
function math.atan()
end

--- [https://wow.gamepedia.com/wiki/API_math.atan2?action=edit&amp;redlink=1]
--- @return void
function math.atan2()
end

--- [https://wow.gamepedia.com/wiki/API_math.ceil?action=edit&amp;redlink=1]
--- @return void
function math.ceil()
end

--- [https://wow.gamepedia.com/wiki/API_math.cos?action=edit&amp;redlink=1]
--- @return void
function math.cos()
end

--- [https://wow.gamepedia.com/wiki/API_math.cosh?action=edit&amp;redlink=1]
--- @return void
function math.cosh()
end

--- [https://wow.gamepedia.com/wiki/API_math.deg?action=edit&amp;redlink=1]
--- @return void
function math.deg()
end

--- [https://wow.gamepedia.com/wiki/API_math.exp?action=edit&amp;redlink=1]
--- @return void
function math.exp()
end

--- [https://wow.gamepedia.com/wiki/API_math.floor?action=edit&amp;redlink=1]
--- @return void
function math.floor()
end

--- [https://wow.gamepedia.com/wiki/API_math.fmod?action=edit&amp;redlink=1]
--- @return void
function math.fmod()
end

--- [https://wow.gamepedia.com/wiki/API_math.frexp?action=edit&amp;redlink=1]
--- @return void
function math.frexp()
end

--- [https://wow.gamepedia.com/wiki/API_math.ldexp?action=edit&amp;redlink=1]
--- @return void
function math.ldexp()
end

--- [https://wow.gamepedia.com/wiki/API_math.log?action=edit&amp;redlink=1]
--- @return void
function math.log()
end

--- [https://wow.gamepedia.com/wiki/API_math.log10?action=edit&amp;redlink=1]
--- @return void
function math.log10()
end

--- [https://wow.gamepedia.com/wiki/API_math.max?action=edit&amp;redlink=1]
--- @return void
function math.max()
end

--- [https://wow.gamepedia.com/wiki/API_math.min?action=edit&amp;redlink=1]
--- @return void
function math.min()
end

--- [https://wow.gamepedia.com/wiki/API_math.modf?action=edit&amp;redlink=1]
--- @return void
function math.modf()
end

--- [https://wow.gamepedia.com/wiki/API_math.pow?action=edit&amp;redlink=1]
--- @return void
function math.pow()
end

--- [https://wow.gamepedia.com/wiki/API_math.rad?action=edit&amp;redlink=1]
--- @return void
function math.rad()
end

--- [https://wow.gamepedia.com/wiki/API_math.random?action=edit&amp;redlink=1]
--- @return void
function math.random()
end

--- [https://wow.gamepedia.com/wiki/API_math.sin?action=edit&amp;redlink=1]
--- @return void
function math.sin()
end

--- [https://wow.gamepedia.com/wiki/API_math.sinh?action=edit&amp;redlink=1]
--- @return void
function math.sinh()
end

--- [https://wow.gamepedia.com/wiki/API_math.sqrt?action=edit&amp;redlink=1]
--- @return void
function math.sqrt()
end

--- [https://wow.gamepedia.com/wiki/API_math.tan?action=edit&amp;redlink=1]
--- @return void
function math.tan()
end

--- [https://wow.gamepedia.com/wiki/API_math.tanh?action=edit&amp;redlink=1]
--- @return void
function math.tanh()
end

--- [https://wow.gamepedia.com/wiki/API_max?action=edit&amp;redlink=1]
--- @return void
function max()
end

--- [https://wow.gamepedia.com/wiki/API_min?action=edit&amp;redlink=1]
--- @return void
function min()
end

--- [https://wow.gamepedia.com/wiki/API_mod?action=edit&amp;redlink=1]
--- @return void
function mod()
end

--- Creates a zero-size userdata object, optionally with a sharable empty metatable.
--- [https://wow.gamepedia.com/wiki/API_newproxy]
...
--- [https://wow.gamepedia.com/wiki/API_next]
--- @param table unknown
...
--- [https://wow.gamepedia.com/wiki/API_pairs]
--- @param table unknown
--- @return unknown, unknown, unknown @ iteratorFunc, table, startState
...
--- [https://wow.gamepedia.com/wiki/API_pcall]
...
--- [https://wow.gamepedia.com/wiki/API_rad?action=edit&amp;redlink=1]
--- @return void
function rad()
end

--- Returns a random number within the specified interval.
--- [https://wow.gamepedia.com/wiki/API_random]
--- @param low number @ lower integer limit on the returned random value.
--- @param high number @ upper integer limit on the returned random value.
--- @return number @ rand
...
--- [https://wow.gamepedia.com/wiki/API_rawequal?action=edit&amp;redlink=1]
--- @return void
function rawequal()
end

--- [https://wow.gamepedia.com/wiki/API_rawget?action=edit&amp;redlink=1]
--- @return void
function rawget()
end

--- Assigns a value to a key in the table, without invoking metamethods.
--- [https://wow.gamepedia.com/wiki/API_rawset]
...
--- [https://wow.gamepedia.com/wiki/API_scrub?action=edit&amp;redlink=1]
--- @return void
function scrub()
end

--- Calls the specified function without propagating taint to the caller.
--- [https://wow.gamepedia.com/wiki/API_securecall]
...
--- [https://wow.gamepedia.com/wiki/API_select]
...
--- [https://wow.gamepedia.com/wiki/API_seterrorhandler]
...
--- [https://wow.gamepedia.com/wiki/API_setfenv?action=edit&amp;redlink=1]
--- @return void
function setfenv()
end

--- [https://wow.gamepedia.com/wiki/API_setmetatable?action=edit&amp;redlink=1]
--- @return void
function setmetatable()
end

--- Computes trigonometric functions.
--- [https://wow.gamepedia.com/wiki/API_sin]
--- @param sine unknown
--- @return number @ radians
function sin(sine)
end
...
--- [https://wow.gamepedia.com/wiki/API_sort]
...
--- [https://wow.gamepedia.com/wiki/API_sqrt?action=edit&amp;redlink=1]
--- @return void
function sqrt()
end

--- Returns the numerical code of a character in a string.
--- [https://wow.gamepedia.com/wiki/API_strbyte]
...
--- [https://wow.gamepedia.com/wiki/API_strchar]
--- @param i1 unknown
--- @param i2 unknown
--- @param ... unknown
--- @return unknown @ s
...
--- [https://wow.gamepedia.com/wiki/API_strcmputf8i?action=edit&amp;redlink=1]
--- @return void
function strcmputf8i()
end

--- [https://wow.gamepedia.com/wiki/API_strconcat?action=edit&amp;redlink=1]
--- @return void
function strconcat()
end
...
--- [https://wow.gamepedia.com/wiki/API_strfind]
...
--- [https://wow.gamepedia.com/wiki/API_string.byte?action=edit&amp;redlink=1]
--- @return void
function string.byte()
end

--- [https://wow.gamepedia.com/wiki/API_string.char?action=edit&amp;redlink=1]
--- @return void
function string.char()
end

--- [https://wow.gamepedia.com/wiki/API_string.find?action=edit&amp;redlink=1]
--- @return void
function string.find()
end

--- [https://wow.gamepedia.com/wiki/API_string.format?action=edit&amp;redlink=1]
--- @return void
function string.format()
end

--- [https://wow.gamepedia.com/wiki/API_string.gfind?action=edit&amp;redlink=1]
--- @return void
function string.gfind()
end

--- [https://wow.gamepedia.com/wiki/API_string.gmatch?action=edit&amp;redlink=1]
--- @return void
function string.gmatch()
end

--- [https://wow.gamepedia.com/wiki/API_string.gsub?action=edit&amp;redlink=1]
--- @return void
function string.gsub()
end

--- [https://wow.gamepedia.com/wiki/API_string.join?action=edit&amp;redlink=1]
--- @return void
function string.join()
end

--- [https://wow.gamepedia.com/wiki/API_string.len?action=edit&amp;redlink=1]
--- @return void
function string.len()
end

--- [https://wow.gamepedia.com/wiki/API_string.lower?action=edit&amp;redlink=1]
--- @return void
function string.lower()
end

--- [https://wow.gamepedia.com/wiki/API_string.match?action=edit&amp;redlink=1]
--- @return void
function string.match()
end

--- [https://wow.gamepedia.com/wiki/API_string.rep?action=edit&amp;redlink=1]
--- @return void
function string.rep()
end

--- [https://wow.gamepedia.com/wiki/API_string.reverse?action=edit&amp;redlink=1]
--- @return void
function string.reverse()
end

--- [https://wow.gamepedia.com/wiki/API_string.split?action=edit&amp;redlink=1]
--- @return void
function string.split()
end

--- [https://wow.gamepedia.com/wiki/API_string.sub?action=edit&amp;redlink=1]
--- @return void
function string.sub()
end

--- [https://wow.gamepedia.com/wiki/API_string.trim?action=edit&amp;redlink=1]
--- @return void
function string.trim()
end

--- [https://wow.gamepedia.com/wiki/API_string.upper?action=edit&amp;redlink=1]
--- @return void
function string.upper()
end

--- Joins strings together with a delimiter.
--- [https://wow.gamepedia.com/wiki/API_strjoin]
...
--- [https://wow.gamepedia.com/wiki/API_strlen]
--- @param s unknown
--- @return void
function strlen(s)
end

--- [https://wow.gamepedia.com/wiki/API_strlenutf8?action=edit&amp;redlink=1]
--- @return void
function strlenutf8()
end

--- Gets a string with all lower case letters instead of upper case.
--- [https://wow.gamepedia.com/wiki/API_strlower]
...
--- [https://wow.gamepedia.com/wiki/API_strmatch]
--- @param string string @ The string to examine.
--- @param pattern string @ The pattern to search for within string.  This pattern is similar to Unix regular expressions, but is not the same -- see Lua Pattern matching for more details.
--- @param initpos number @ Index of the character within string to begin searching.  As is usual for Lua string functions, 1 refers to the first character of the string, 2 to the second, etc.  -1 refers to the last character of the string, -2 to the second last, etc.  If this argument is omitted, it defaults to 1; i.e., the search begins at the beginning of string.
...
--- [https://wow.gamepedia.com/wiki/API_strrep]
--- @param s unknown
--- @param n unknown
--- @return void
function strrep(s, n)
...
--- [https://wow.gamepedia.com/wiki/API_strrev]
...
--- [https://wow.gamepedia.com/wiki/API_strsplit]
...
--- [https://wow.gamepedia.com/wiki/API_strsub]
--- @param s unknown
--- @param i unknown
--- @param j unknown
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_strtrim]
...
--- [https://wow.gamepedia.com/wiki/API_strupper]
--- @param s unknown
--- @return void
function strupper(s)
end

--- [https://wow.gamepedia.com/wiki/API_table.concat?action=edit&amp;redlink=1]
--- @return void
function table.concat()
end

--- [https://wow.gamepedia.com/wiki/API_table.foreach?action=edit&amp;redlink=1]
--- @return void
function table.foreach()
end

--- [https://wow.gamepedia.com/wiki/API_table.foreachi?action=edit&amp;redlink=1]
--- @return void
function table.foreachi()
end

--- [https://wow.gamepedia.com/wiki/API_table.getn?action=edit&amp;redlink=1]
--- @return void
function table.getn()
end

--- From TableLibraryTutorial of lua-users.org.
--- [https://wow.gamepedia.com/wiki/API_table.insert]
--- @param table unknown
--- @param pos unknown
--- @param value unknown
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_table.maxn?action=edit&amp;redlink=1]
--- @return void
function table.maxn()
end

--- [https://wow.gamepedia.com/wiki/API_table.remove?action=edit&amp;redlink=1]
--- @return void
function table.remove()
end

--- [https://wow.gamepedia.com/wiki/API_table.removemulti?action=edit&amp;redlink=1]
--- @return void
function table.removemulti()
end

--- Obsolete; throws an error if called.
--- [https://wow.gamepedia.com/wiki/API_table.setn]
...
--- [https://wow.gamepedia.com/wiki/API_table.sort?action=edit&amp;redlink=1]
--- @return void
function table.sort()
end

--- [https://wow.gamepedia.com/wiki/API_table.wipe?action=edit&amp;redlink=1]
--- @return void
function table.wipe()
end

--- Computes trigonometric functions.
--- [https://wow.gamepedia.com/wiki/API_tan]
--- @param tangent unknown
--- @return number @ radians
...
--- [https://wow.gamepedia.com/wiki/API_time]
...
--- From TableLibraryTutorial of lua-users.org.
--- [https://wow.gamepedia.com/wiki/API_tinsert]
--- @param table unknown
--- @param pos unknown
--- @param value unknown
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_tonumber]
...
--- [https://wow.gamepedia.com/wiki/API_tostring]
...
--- From TableLibraryTutorial of lua-users.org.
--- [https://wow.gamepedia.com/wiki/API_tremove]
--- @param table unknown
--- @param pos unknown
--- @return void
...
--- [https://wow.gamepedia.com/wiki/API_type]
...
--- [https://wow.gamepedia.com/wiki/API_unpack]
...
--- [https://wow.gamepedia.com/wiki/API_wipe]
--- @param table table @ The table to be cleared.
--- @return table @ table
function wipe(table)
end

--- [https://wow.gamepedia.com/wiki/API_xpcall?action=edit&amp;redlink=1]
--- @return void
function xpcall()
end
